...
class SpecLibrary(Library):
    ...
    def download_all(self):
        ...
        for template in self.template_names:
            database.abspath(os.path.join(self.library_name, template), reload=True)
...
class FilterSystem(Library):
    ...
    def download_all(self):
        ...
        for filt in self.filter_names:
            database.abspath(os.path.join(self.filter_system, filt), reload=True)
...
class ExtCurvesLibrary(Library):
    """
    Class that contains the information of an Extinction Curve Library
    """
