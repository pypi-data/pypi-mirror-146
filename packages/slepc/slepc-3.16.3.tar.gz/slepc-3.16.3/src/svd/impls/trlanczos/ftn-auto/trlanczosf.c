...
*__ierr = SVDTRLanczosGetGBidiag(
	...
	(SVDTRLanczosGBidiag* )PetscToPointer((bidiag) ));
}
...
SLEPC_EXTERN void  svdtrlanczossetexplicitmatrix_(SVD svd,PetscBool *explicitmatrix, int *__ierr)
{
*__ierr = SVDTRLanczosSetExplicitMatrix(
	(SVD)PetscToPointer((svd) ),*explicitmatrix);
}
SLEPC_EXTERN void  svdtrlanczosgetexplicitmatrix_(SVD svd,PetscBool *explicitmatrix, int *__ierr)
{
