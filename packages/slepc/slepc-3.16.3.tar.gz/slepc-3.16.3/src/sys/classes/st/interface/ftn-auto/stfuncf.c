...
SLEPC_EXTERN void  stsetpreconditionermat_(ST st,Mat mat, int *__ierr)
{
*__ierr = STSetPreconditionerMat(
	(ST)PetscToPointer((st) ),
	(Mat)PetscToPointer((mat) ));
}
SLEPC_EXTERN void  stgetpreconditionermat_(ST st,Mat *mat, int *__ierr)
{
*__ierr = STGetPreconditionerMat(
