...
#
    ...
    def echelle(self, smooth_ech=None, nox=50, noy=0, hey=False, npb=10):
        ...
        lower = self.params['obs_numax']-(self.params['obs_dnu']*((ny-1)/2.))+(self.params['obs_dnu']*nshift)
        upper = self.params['obs_numax']+(self.params['obs_dnu']*((ny-1)/2.))+(self.params['obs_dnu']*nshift)
