...
def create_workspace(self, name, channelIds=[], code=None):
    ...
    return self.ana_api.createWorkspace(organizationId=self.organization, name=name, channelIds = channelIds, code=code)
