...
['click>=8.0.3,<9.0.0',
 ...
 'pysigma-backend-insightidr>=0.1.2,<0.2.0',
 'pysigma-backend-splunk>=0.3.0,<0.4.0',
 'pysigma-pipeline-crowdstrike>=0.1.5,<0.2.0',
 'pysigma-pipeline-sysmon>=0.1.4,<0.2.0',
 'pysigma-pipeline-windows>=0.1.0,<0.2.0',
 'pysigma>=0.5.0,<0.6.0']
