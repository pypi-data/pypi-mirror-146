...
mapping_file="/ocean/projects/asc170022p/tighu/jupyter_notebooks/"
...
class genetic_data_handler:
    ...
    def get_genetic_data_from_snps(self, subject_list=None, snp_list= None):
        """ The Primary function of the module which allows user to provide a subject list and list of snps

                Parameters:

                subject_list (list str): List of subjects which are of interest
                SNP (list str): A python list containing snps of interest
        ...
        with open(mapping_file+'ukb_chr_variant_mapping.pkl', 'rb') as f:
