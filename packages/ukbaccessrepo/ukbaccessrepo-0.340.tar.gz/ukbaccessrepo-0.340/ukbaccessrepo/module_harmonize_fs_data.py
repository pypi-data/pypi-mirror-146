...
class harmonize_fs_data:
    ...
    def get_subject_ids():
        """
        A utility function which lets user fetch a list of subject ids whose freesurfer data is available on PSC
        Parameters:
        No parameter required
        Returns:
        subject list: A python list object
    ...
    def get_demographics_data(self, subject_list=None):
        """
        The primary function of this module which lets user provide a subject list. Returned is a pandas dataframe which
        has meta data and freesurfer features. If no subject list is provided all subjects are considered
        Parameters:
        A python list of subjects whose freesurfer and meta data features is required
        Returns:
        subject list: A pandas dataframe which has all the features from freesurfer like cortical measurements and sub
        cortical volume numbers
        """
