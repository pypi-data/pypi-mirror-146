...
class OkraAuth(Initializer):
    ...
    def get_by_customer(self, customer_id, page=1, limit=20, **kwargs):
        """
    ...
    def get_by_bank(self, bank_id, page=1, limit=20):
        """
    ...
    def get_by_customer_date(self, customer_id, from_, to_, page=1, limit=20):
        ...
        Args : "customer":"5rggfdfghjkl4567",
                ...
                "from_" (string): "2020-01-01"
        """
        url = self._base_url + "auth/getByCustomerDate"
