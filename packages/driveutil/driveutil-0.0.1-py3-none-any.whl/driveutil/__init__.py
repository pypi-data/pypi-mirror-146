...
def GetUsbLetterFromName(drive_name):
...
def GetUsedDrives():
    ...
    #for drive in drives:
        #if GetDrivesInfo(drive) == "Error" or GetDrivesInfo(drive) == "":
            #drives.remove(drive)
    return drives
...
class Usb:
    ...
    def CopyToUsb(self,FileToCopy,WhereToCopyTo,Copy_file=True):
...
class HardDrive():
    '''Define a Hard Drive! (May Need Admin Access... Use This To Elavate To Admin! : https://gist.github.com/GaryLee/d1cf2089c3a515691919)'''
