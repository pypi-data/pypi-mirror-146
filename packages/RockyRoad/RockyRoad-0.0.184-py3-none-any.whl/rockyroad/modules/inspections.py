...
class Inspections(Consumer):
    ...
    class __Reports(Consumer):
        ...
        def listFields(self, model: Query(type=str) = None, productType: Query(type=str) = None, field: Query(type=str) = None):
            """This call will return detailed inspection wear part range information for the specified criteria."""

        @returns.json
        @http_get("inspections/fields/mappings/dictionary")
        def listFieldsDictionary(self, model: Query(type=str) = None, productType: Query(type=str) = None, field: Query(type=str) = None):
            """This call will return detailed inspection wear part range information for the specified criteria."""
