...
class Subscriptions(Consumer):
    ...
    @json
    @post("subscriptions")
    def insert(self, user_subscription: Body):
        """This call will create the user subscription with the specified parameters."""

    @json
    @patch("subscriptions/{uid}")
    def update(self, uid: str, user_subscription: Body):
        """This call will update the user subscriptionwith the specified parameters."""
