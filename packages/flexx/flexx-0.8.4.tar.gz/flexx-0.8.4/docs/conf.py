...
# -*- coding: utf-8 -*-
#
# Flexx documentation build configuration file, created by
...
import flexx
from flexx import app, event, ui, util
...
latex_documents = [
  ('index', 'Flexx.tex', 'Flexx Documentation',
   'Flexx contributors', 'manual'),
]
...
man_pages = [
    ('index', 'flexx', 'Flexx Documentation',
     ['Flexx contributors'], 1)
]
...
texinfo_documents = [
  ('index', 'Flexx', 'Flexx Documentation',
   'Flexx contributors', 'Flexx', 'One line description of project.',
   'Miscellaneous'),
]
