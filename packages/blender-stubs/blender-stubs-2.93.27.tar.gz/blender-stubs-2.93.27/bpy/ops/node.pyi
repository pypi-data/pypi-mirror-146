...
def active_preview_toggle() -> None:
...
def link(detach: bool = False, has_link_picked: bool = False, drag_start: typing.Tuple[float, float] = (0.0, 0.0)) -> None:
