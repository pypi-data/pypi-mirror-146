...
def gltf(filepath: str = '', filter_glob: str = '*args.glb;*args.gltf', loglevel: int = 0, import_pack_images: bool = True, import_shading: str = 'NORMALS') -> None:
...
def obj(filepath: str = '', filter_glob: str = '*args.obj;*args.mtl', use_edges: bool = True, use_smooth_groups: bool = True, use_split_objects: bool = True, use_split_groups: bool = False, use_groups_as_vgroups: bool = False, use_image_search: bool = True, split_mode: str = 'ON', global_clight_size: float = 0.0, axis_forward: str = '-Z', axis_up: str = 'Y') -> None:
