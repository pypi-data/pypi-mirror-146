...
def export_layout(filepath: str = '', export_all: bool = False, modified: bool = False, mode: str = 'PNG', size: typing.Tuple[int, int] = (1024, 1024), opacity: float = 0.25) -> None:
...
def pack_islands(rotate: bool = True, margin: float = 0.001) -> None:
...
def smart_project(angle_limit: float = 66.0, island_margin: float = 0.0, user_area_weight: float = 0.0, use_aspect: bool = True, stretch_to_bounds: bool = True) -> None:
