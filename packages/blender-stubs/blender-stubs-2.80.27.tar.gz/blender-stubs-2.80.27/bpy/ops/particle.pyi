...
def select_linked(deselect: bool = False, location: typing.Tuple[int, int] = (0, 0)) -> None:
...
def select_random(percent: float = 50.0, seed: int = 0, action: str = 'SELECT', type: str = 'HAIR') -> None:
