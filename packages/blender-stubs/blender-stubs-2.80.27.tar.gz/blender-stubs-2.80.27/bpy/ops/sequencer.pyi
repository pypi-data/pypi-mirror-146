...
def change_effect_type(type: str = 'ALPHA_OVER') -> None:
...
def cut(frame: int = 0, type: str = 'SOFT', side: str = 'MOUSE') -> None:
...
def cut_multicam(camera: int = 1) -> None:
...
def effect_strip_add(frame_start: int = 0, frame_end: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, type: str = 'ALPHA_OVER', color: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def movie_strip_add(filepath: str = '', files: typing.Union[typing.Sequence[OperatorFileListElement], typing.Mapping[str, OperatorFileListElement], bpy.types.bpy_prop_collection] = None, filter_blender: bool = False, filter_backup: bool = False, filter_image: bool = False, filter_movie: bool = True, filter_python: bool = False, filter_font: bool = False, filter_sound: bool = False, filter_text: bool = False, filter_btx: bool = False, filter_collada: bool = False, filter_alembic: bool = False, filter_folder: bool = True, filter_blenlib: bool = False, filemode: int = 9, relative_path: bool = True, show_multiview: bool = False, use_multiview: bool = False, display_type: str = 'DEFAULT', sort_method: str = 'FILE_SORT_ALPHA', frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, sound: bool = True, use_framerate: bool = True) -> None:
...
def select(extend: bool = False, deselect_all: bool = False, linked_handle: bool = False, left_right: str = 'NONE', linked_time: bool = False) -> None:
...
def select_active_side(side: str = 'BOTH') -> None:
