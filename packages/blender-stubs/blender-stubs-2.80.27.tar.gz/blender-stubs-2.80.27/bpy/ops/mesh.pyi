...
def bevel(offset_type: str = 'OFFSET', offset: float = 0.0, offset_pct: float = 0.0, segments: int = 1, profile: float = 0.5, vertex_only: bool = False, clamp_overlap: bool = False, loop_slide: bool = True, mark_seam: bool = False, mark_sharp: bool = False, material: int = -1, harden_normals: bool = False, face_strength_mode: str = 'NONE', miter_outer: str = 'SHARP', miter_inner: str = 'SHARP', spread: float = 0.1, release_confirm: bool = False) -> None:
...
def bisect(plane_co: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), plane_no: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), use_fill: bool = False, clear_inner: bool = False, clear_outer: bool = False, threshold: float = 0.0001, xstart: int = 0, xend: int = 0, ystart: int = 0, yend: int = 0, cursor: int = 1002) -> None:
...
def extrude_context(use_normal_flip: bool = False, mirror: bool = False) -> None:
...
def extrude_region(use_normal_flip: bool = False, mirror: bool = False) -> None:
...
def extrude_repeat(offset: float = 2.0, steps: int = 10) -> None:
...
def intersect(mode: str = 'SELECT_UNSELECT', separate_mode: str = 'CUT', threshold: float = 1e-06) -> None:
...
def intersect_boolean(operation: str = 'DIFFERENCE', use_swap: bool = False, threshold: float = 1e-06) -> None:
...
def knife_tool(use_occlude_geometry: bool = True, only_selected: bool = False, wait_for_input: bool = True) -> None:
...
def polybuild_face_at_cursor(mirror: bool = False, use_proportional_edit: bool = False, proportional_edit_falloff: str = 'SMOOTH', proportional_size: float = 1.0, use_proportional_connected: bool = False, use_proportional_projected: bool = False, release_confirm: bool = False, use_accurate: bool = False) -> None:
...
def primitive_circle_add(vertices: int = 32, radius: float = 1.0, fill_type: str = 'NOTHING', calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_cone_add(vertices: int = 32, radius1: float = 1.0, radius2: float = 0.0, depth: float = 2.0, end_fill_type: str = 'NGON', calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_cube_add(size: float = 2.0, calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_cylinder_add(vertices: int = 32, radius: float = 1.0, depth: float = 2.0, end_fill_type: str = 'NGON', calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_grid_add(x_subdivisions: int = 10, y_subdivisions: int = 10, size: float = 2.0, calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_ico_sphere_add(subdivisions: int = 2, radius: float = 1.0, calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_monkey_add(size: float = 2.0, calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_plane_add(size: float = 2.0, calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def primitive_uv_sphere_add(segments: int = 32, ring_count: int = 16, radius: float = 1.0, calc_uvs: bool = True, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def remove_doubles(threshold: float = 0.0001, use_unselected: bool = False) -> None:
...
def select_linked_pick(deselect: bool = False, delimit: typing.Set[str] = {'SEAM'}, index: int = -1) -> None:
...
def select_nth(nth: int = 2, skip: int = 1, offset: int = 0) -> None:
...
def shortest_path_pick(edge_mode: str = 'SELECT', use_face_step: bool = False, use_topology_distance: bool = False, use_fill: bool = False, nth: int = 1, skip: int = 1, offset: int = 0, index: int = -1) -> None:
...
def shortest_path_select(edge_mode: str = 'SELECT', use_face_step: bool = False, use_topology_distance: bool = False, use_fill: bool = False, nth: int = 1, skip: int = 1, offset: int = 0) -> None:
...
def smoothen_normals(factor: float = 0.5) -> None:
...
def spin(steps: int = 9, dupli: bool = False, angle: float = 1.5708, use_auto_merge: bool = True, use_normal_flip: bool = False, center: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), axis: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def vertices_smooth(factor: float = 0.5, repeat: int = 1, xaxis: bool = True, yaxis: bool = True, zaxis: bool = True) -> None:
