...
def alembic_export(filepath: str = '', check_existing: bool = True, filter_blender: bool = False, filter_backup: bool = False, filter_image: bool = False, filter_movie: bool = False, filter_python: bool = False, filter_font: bool = False, filter_sound: bool = False, filter_text: bool = False, filter_btx: bool = False, filter_collada: bool = False, filter_alembic: bool = True, filter_folder: bool = True, filter_blenlib: bool = False, filemode: int = 8, display_type: str = 'DEFAULT', sort_method: str = 'FILE_SORT_ALPHA', start: int = -2147483648, end: int = -2147483648, xsamples: int = 1, gsamples: int = 1, sh_open: float = 0.0, sh_close: float = 1.0, selected: bool = False, renderable_only: bool = True, visible_layers_only: bool = False, flatten: bool = False, uvs: bool = True, packuv: bool = True, normals: bool = True, vcolors: bool = False, face_sets: bool = False, subdiv_schema: bool = False, apply_subdiv: bool = False, curves_as_mesh: bool = False, compression_type: str = 'OGAWA', global_scale: float = 1.0, triangulate: bool = False, quad_method: str = 'SHORTEST_DIAGONAL', ngon_method: str = 'BEAUTY', export_hair: bool = True, export_particles: bool = True, as_background_job: bool = False, init_scene_frame_range: bool = False) -> None:
...
def lib_reload(library: str = '', filepath: str = '', directory: str = '', filename: str = '', filter_blender: bool = True, filter_backup: bool = False, filter_image: bool = False, filter_movie: bool = False, filter_python: bool = False, filter_font: bool = False, filter_sound: bool = False, filter_text: bool = False, filter_btx: bool = False, filter_collada: bool = False, filter_alembic: bool = False, filter_folder: bool = True, filter_blenlib: bool = False, filemode: int = 8, relative_path: bool = True, display_type: str = 'DEFAULT', sort_method: str = 'FILE_SORT_ALPHA') -> None:
...
def link(filepath: str = '', directory: str = '', filename: str = '', files: typing.Union[typing.Sequence[OperatorFileListElement], typing.Mapping[str, OperatorFileListElement], bpy.types.bpy_prop_collection] = None, filter_blender: bool = True, filter_backup: bool = False, filter_image: bool = False, filter_movie: bool = False, filter_python: bool = False, filter_font: bool = False, filter_sound: bool = False, filter_text: bool = False, filter_btx: bool = False, filter_collada: bool = False, filter_alembic: bool = False, filter_folder: bool = True, filter_blenlib: bool = True, filemode: int = 1, relative_path: bool = True, display_type: str = 'DEFAULT', sort_method: str = 'FILE_SORT_ALPHA', link: bool = True, autoselect: bool = True, active_collection: bool = True, instance_collections: bool = True) -> None:
...
def open_mainfile(filepath: str = '', filter_blender: bool = True, filter_backup: bool = False, filter_image: bool = False, filter_movie: bool = False, filter_python: bool = False, filter_font: bool = False, filter_sound: bool = False, filter_text: bool = False, filter_btx: bool = False, filter_collada: bool = False, filter_alembic: bool = False, filter_folder: bool = True, filter_blenlib: bool = False, filemode: int = 8, display_type: str = 'DEFAULT', sort_method: str = 'FILE_SORT_ALPHA', load_ui: bool = True, use_scripts: bool = True, display_file_selector: bool = True, state: int = 0) -> None:
...
def previews_clear(id_type: typing.Set[str] = {'ALL', 'GEOMETRY', 'GROUP', 'IMAGE', 'LIGHT', 'MATERIAL', 'OBJECT', 'SCENE', 'SHADING', 'TEXTURE', 'WORLD'}) -> None:
...
def properties_edit(data_path: str = '', property: str = '', value: str = '', default: str = '', min: float = -10000, max: float = 10000.0, use_soft_limits: bool = False, is_overridable_library: bool = False, soft_min: float = -10000, soft_max: float = 10000.0, description: str = '') -> None:
...
def recover_auto_save(filepath: str = '', filter_blender: bool = True, filter_backup: bool = False, filter_image: bool = False, filter_movie: bool = False, filter_python: bool = False, filter_font: bool = False, filter_sound: bool = False, filter_text: bool = False, filter_btx: bool = False, filter_collada: bool = False, filter_alembic: bool = False, filter_folder: bool = False, filter_blenlib: bool = False, filemode: int = 8, display_type: str = 'LIST_LONG', sort_method: str = 'FILE_SORT_TIME') -> None:
...
def tool_set_by_id(name: str = '', cycle: bool = False, space_type: str = 'EMPTY') -> None:
...
def tool_set_by_index(index: int = 0, cycle: bool = False, expand: bool = True, space_type: str = 'EMPTY') -> None:
