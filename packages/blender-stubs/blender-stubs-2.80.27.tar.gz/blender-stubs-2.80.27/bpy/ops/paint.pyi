...
def brush_select(sculpt_tool: str = 'DRAW', vertex_tool: str = 'DRAW', weight_tool: str = 'DRAW', image_tool: str = 'DRAW', gpencil_tool: str = 'DRAW', toggle: bool = False, create_missing: bool = False) -> None:
...
def mask_lasso_gesture(path: typing.Union[typing.Sequence[OperatorMousePath], typing.Mapping[str, OperatorMousePath], bpy.types.bpy_prop_collection] = None, mode: str = 'VALUE', value: float = 1.0) -> None:
...
def vertex_color_dirt(blur_strength: float = 1.0, blur_iterations: int = 1, clean_angle: float = 3.14159, dirt_angle: float = 0.0, dirt_only: bool = False) -> None:
...
def weight_gradient(type: str = 'LINEAR', xstart: int = 0, xend: int = 0, ystart: int = 0, yend: int = 0, cursor: int = 1002) -> None:
