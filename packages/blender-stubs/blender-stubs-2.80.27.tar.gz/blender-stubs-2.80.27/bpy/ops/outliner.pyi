...
def collection_delete(hierarchy: bool = False) -> None:
...
def data_operation(type: str = 'SELECT') -> None:
...
def item_activate(extend: bool = True, recursive: bool = False, deselect_all: bool = False) -> None:
...
def item_openclose(all: bool = True) -> None:
...
def orphans_purge(num_deleted: int = 0) -> None:
...
def parent_drop(child: str = 'Object', parent: str = 'Object', type: str = 'OBJECT') -> None:
