...
def bake(frame_start: int = 1, frame_end: int = 250, step: int = 1, only_selected: bool = True, visual_keying: bool = False, clear_constraints: bool = False, clear_parents: bool = False, use_current_action: bool = False, bake_types: typing.Set[str] = {'POSE'}) -> None:
...
def click_select(extend: bool = False, deselect_all: bool = False) -> None:
