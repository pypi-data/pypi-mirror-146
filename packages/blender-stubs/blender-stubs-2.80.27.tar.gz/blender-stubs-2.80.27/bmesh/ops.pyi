...
def mirror(bm: bmesh.types.BMesh, geom: typing.List[typing.Any], matrix: mathutils.Matrix, merge_dist: float, axis: str, mirror_u: bool, mirror_v: bool) -> typing.Dict[str, typing.Any]:
...
def automerge(bm: bmesh.types.BMesh, verts: typing.List[typing.Any], dist: float) -> None:
