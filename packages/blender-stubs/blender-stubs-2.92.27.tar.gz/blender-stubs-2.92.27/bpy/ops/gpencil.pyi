...
def trace_image(target: str = 'NEW', thickness: int = 10, resolution: int = 5, scale: float = 1.0, sample: float = 0.0, threshold: float = 0.5, turnpolicy: str = 'MINORITY', mode: str = 'SINGLE') -> None:
