...
:func:`show_group_colors_deprecated`
...
def channels_find(query: str = 'Query') -> None:
...
def keyframe_delete(type: str = 'DEFAULT', confirm_success: bool = True) -> None:
...
def keyframe_delete_by_name(type: str = 'Type', confirm_success: bool = True) -> None:
...
def keyframe_insert(type: str = 'DEFAULT', confirm_success: bool = True) -> None:
...
def keyframe_insert_by_name(type: str = 'Type', confirm_success: bool = True) -> None:
...
def keyframe_insert_menu(type: str = 'DEFAULT', confirm_success: bool = False, always_prompt: bool = False) -> None:
...
def show_group_colors_deprecated() -> None:
