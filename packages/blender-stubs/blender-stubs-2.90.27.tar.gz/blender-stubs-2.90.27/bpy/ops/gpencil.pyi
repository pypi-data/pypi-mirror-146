...
def bake_mesh_animation(frame_start: int = 1, frame_end: int = 250, step: int = 1, angle: float = 1.22173, thickness: int = 1, seams: bool = False, faces: bool = True, offset: float = 0.001, frame_target: int = 1, target: str = '*argsNEW', project_type: str = 'VIEW') -> None:
