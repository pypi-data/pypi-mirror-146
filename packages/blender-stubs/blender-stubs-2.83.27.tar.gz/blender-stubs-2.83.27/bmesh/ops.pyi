...
Note: This API us new in 2.65 and not yet well tested.
...
def mirror(bm: bmesh.types.BMesh, geom: typing.List[typing.Any], matrix: mathutils.Matrix, merge_dist: float, axis: str, mirror_u: bool, mirror_v: bool, mirror_udim: bool) -> typing.Dict[str, typing.Any]:
...
def rotate(bm: bmesh.types.BMesh, cent: typing.Union[mathutils.Vector, typing.Any], matrix: mathutils.Matrix, verts: typing.List[typing.Any], space: mathutils.Matrix) -> None:
...
def translate(bm: bmesh.types.BMesh, vec: typing.Union[mathutils.Vector, typing.Any], space: mathutils.Matrix, verts: typing.List[typing.Any]) -> None:
...
def scale(bm: bmesh.types.BMesh, vec: typing.Union[mathutils.Vector, typing.Any], space: mathutils.Matrix, verts: typing.List[typing.Any]) -> None:
...
def transform(bm: bmesh.types.BMesh, matrix: mathutils.Matrix, space: mathutils.Matrix, verts: typing.List[typing.Any]) -> None:
...
def extrude_face_region(bm: bmesh.types.BMesh, geom: typing.List[typing.Any], edges_exclude: typing.Set[typing.Any], use_keep_orig: bool, use_normal_flip: bool, use_normal_from_adjacent: bool, use_select_history: bool) -> typing.Dict[str, typing.Any]:
...
def bevel(bm: bmesh.types.BMesh, geom: typing.List[typing.Any], offset: float, offset_type: str, segments: int, profile: float, vertex_only: bool, clamp_overlap: bool, material: int, loop_slide: bool, mark_seam: bool, mark_sharp: bool, harden_normals: bool, face_strength_mode: str, miter_outer: str, miter_inner: str, spread: float, smoothresh: float, use_custom_profile: bool, custom_profile: bpy.types.bpy_struct, vmesh_method: str) -> typing.Dict[str, typing.Any]:
...
def symmetrize(bm: bmesh.types.BMesh, input: typing.List[typing.Any], direction: str, dist: float) -> typing.Dict[str, typing.Any]:
