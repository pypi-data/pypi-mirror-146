...
def pgettext(self, msgid: str, msgctxt: str) -> None:
...
def pgettext_data(self, msgid: str, msgctxt: str) -> None:
...
def pgettext_iface(self, msgid: str, msgctxt: str) -> None:
...
def pgettext_tip(self, msgid: str, msgctxt: str) -> None:
