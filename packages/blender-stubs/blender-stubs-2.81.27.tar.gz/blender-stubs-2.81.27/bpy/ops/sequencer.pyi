...
def effect_strip_add(frame_start: int = 0, frame_end: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, type: str = 'CROSS', color: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def select(wait_to_deselect_others: bool = False, mouse_x: int = 0, mouse_y: int = 0, extend: bool = False, deselect_all: bool = False, linked_handle: bool = False, left_right: str = 'NONE', linked_time: bool = False) -> None:
