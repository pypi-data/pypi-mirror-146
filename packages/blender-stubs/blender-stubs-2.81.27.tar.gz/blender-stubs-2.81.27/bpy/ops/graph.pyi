...
def clickselect(extend: bool = False, deselect_all: bool = False, column: bool = False, curves: bool = False) -> None:
...
def select_box(axis_range: bool = False, include_handles: bool = False, tweak: bool = False, xmin: int = 0, xmax: int = 0, ymin: int = 0, ymax: int = 0, wait_for_input: bool = True, mode: str = 'SET') -> None:
