...
def bisect(plane_co: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), plane_no: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), use_fill: bool = False, clear_inner: bool = False, clear_outer: bool = False, threshold: float = 0.0001, xstart: int = 0, xend: int = 0, ystart: int = 0, yend: int = 0, cursor: int = 5) -> None:
