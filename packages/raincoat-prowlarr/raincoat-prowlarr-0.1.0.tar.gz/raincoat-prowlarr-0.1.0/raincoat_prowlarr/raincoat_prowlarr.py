...
parser.add_argument("-s", "--sort", help="Change sorting criteria. Any combination of 'cn','protocol', 'seeders', 'leechers', 'ratio', 'size', 'description'", action="store", default= "cn,size", dest="sort")
...
def search(search_terms):
    ...
    try:
        ...
        url = f"{shared.PROWLARR_URL}/api/v1/search?query={search_terms}"
