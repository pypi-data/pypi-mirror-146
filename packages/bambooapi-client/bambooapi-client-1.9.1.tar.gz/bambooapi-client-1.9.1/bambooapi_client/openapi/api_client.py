...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.client_forecast_baseline  # this is an instance of the class Endpoint
        api_instance.client_forecast_baseline()  # this invokes api_instance.client_forecast_baseline.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.client_forecast_baseline.callable or self.callable in this class
