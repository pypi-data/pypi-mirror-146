...
from bambooapi_client.openapi.model.markets_summary import MarketsSummary
...
class MarketsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_markets_summary_endpoint = _Endpoint(
            settings={
                'response_type': (MarketsSummary,),
                'auth': [
                    'BearerAuth'
                ],
                'endpoint_path': '/markets/summary',
                'operation_id': 'get_markets_summary',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'secondary_market_id': 'secondary_market_id',
                    'tertiary_market_id': 'tertiary_market_id',
                    'period_start': 'period_start',
                    'period_stop': 'period_stop',
                },
                'location_map': {
                    'spot_market_id': 'query',
                    'secondary_market_id': 'query',
                    'tertiary_market_id': 'query',
                    'period_start': 'query',
                    'period_stop': 'query',
                },
                'collection_format_map': {
    ...
    def get_markets_summary(
        ...
        **kwargs
        ...
        """Get summary statistics of a group of markets  # noqa: E501

        Return summary statistics of a given portfolio for all markets.  It returns the following KPIs: - Average spot price - Spot volatility - Average price tertiary up - Average price tertiary down - Average secondary price capacity band  **Not implemented yet. Endpoint returns 0.0 for each KPI.**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_markets_summary(spot_market_id, secondary_market_id, tertiary_market_id, period_start, period_stop, async_req=True)
        >>> result = thread.get()

        Args:
            spot_market_id (int):
            secondary_market_id (int):
            tertiary_market_id (int):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['spot_market_id'] = \
            spot_market_id
        kwargs['secondary_market_id'] = \
            secondary_market_id
        kwargs['tertiary_market_id'] = \
            tertiary_market_id
        kwargs['period_start'] = \
            period_start
        kwargs['period_stop'] = \
            period_stop
        return self.get_markets_summary_endpoint.call_with_http_info(**kwargs)
    ...
    def read_energy_market_prices(
        ...
        **kwargs
        ...
        >>> thread = api.read_energy_market_prices(market_id, start_date, end_date, async_req=True)
        >>> result = thread.get()
    ...
    def read_flexibility_market_prices(
        ...
        **kwargs
        ...
        >>> thread = api.read_flexibility_market_prices(market_id, start_date, end_date, async_req=True)
        >>> result = thread.get()
