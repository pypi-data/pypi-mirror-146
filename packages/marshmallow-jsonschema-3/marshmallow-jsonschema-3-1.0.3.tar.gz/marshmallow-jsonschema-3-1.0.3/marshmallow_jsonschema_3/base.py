...
class JSONSchema(Schema):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.to_openapi31 = kwargs.pop("to_openapi31", False)
        ...
        for validator in field.validators:
            if validator.__class__ in FIELD_VALIDATORS:
                schema = FIELD_VALIDATORS[validator.__class__](
                    schema, field, validator, obj, to_openapi31=self.to_openapi31
                )
            else:
                base_class = getattr(
                ...
                if base_class is not None and base_class in FIELD_VALIDATORS:
                    schema = FIELD_VALIDATORS[base_class](
                        schema, field, validator, obj, to_openapi31=self.to_openapi31
                    )
        return schema
