...
class ImGuiIO(ctypes.Structure):
    ...
    KeyMap: ctypes.Array # ArrayType: int[22]
    ...
    KeysDown: ctypes.Array # ArrayType: bool[512]
    ...
    KeysDownDuration: ctypes.Array # ArrayType: float[512]
    KeysDownDurationPrev: ctypes.Array # ArrayType: float[512]
