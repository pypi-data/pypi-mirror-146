...
# ASN.1 source file:///mnt/d/data/MIBS/text_mibs/paloalto/PAN-COMMON-MIB.my
# Produced by pysmi-0.3.4 at Wed Feb 10 13:07:04 2021
...
Gauge32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, IpAddress, ObjectIdentity, Counter32, MibIdentifier, Unsigned32, ModuleIdentity, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "IpAddress", "ObjectIdentity", "Counter32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter64", "Bits")
...
panCommonMibModule.setRevisions(('2014-09-04 00:00', '2014-09-04 00:00', '2014-03-06 00:00', '2013-03-01 00:00', '2011-02-09 16:10',))
...
panHACluster = ObjectIdentity((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9))
if mibBuilder.loadTexts: panHACluster.setStatus('current')
panWFMonitor = ObjectIdentity((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10))
if mibBuilder.loadTexts: panWFMonitor.setStatus('current')
...
panSSLBrokerStatsEntryindex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 8, 1, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panSSLBrokerStatsEntryindex.setStatus('current')
panSSLBrokerStatsEntrychainName = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 8, 1, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panSSLBrokerStatsEntrychainName.setStatus('current')
panSSLBrokerStatsEntryavgLatency = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 8, 1, 1, 3), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panSSLBrokerStatsEntryavgLatency.setStatus('current')
panSSLBrokerStatsEntrysessionCount = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 8, 1, 1, 4), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panSSLBrokerStatsEntrysessionCount.setStatus('current')
panHAClusterLocalSessStatsTable = MibTable((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1), )
if mibBuilder.loadTexts: panHAClusterLocalSessStatsTable.setStatus('current')
panHAClusterLocalSessStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1, 1), ).setIndexNames((0, "PAN-COMMON-MIB", "index"))
if mibBuilder.loadTexts: panHAClusterLocalSessStatsEntry.setStatus('current')
panHAClusterLocalSessStatsEntryindex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterLocalSessStatsEntryindex.setStatus('current')
panHAClusterLocalSessStatsEntryserialNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterLocalSessStatsEntryserialNumber.setStatus('current')
panHAClusterLocalSessStatsEntrycacheCurrentTotal = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterLocalSessStatsEntrycacheCurrentTotal.setStatus('current')
panHAClusterLocalSessStatsEntrycacheMax = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1, 1, 4), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterLocalSessStatsEntrycacheMax.setStatus('current')
panHAClusterLocalSessStatsEntrytableActive = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1, 1, 5), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterLocalSessStatsEntrytableActive.setStatus('current')
panHAClusterLocalSessStatsEntrytableMax = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 1, 1, 6), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterLocalSessStatsEntrytableMax.setStatus('current')
panHAClusterSessStatsTable = MibTable((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2), )
if mibBuilder.loadTexts: panHAClusterSessStatsTable.setStatus('current')
panHAClusterSessStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2, 1), ).setIndexNames((0, "PAN-COMMON-MIB", "index"))
if mibBuilder.loadTexts: panHAClusterSessStatsEntry.setStatus('current')
panHAClusterSessStatsEntryindex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterSessStatsEntryindex.setStatus('current')
panHAClusterSessStatsEntryserialNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterSessStatsEntryserialNumber.setStatus('current')
panHAClusterSessStatsEntrycacheCurrent = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterSessStatsEntrycacheCurrent.setStatus('current')
panHAClusterSessStatsEntrycacheAccumulated = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2, 1, 4), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterSessStatsEntrycacheAccumulated.setStatus('current')
panHAClusterSessStatsEntrycacheCurrentPromoted = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2, 1, 5), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterSessStatsEntrycacheCurrentPromoted.setStatus('current')
panHAClusterSessStatsEntrypromotedAccumulated = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 9, 2, 1, 6), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panHAClusterSessStatsEntrypromotedAccumulated.setStatus('current')
panWFMonitorQStatusTable = MibTable((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1), )
if mibBuilder.loadTexts: panWFMonitorQStatusTable.setStatus('current')
panWFMonitorQStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1), ).setIndexNames((0, "PAN-COMMON-MIB", "index"))
if mibBuilder.loadTexts: panWFMonitorQStatusEntry.setStatus('current')
panWFMonitorQStatusEntryindex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorQStatusEntryindex.setStatus('current')
panWFMonitorQStatusEntryname = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorQStatusEntryname.setStatus('current')
panWFMonitorQStatusEntryarchiveCount = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorQStatusEntryarchiveCount.setStatus('current')
panWFMonitorQStatusEntrydocCount = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1, 4), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorQStatusEntrydocCount.setStatus('current')
panWFMonitorQStatusEntryelinkCount = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1, 5), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorQStatusEntryelinkCount.setStatus('current')
panWFMonitorQStatusEntryportExecCount = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1, 6), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorQStatusEntryportExecCount.setStatus('current')
panWFMonitorQStatusEntryurlUploadFileCount = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 1, 1, 7), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorQStatusEntryurlUploadFileCount.setStatus('current')
panWFMonitorArchiveUtilizationTable = MibTable((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 2), )
if mibBuilder.loadTexts: panWFMonitorArchiveUtilizationTable.setStatus('current')
panWFMonitorArchiveUtilizationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 2, 1), ).setIndexNames((0, "PAN-COMMON-MIB", "index"))
if mibBuilder.loadTexts: panWFMonitorArchiveUtilizationEntry.setStatus('current')
panWFMonitorArchiveUtilizationIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 2, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorArchiveUtilizationIndex.setStatus('current')
panWFMonitorArchiveUtilizationName = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 2, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorArchiveUtilizationName.setStatus('current')
panWFMonitorArchiveUtilizationAvailable = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 2, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorArchiveUtilizationAvailable.setStatus('current')
panWFMonitorArchiveUtilizationInUse = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 2, 1, 4), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorArchiveUtilizationInUse.setStatus('current')
panWFMonitorDocUtilizationTable = MibTable((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 3), )
if mibBuilder.loadTexts: panWFMonitorDocUtilizationTable.setStatus('current')
panWFMonitorDocUtilizationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 3, 1), ).setIndexNames((0, "PAN-COMMON-MIB", "index"))
if mibBuilder.loadTexts: panWFMonitorDocUtilizationEntry.setStatus('current')
panWFMonitorDocUtilizationEntryindex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 3, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorDocUtilizationEntryindex.setStatus('current')
panWFMonitorDocUtilizationEntryname = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 3, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorDocUtilizationEntryname.setStatus('current')
panWFMonitorDocUtilizationEntryavailable = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 3, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorDocUtilizationEntryavailable.setStatus('current')
panWFMonitorDocUtilizationEntryinUse = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 3, 1, 4), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorDocUtilizationEntryinUse.setStatus('current')
panWFMonitorElinkUtilizationTable = MibTable((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 4), )
if mibBuilder.loadTexts: panWFMonitorElinkUtilizationTable.setStatus('current')
panWFMonitorElinkUtilizationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 4, 1), ).setIndexNames((0, "PAN-COMMON-MIB", "index"))
if mibBuilder.loadTexts: panWFMonitorElinkUtilizationEntry.setStatus('current')
panWFMonitorElinkUtilizationEntryindex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 4, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorElinkUtilizationEntryindex.setStatus('current')
panWFMonitorElinkUtilizationEntryname = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 4, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorElinkUtilizationEntryname.setStatus('current')
panWFMonitorElinkUtilizationEntryavailable = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 4, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorElinkUtilizationEntryavailable.setStatus('current')
panWFMonitorElinkUtilizationEntryinUse = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 4, 1, 4), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorElinkUtilizationEntryinUse.setStatus('current')
panWFMonitorPortableExecUtilizationTable = MibTable((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 5), )
if mibBuilder.loadTexts: panWFMonitorPortableExecUtilizationTable.setStatus('current')
panWFMonitorPortableExecUtilizationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 5, 1), ).setIndexNames((0, "PAN-COMMON-MIB", "index"))
if mibBuilder.loadTexts: panWFMonitorPortableExecUtilizationEntry.setStatus('current')
panWFMonitorPortableExecUtilizationEntryindex = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 5, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorPortableExecUtilizationEntryindex.setStatus('current')
panWFMonitorPortableExecUtilizationEntryname = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 5, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorPortableExecUtilizationEntryname.setStatus('current')
panWFMonitorPortableExecUtilizationEntryavailable = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 5, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorPortableExecUtilizationEntryavailable.setStatus('current')
panWFMonitorPortableExecUtilizationEntryinUse = MibTableColumn((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 10, 5, 1, 4), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panWFMonitorPortableExecUtilizationEntryinUse.setStatus('current')
...
panDeviceLoggingLogTypeStatEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 7, 2, 1), ).setIndexNames((1, "PAN-COMMON-MIB", "panDeviceLoggingDeviceIndex"), (0, "PAN-COMMON-MIB", "panDeviceLoggingDevice"))
...
if mibBuilder.loadTexts: panDeviceLoggingExtFwdCount.setStatus('deprecated')
panDeviceLoggingExtFwdQueueDrop = MibScalar((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 7, 4, 2), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panDeviceLoggingExtFwdQueueDrop.setStatus('deprecated')
panDeviceLoggingExtFwdStatsSendErr = MibScalar((1, 3, 6, 1, 4, 1, 25461, 2, 1, 2, 7, 4, 3), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: panDeviceLoggingExtFwdStatsSendErr.setStatus('deprecated')
...
mibBuilder.exportSymbols("PAN-COMMON-MIB", panHAClusterLocalSessStatsTable=panHAClusterLocalSessStatsTable, panLcDiskQuotaPct=panLcDiskQuotaPct, panSSLBroker=panSSLBroker, panDeviceLoggingExtFwdStatsTable1minAvgSendRate=panDeviceLoggingExtFwdStatsTable1minAvgSendRate, panLocalDiskUsageDiskSpace=panLocalDiskUsageDiskSpace, panWFMonitorElinkUtilizationEntryavailable=panWFMonitorElinkUtilizationEntryavailable, panWFMonitorElinkUtilizationTable=panWFMonitorElinkUtilizationTable, panFlowDosClMaxSessLimit=panFlowDosClMaxSessLimit, panDeviceLoggingLogTypeStatEntry=panDeviceLoggingLogTypeStatEntry, panVsysName=panVsysName, panFlowMeterVsysThrottle=panFlowMeterVsysThrottle, panVsysActiveUdpCps=panVsysActiveUdpCps, panDeviceLoggingDiskUsageDiskSpace=panDeviceLoggingDiskUsageDiskSpace, panFlowDosPfIcmplpkt=panFlowDosPfIcmplpkt, panVsysEntry=panVsysEntry, panFlowDosPfIcmperr=panFlowDosPfIcmperr, panDeviceLoggingLogUsageTable=panDeviceLoggingLogUsageTable, panSysHwVersion=panSysHwVersion, panWFMonitorQStatusEntryelinkCount=panWFMonitorQStatusEntryelinkCount, panVsysActiveOtherIpCps=panVsysActiveOtherIpCps, panWFMonitor=panWFMonitor, panFlowDosPfSatnetid=panFlowDosPfSatnetid, panFlowDosSyncookieMax=panFlowDosSyncookieMax, panLcDiskUsageId=panLcDiskUsageId, panZoneEntry=panZoneEntry, panWFMonitorArchiveUtilizationTable=panWFMonitorArchiveUtilizationTable, panLcLogDurationThreat=panLcLogDurationThreat, panFlowDosIp6Route3=panFlowDosIp6Route3, panTcpAllocWqeFailed=panTcpAllocWqeFailed, panLocalDiskQuotaPct=panLocalDiskQuotaPct, panCommonEventEvents=panCommonEventEvents, panFlowDosClSyncookieMax=panFlowDosClSyncookieMax, panGlobalCountersTCPState=panGlobalCountersTCPState, panCommonConfMib=panCommonConfMib, panLcLogDurationTraffic=panLcLogDurationTraffic, panFlowDosIp6OptionsInvalidIPv6=panFlowDosIp6OptionsInvalidIPv6, panWFMonitorQStatusEntryarchiveCount=panWFMonitorQStatusEntryarchiveCount, panWFMonitorQStatusEntryname=panWFMonitorQStatusEntryname, panFlowDosRedTcp=panFlowDosRedTcp, panLcDiskIOWrite5min=panLcDiskIOWrite5min, panFlowDosPfIpfrag=panFlowDosPfIpfrag, panFlowTciIpsecDecapFailed=panFlowTciIpsecDecapFailed, panLcLogDurationSystem=panLcLogDurationSystem, panSessionActiveICMP=panSessionActiveICMP, panSysAvVersion=panSysAvVersion, panFlowDosIp6IPv6ExtHdrDestOpt=panFlowDosIp6IPv6ExtHdrDestOpt, panWFMonitorDocUtilizationEntry=panWFMonitorDocUtilizationEntry, panLcLogDurationHipmatch=panLcLogDurationHipmatch, panDeviceLoggingExtFwdStatsEntry=panDeviceLoggingExtFwdStatsEntry, panDeviceLoggingCollectorConnectionEntry=panDeviceLoggingCollectorConnectionEntry, panFlowDosPfRecordroute=panFlowDosPfRecordroute, panFlowDosIp6Acast=panFlowDosIp6Acast, panFlowDosPfTimestamp=panFlowDosPfTimestamp, panSysWildfireVersion=panSysWildfireVersion, panFlowPolicyNat=panFlowPolicyNat, panWFMonitorElinkUtilizationEntryinUse=panWFMonitorElinkUtilizationEntryinUse, panLcDiskUsageRetention=panLcDiskUsageRetention, panMSeriesMode=panMSeriesMode, panFlowTciGtpDecapFailed=panFlowTciGtpDecapFailed, panDeviceLoggingExtFwdQueueDrop=panDeviceLoggingExtFwdQueueDrop, panLocalDiskQuota=panLocalDiskQuota, panFlowHostServiceAllow=panFlowHostServiceAllow, panDeviceIncomingLogRate=panDeviceIncomingLogRate, panFlowDosPfSecurity=panFlowDosPfSecurity, panHAClusterLocalSessStatsEntryindex=panHAClusterLocalSessStatsEntryindex, panWFMonitorArchiveUtilizationIndex=panWFMonitorArchiveUtilizationIndex, panSysAvReleaseDate=panSysAvReleaseDate, panFpgaPkt=panFpgaPkt, panCommonEventObjs=panCommonEventObjs, panSessionMax=panSessionMax, panDeviceLoggingLogTypeStatTable=panDeviceLoggingLogTypeStatTable, panDeviceLoggingLogType=panDeviceLoggingLogType, panAhoSw=panAhoSw, panZoneName=panZoneName, panLcLogUsageTable=panLcLogUsageTable, panHAClusterLocalSessStatsEntrycacheCurrentTotal=panHAClusterLocalSessStatsEntrycacheCurrentTotal, panFlowDosPfStrictsource=panFlowDosPfStrictsource, panWFMonitorPortableExecUtilizationEntryname=panWFMonitorPortableExecUtilizationEntryname, panDeviceLoggingExtFwdStatsTable=panDeviceLoggingExtFwdStatsTable, panLcLoggingConnectedDeviceTable=panLcLoggingConnectedDeviceTable, panLcLoggingConnectedIdLogRate=panLcLoggingConnectedIdLogRate, panFlowDosPfTcpoverlappingmismatch=panFlowDosPfTcpoverlappingmismatch, panVsysActiveTcpCps=panVsysActiveTcpCps, panFlowDosip6IPv6ExtHdrRouting=panFlowDosip6IPv6ExtHdrRouting, panDeviceLoggingLogLastLogCreated=panDeviceLoggingLogLastLogCreated, panLocalDiskUsageRetention=panLocalDiskUsageRetention, panSysUrlFilteringDatabase=panSysUrlFilteringDatabase, panFlowIpfragRecv=panFlowIpfragRecv, panDeviceLoggingLogLastLogFwded=panDeviceLoggingLogLastLogFwded, panGlobalCountersDOSCounters=panGlobalCountersDOSCounters, panSessionActiveSslProxy=panSessionActiveSslProxy, panFlowDosIp6Route253=panFlowDosIp6Route253, panFlowDosPbpDrop=panFlowDosPbpDrop, panWFMonitorDocUtilizationEntryname=panWFMonitorDocUtilizationEntryname, panFlowDosPfNoreplyneedfrag=panFlowDosPfNoreplyneedfrag, panFlowDosRuleDropAggr=panFlowDosRuleDropAggr, panLcLogFwdStatsEntry=panLcLogFwdStatsEntry, panIfActiveTcpCps=panIfActiveTcpCps, ifDescr=ifDescr, panFlowHostServiceDeny=panFlowHostServiceDeny, panSysSwVersion=panSysSwVersion, panDeviceLoggingLogUsageLogType=panDeviceLoggingLogUsageLogType, panFlowTciIpsecDecapSuccess=panFlowTciIpsecDecapSuccess, panSysTimeZoneOffset=panSysTimeZoneOffset, panFlowHostServiceUnknown=panFlowHostServiceUnknown, panDeviceLoggingCollectorConnectionStatus=panDeviceLoggingCollectorConnectionStatus, panLcDiskUsage=panLcDiskUsage, panSysSerialNumber=panSysSerialNumber, panLcLogFwdStatsTableDropCount=panLcLogFwdStatsTableDropCount, panTcpDropPacket=panTcpDropPacket, panDeviceLoggingCollectorConnectionTable=panDeviceLoggingCollectorConnectionTable, panFlowActionClose=panFlowActionClose, panHACluster=panHACluster, panLcIsRedundancyMember=panLcIsRedundancyMember, panChassis=panChassis, panFlowDosSyncookieNotTcpSyn=panFlowDosSyncookieNotTcpSyn, panFlowDosPfLoosesource=panFlowDosPfLoosesource, panWFMonitorArchiveUtilizationEntry=panWFMonitorArchiveUtilizationEntry, panHAClusterLocalSessStatsEntrytableMax=panHAClusterLocalSessStatsEntrytableMax, panHAClusterSessStatsEntrypromotedAccumulated=panHAClusterSessStatsEntrypromotedAccumulated, panFlowDosPfUnknown=panFlowDosPfUnknown, panHAClusterSessStatsEntrycacheCurrentPromoted=panHAClusterSessStatsEntrycacheCurrentPromoted, panFlowActionReset=panFlowActionReset, panSession=panSession, panWFMonitorPortableExecUtilizationEntry=panWFMonitorPortableExecUtilizationEntry, panFlowDosRuleDropClBlkDur=panFlowDosRuleDropClBlkDur, panFlowDosIp6Route255=panFlowDosIp6Route255, panFlowDosDropIpBlocked=panFlowDosDropIpBlocked, panFlowDosPfStrictip=panFlowDosPfStrictip, panSysVpnClientVersion=panSysVpnClientVersion, panSysThreatVersion=panSysThreatVersion, panLcLoggingLogType=panLcLoggingLogType, panHAClusterLocalSessStatsEntrytableActive=panHAClusterLocalSessStatsEntrytableActive, panLcDiskIOPSEntry=panLcDiskIOPSEntry, panWFMonitorQStatusEntryindex=panWFMonitorQStatusEntryindex, panLcStat=panLcStat, PYSNMP_MODULE_ID=panCommonMibModule, panGPGatewayUtilization=panGPGatewayUtilization, panFlowDosClSyncookieAckRcv=panFlowDosClSyncookieAckRcv, panLcLoggingConnectedDeviceEntry=panLcLoggingConnectedDeviceEntry, panSysHAState=panSysHAState, panFlowDosPfTcpsplithandshake=panFlowDosPfTcpsplithandshake, panDeviceLoggingCollectorConnectionIP=panDeviceLoggingCollectorConnectionIP, FloatValue=FloatValue, panMgmtPanoramaConnected=panMgmtPanoramaConnected, panLcDiskUsageTable=panLcDiskUsageTable, panHAClusterSessStatsEntrycacheAccumulated=panHAClusterSessStatsEntrycacheAccumulated, panWFMonitorArchiveUtilizationAvailable=panWFMonitorArchiveUtilizationAvailable, panSysThreatReleaseDate=panSysThreatReleaseDate, panWFMonitorPortableExecUtilizationEntryavailable=panWFMonitorPortableExecUtilizationEntryavailable, panDeviceLoggingLogTotalLogsFwded=panDeviceLoggingLogTotalLogsFwded, panSSLBrokerStatsEntrysessionCount=panSSLBrokerStatsEntrysessionCount, panFlowTciGreDecapSuccess=panFlowTciGreDecapSuccess, panSessionActiveTcp=panSessionActiveTcp, panDeviceLoggingDiskQuotaPct=panDeviceLoggingDiskQuotaPct, panLcLogFwdStatsTableQueueDepth=panLcLogFwdStatsTableQueueDepth, panWFMonitorElinkUtilizationEntryname=panWFMonitorElinkUtilizationEntryname, panFlowDosAgMaxSessLimit=panFlowDosAgMaxSessLimit, panLcLoggingDeviceConnectionId=panLcLoggingDeviceConnectionId, panFlowFwdL3TtlZero=panFlowFwdL3TtlZero, panLcLogFwdStatsTableSendCount=panLcLogFwdStatsTableSendCount, panAhoFpga=panAhoFpga, panMgmtPanorama2Connected=panMgmtPanorama2Connected, panFlowDosRuleDropClRedAct=panFlowDosRuleDropClRedAct, panDeviceLoggingExtFwdStatsTableSendCount=panDeviceLoggingExtFwdStatsTableSendCount, panDeviceLoggingDiskUsageRetention=panDeviceLoggingDiskUsageRetention, panSessionDiscard=panSessionDiscard, panWFMonitorQStatusEntryportExecCount=panWFMonitorQStatusEntryportExecCount, panDeviceLoggingDiskQuota=panDeviceLoggingDiskQuota, panZoneActiveOtherIpCps=panZoneActiveOtherIpCps, panFlowDosIp6NeedlessIpv6FragHdr=panFlowDosIp6NeedlessIpv6FragHdr, panHAClusterSessStatsTable=panHAClusterSessStatsTable, panHAClusterLocalSessStatsEntrycacheMax=panHAClusterLocalSessStatsEntrycacheMax, panDeviceLogging=panDeviceLogging, panMgmt=panMgmt, panFlowDosSyncookieBlkDur=panFlowDosSyncookieBlkDur, panWFMonitorDocUtilizationTable=panWFMonitorDocUtilizationTable, panGlobalCountersDropCounters=panGlobalCountersDropCounters, panSSLBrokerStatsTable=panSSLBrokerStatsTable, panWFMonitorArchiveUtilizationName=panWFMonitorArchiveUtilizationName, panFlowDosIp6Ip4cmpt=panFlowDosIp6Ip4cmpt, panFlowDosZoneRedMax=panFlowDosZoneRedMax, panLcLogTypeLastSeqNumRecd=panLcLogTypeLastSeqNumRecd, panWFMonitorDocUtilizationEntryindex=panWFMonitorDocUtilizationEntryindex, panLocalLogUsageTable=panLocalLogUsageTable, panFlowDosRuleDropClRedMax=panFlowDosRuleDropClRedMax, panDeviceLoggingExtFwd=panDeviceLoggingExtFwd, panWFMonitorQStatusEntry=panWFMonitorQStatusEntry, panChassisType=panChassisType, panSessionActive=panSessionActive, panFlowDosIPv6ExtHdrHopByHop=panFlowDosIPv6ExtHdrHopByHop, panFlowDosZoneRedAct=panFlowDosZoneRedAct, panSessionSslProxyUtilization=panSessionSslProxyUtilization, panFlowDosBlkSwEntries=panFlowDosBlkSwEntries, panVsysSessionUtilizationPct=panVsysSessionUtilizationPct, panHAClusterLocalSessStatsEntryserialNumber=panHAClusterLocalSessStatsEntryserialNumber, panWFMonitorDocUtilizationEntryavailable=panWFMonitorDocUtilizationEntryavailable, panLcDiskIOPSTable=panLcDiskIOPSTable, panHaPathmonSent=panHaPathmonSent, panFlowDosPfTcpsynackdata=panFlowDosPfTcpsynackdata, panFlowDosRedIp=panFlowDosRedIp, panFlowDosRuleAgRedAct=panFlowDosRuleAgRedAct, panVsysMaxSessions=panVsysMaxSessions, panFlowTciGreDecapUnknown=panFlowTciGreDecapUnknown, panLcLogFwdStatsTableType=panLcLogFwdStatsTableType, panFlowDosClSyncookieBlkDur=panFlowDosClSyncookieBlkDur, panCommonObjs=panCommonObjs, panFlowDosPfTcpsyndata=panFlowDosPfTcpsyndata, panDeviceWriteLogRate=panDeviceWriteLogRate, panHAClusterLocalSessStatsEntry=panHAClusterLocalSessStatsEntry, panLcDiskUsageDiskSpacePct=panLcDiskUsageDiskSpacePct, panWFMonitorDocUtilizationEntryinUse=panWFMonitorDocUtilizationEntryinUse, panLcLogDurationUserid=panLcLogDurationUserid, panDeviceLoggingLogUsageEntry=panDeviceLoggingLogUsageEntry, panFlowDosRuleDrop=panFlowDosRuleDrop, panFlowDosCurrSessIncrFailed=panFlowDosCurrSessIncrFailed, panWFMonitorQStatusEntrydocCount=panWFMonitorQStatusEntrydocCount, panSysOpswatDatafileVersion=panSysOpswatDatafileVersion, panFlowDosIp6Route254=panFlowDosIp6Route254, panFlowDosIp6Icmpv6ErrorInvalid=panFlowDosIp6Icmpv6ErrorInvalid, panIfActiveOtherIpCps=panIfActiveOtherIpCps, panLcLogTypeLastLogRecd=panLcLogTypeLastLogRecd, panLcLogDurationAppstat=panLcLogDurationAppstat, panFlowTcpNonSyn=panFlowTcpNonSyn, panCommonMibModule=panCommonMibModule, panDfaFpga=panDfaFpga, panSSLBrokerStatsEntry=panSSLBrokerStatsEntry, panLcLogDurationConfig=panLcLogDurationConfig, panZoneTable=panZoneTable, panPktAllocFailure=panPktAllocFailure, panSysWfReleaseDate=panSysWfReleaseDate, panTcpExceedSegLimit=panTcpExceedSegLimit, panIfTable=panIfTable, panLcLoggingDeviceTable=panLcLoggingDeviceTable, panLcLogDurationThsum=panLcLogDurationThsum, panWFMonitorQStatusEntryurlUploadFileCount=panWFMonitorQStatusEntryurlUploadFileCount, panFlowDosIp6Route1=panFlowDosIp6Route1, panFlowScanDrop=panFlowScanDrop, panTcpDeny=panTcpDeny, panDeviceLoggingLogRate=panDeviceLoggingLogRate, panSysUrlFilteringVersion=panSysUrlFilteringVersion, panFlowIpfragFragErr=panFlowIpfragFragErr, panGPGWUtilizationPct=panGPGWUtilizationPct, panFlowPolicyDeny=panFlowPolicyDeny, panGPGWUtilizationActiveTunnels=panGPGWUtilizationActiveTunnels, panFlowDosRuleAgBlkDur=panFlowDosRuleAgBlkDur, panSessionActiveUdp=panSessionActiveUdp, panSSLBrokerStatsEntrychainName=panSSLBrokerStatsEntrychainName, panHAClusterSessStatsEntry=panHAClusterSessStatsEntry, panWFMonitorPortableExecUtilizationEntryinUse=panWFMonitorPortableExecUtilizationEntryinUse, panFlowDosRedUdp=panFlowDosRedUdp, panSysWildfirePrivateCloudVersion=panSysWildfirePrivateCloudVersion, panHAClusterSessStatsEntrycacheCurrent=panHAClusterSessStatsEntrycacheCurrent, panLcLogTypeLastLogGen=panLcLogTypeLastLogGen)
mibBuilder.exportSymbols("PAN-COMMON-MIB", panFlowDosPfBadoption=panFlowDosPfBadoption, panCommonEvents=panCommonEvents, panLcLogDurationEvent=panLcLogDurationEvent, panWFMonitorPortableExecUtilizationEntryindex=panWFMonitorPortableExecUtilizationEntryindex, panSysHAMode=panSysHAMode, panDeviceLoggingExtFwdStatsTableQueueDepth=panDeviceLoggingExtFwdStatsTableQueueDepth, panLcDiskUsageEntry=panLcDiskUsageEntry, panLocalLogType=panLocalLogType, panDeviceLoggingCollectorConnectionHostname=panDeviceLoggingCollectorConnectionHostname, panFlowDosRedIcmp6=panFlowDosRedIcmp6, panDeviceLoggingExtFwdStatsTableType=panDeviceLoggingExtFwdStatsTableType, panVsysId=panVsysId, panWFMonitorElinkUtilizationEntry=panWFMonitorElinkUtilizationEntry, panFlowDosRedIcmp=panFlowDosRedIcmp, panFlowDosIp6Route0=panFlowDosIp6Route0, panDeviceLoggingExtFwdStatsTableEnqueueCount=panDeviceLoggingExtFwdStatsTableEnqueueCount, panLcLoggingConnectedDeviceName=panLcLoggingConnectedDeviceName, panZoneActiveTcpCps=panZoneActiveTcpCps, panLcLogFwdStatsTableEnqueueCount=panLcLogFwdStatsTableEnqueueCount, panSysDaylightSaving=panSysDaylightSaving, panCommonEventDescr=panCommonEventDescr, panFlowTciIpsecDecapUnknown=panFlowTciIpsecDecapUnknown, panGlobalCountersIPFragmentationCounters=panGlobalCountersIPFragmentationCounters, panWFMonitorPortableExecUtilizationTable=panWFMonitorPortableExecUtilizationTable, panWFMonitorArchiveUtilizationInUse=panWFMonitorArchiveUtilizationInUse, panDeviceLoggingDevice=panDeviceLoggingDevice, panFlowMeterHostThrottle=panFlowMeterHostThrottle, panTcpDropOutOfWnd=panTcpDropOutOfWnd, panHAClusterSessStatsEntryserialNumber=panHAClusterSessStatsEntryserialNumber, panCommonEventLog=panCommonEventLog, panLogCollector=panLogCollector, panDeviceLoggingExtFwdCount=panDeviceLoggingExtFwdCount, panFlowDosBlkNumEntries=panFlowDosBlkNumEntries, panVsysActiveSessions=panVsysActiveSessions, panLcLogDurationAlarm=panLcLogDurationAlarm, panLcDiskIORead5min=panLcDiskIORead5min, panFlowDosRuleAgRedMax=panFlowDosRuleAgRedMax, panFlowDosPfIpspoof=panFlowDosPfIpspoof, panFlowDosSyncookieNotTcpSynAck=panFlowDosSyncookieNotTcpSynAck, panLcLogType=panLcLogType, panLcLogRate=panLcLogRate, panIfEntry=panIfEntry, panLcDiskIOPSId=panLcDiskIOPSId, panFlowTciGreDecapFailed=panFlowTciGreDecapFailed, panFlowTciGtpDecapUnknown=panFlowTciGtpDecapUnknown, panLcLogDurationTrsum=panLcLogDurationTrsum, panLcLogDuration=panLcLogDuration, panFlowDosClSyncookieAckErr=panFlowDosClSyncookieAckErr, panSessionUtilization=panSessionUtilization, panWFMonitorQStatusTable=panWFMonitorQStatusTable, panSysAppVersion=panSysAppVersion, panFlowDosPfPing0=panFlowDosPfPing0, panSysGlobalProtectClientVersion=panSysGlobalProtectClientVersion, panDeviceLoggingLogLastSeqNumberFwded=panDeviceLoggingLogLastSeqNumberFwded, panLcLoggingDeviceEntry=panLcLoggingDeviceEntry, panGlobalProtect=panGlobalProtect, panFlowTciGtpDecapSuccess=panFlowTciGtpDecapSuccess, panDeviceLoggingCollectorConnectionType=panDeviceLoggingCollectorConnectionType, panCommonEventEventsV2=panCommonEventEventsV2, panDeviceLoggingDeviceIndex=panDeviceLoggingDeviceIndex, panFlowDosRuleDeny=panFlowDosRuleDeny, panSysHAPeerState=panSysHAPeerState, panFlowDosPfNoreplyttl=panFlowDosPfNoreplyttl, panLocalLogUsageEntry=panLocalLogUsageEntry, panSSLBrokerStatsEntryavgLatency=panSSLBrokerStatsEntryavgLatency, panLcLoggingConnectedDeviceConnectionId=panLcLoggingConnectedDeviceConnectionId, panFlowDosClSyncookieSent=panFlowDosClSyncookieSent, panDeviceLoggingExtFwdStatsTableDropCount=panDeviceLoggingExtFwdStatsTableDropCount, panFlowDosPfIcmpfrag=panFlowDosPfIcmpfrag, panGlobalCounters=panGlobalCounters, panLcLogFwdStatsTable=panLcLogFwdStatsTable, panDfaSw=panDfaSw, panSys=panSys, panPktAllocFailureCos=panPktAllocFailureCos, ifIndex=ifIndex, panSysAppReleaseDate=panSysAppReleaseDate, panVsysTable=panVsysTable, panHAClusterSessStatsEntryindex=panHAClusterSessStatsEntryindex, panFlowDosIp6Route4to252=panFlowDosIp6Route4to252, panWFMonitorElinkUtilizationEntryindex=panWFMonitorElinkUtilizationEntryindex, panIfActiveUdpCps=panIfActiveUdpCps, panSSLBrokerStatsEntryindex=panSSLBrokerStatsEntryindex, panFlowDosRuleDropClassified=panFlowDosRuleDropClassified, panGlobalCountersTunnelInspect=panGlobalCountersTunnelInspect, panDeviceLoggingLogLastSeqNumberAck=panDeviceLoggingLogLastSeqNumberAck, panFlowDosBlkHwEntries=panFlowDosBlkHwEntries, panZoneActiveUdpCps=panZoneActiveUdpCps, panDeviceLoggingExtFwdStatsSendErr=panDeviceLoggingExtFwdStatsSendErr, panFlowDosIp6RsvdSet=panFlowDosIp6RsvdSet, panFlowDosCurrSessDecrFailed=panFlowDosCurrSessDecrFailed, panLcLogUsageEntry=panLcLogUsageEntry, panGPGWUtilizationMaxTunnels=panGPGWUtilizationMaxTunnels)
