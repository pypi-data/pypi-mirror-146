...
class BGGCommon(object):
    ...
    def collection(self, user_name, subtype=BGGRestrictCollectionTo.BOARD_GAME, exclude_subtype=None, ids=None,
                   versions=None, version=None, own=None, rated=None, played=None, commented=None, trade=None,
                   want=None, wishlist=None, wishlist_prio=None, preordered=None, want_to_play=None, want_to_buy=None,
                   prev_owned=None, has_parts=None, want_parts=None, min_rating=None, rating=None, min_bgg_rating=None,
                   bgg_rating=None, min_plays=None, max_plays=None, private=None, collection_id=None,
                   modified_since=None):
        """
...
class BGGClient(BGGCommon):
    ...
    def game_list(self, game_id_list, versions=False, videos=False, historical=False, marketplace=False):
        """
