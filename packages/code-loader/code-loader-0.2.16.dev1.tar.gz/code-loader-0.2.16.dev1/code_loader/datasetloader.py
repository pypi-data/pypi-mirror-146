...
class DatasetLoader:
    ...
    @lru_cache()
    def custom_metric_by_name(self) -> Dict[str, CustomMetricHandler]:
        self.exec_script()
        setup = global_dataset_binder.setup_container
        return {
            custom_metric_handler.name: custom_metric_handler
            for custom_metric_handler in setup.custom_metric_handlers
        }
    ...
    def get_dataset_setup_response() -> DatasetSetup:
        ...
        custom_metric_names = [custom_metric.name for custom_metric in setup.custom_metric_handlers]
        return DatasetSetup(preprocess=dataset_preprocess, inputs=inputs, outputs=ground_truths, metadata=metadata,
                            ...
                            custom_loss_names=custom_loss_names, custom_metric_names=custom_metric_names)
