...
from code_loader.contract.datasetclasses import SectionCallableInterface, InputHandler, \
    ...
    PreprocessHandler, DecoderCallableInterface, CustomLossHandler, CustomCallableInterface, CustomMetricHandler
...
class DatasetBinder:
    ...
    def add_custom_metric(self, name: str, function: CustomCallableInterface) -> None:
        self.setup_container.custom_metric_handlers.append(CustomMetricHandler(name, function))
