...
class ReactionForm(EditPanelForm):
    ...
    def CreateControls(self):
        ...
        #self.auto_center_ctrl.SetValue(True) # TODO NEITHER of these need to exist
    ...
    def _AutoCenterCallback(self, evt):
        ...
        if checked:
            ...
            with self.controller.group_action():
                ...
                #print(reaction.center_pos)
                #reaction.auto_center = True
