...
try:
    ...
    from . import NXSCreateOnlineCPDB_test
...
class NXSCreateOnlineCPDBRTest(
        NXSCreateOnlineCPDB_test.NXSCreateOnlineCPDBTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateOnlineCPDB_test.NXSCreateOnlineCPDBTest.__init__(
            self, methodName)
    ...
    def setUp(self):
        self._sv2.setUp()
        self.openConf2()
        NXSCreateOnlineCPDB_test.NXSCreateOnlineCPDBTest.setUp(self)

    # test closer
    # \brief Common tear down
    def tearDown(self):
        NXSCreateOnlineCPDB_test.NXSCreateOnlineCPDBTest.tearDown(self)
        self.closeConfig2()
        self._sv2.tearDown()
