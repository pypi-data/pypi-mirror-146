...
try:
    ...
    from . import NXSCreateClientDSDB_test
...
class NXSCreateClientDSDBRTest(
        NXSCreateClientDSDB_test.NXSCreateClientDSDBTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateClientDSDB_test.NXSCreateClientDSDBTest.__init__(
            self, methodName)
    ...
    def setUp(self):
        self._sv2.setUp()
        NXSCreateClientDSDB_test.NXSCreateClientDSDBTest.setUp(self)

    # test closer
    # \brief Common tear down
    def tearDown(self):
        NXSCreateClientDSDB_test.NXSCreateClientDSDBTest.tearDown(self)
        self._sv2.tearDown()
