...
class DecisionTreeStrategy(StrategyInterface):
    """
        ...
        """
    def __init__(self,  features: list, target: list, data_loader: DataLoader, min_samples_leaf: int = 1, **kwargs):
        super().__init__(features=features, target=target, data_loader=data_loader, **kwargs)
