from datappkit.controller import BatchesController
...
class Datapp:
    ...
    def get_batches(self, search='', page=1, per_page=10):
        """
        获取批次
        :param search: 批次ID/名称
        :param page:
        :param per_page:
        :return:
        """
        return self.batch.get_batches(search, page, per_page)
