...
def Convert_Higher_is_Better(df, columns, conversion_type = 'absolute'):
    ...
    conversion_type : a string specifying the type of conversion to perform
        ...
        - 'inverse' converts  the raw value to its inverse
    ...
    for column in columns:
        ...
        elif conversion_type is 'inverse':
            new_column = column + '(invers HIB)'
...
####***********************           2.3 Standard Deviation Weighting               ****************###
...
####******************   2.4  Variability and Interdependencies of Criteria method    ****************###
