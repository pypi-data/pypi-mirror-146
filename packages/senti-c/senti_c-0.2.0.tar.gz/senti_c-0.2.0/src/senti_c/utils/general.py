...
# simple download that does not use google drive. 
...
# abandon google drive as of 2022-4-13
...
def get_toolkit_models(model_path,types="sentence",varients="default"):
    ...
    if types == "sentence":
        if varients == "default":
            ...
            file_id = 'http://www.im.ntu.edu.tw/~lu/data/senti_c/1DnSE7d_my_model.zip'
        else:
            # file_id = '1mwWLrjiYb7YyeHd5EtWKrHz_I0_YpYF-' 
            file_id = 'http://www.im.ntu.edu.tw/~lu/data/senti_c/1mwWL_open_model.zip'
    else:
        if varients == "default":
            # file_id = '1HHjpR9Am9a2JgDRrqVWh6t5BRRjlqk2u' 
            file_id = 'http://www.im.ntu.edu.tw/~lu/data/senti_c/1HHjp_my_model.zip'
        else:
            # file_id = '1a2RtKsGtgK6c3yCE_ABpZZZ18VcvZApv'
            file_id = 'http://www.im.ntu.edu.tw/~lu/data/senti_c/1a2RtK_open_model.zip'
            
    destination = model_path + '/models.zip'
    # _download_file_from_google_drive(file_id, destination)
    simple_download(file_id, destination)
