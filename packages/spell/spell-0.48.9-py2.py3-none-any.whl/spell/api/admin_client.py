...
class AdminClient(base_client.BaseClient):
    def create_org(self, name, billing_email, admin_email, plan_id=0):
        ...
        r = self.request("post", f"{ADMIN_RESOURCE_URL}/{ORG_RESOURCE_URL}", payload=payload)
    ...
    def create_gcp_cluster(
        ...
        r = self.request("post", f"{ADMIN_RESOURCE_URL}/clusters", payload=payload)
        self.check_and_raise(r)
    ...
    def update_cluster_bastion_key(self, cluster_id, new_key):
        ...
        url = f"{ADMIN_RESOURCE_URL}/clusters/{cluster_id}/sshd_key"
    ...
    def rotate_cluster_worker_key(self, cluster_id):
        ...
        """
        url = f"{ADMIN_RESOURCE_URL}/clusters/{cluster_id}/rotate_worker_key"
    ...
    def delete_cluster(self, cluster_id):
        ...
        cluster_id -- internal (global) id of the cluster
        """
        url = f"{ADMIN_RESOURCE_URL}/clusters/{cluster_id}"
