...
class ClusterClient(base_client.BaseClient):
    ...
    def register_serving_cluster(
        ...
        # TODO: drop this from the CLI if we decide to overwrite DB fields manually instead
        k8s_run_cluster_service_account="argo",
        k8s_run_cluster_storage_class="",
        k8s_run_cluster_region="",
    ):
        ...
        Kwargs:
            ...
            k8s_run_cluster_service_account -- service account name for the run cluster
            k8s_run_cluster_storage_class -- the storage class for the run cluster
            k8s_run_cluster_region -- the region for the run cluster
        ...
        payload = {
            ...
            "k8s_run_cluster": {
                "namespace": k8s_run_cluster_namespace,
                "service_account": k8s_run_cluster_service_account,
                "storage_class": k8s_run_cluster_storage_class,
                "region": k8s_run_cluster_region,
            },
        }
