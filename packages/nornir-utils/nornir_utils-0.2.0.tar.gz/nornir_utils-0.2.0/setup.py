...
['nornir_utils',
 ...
 'nornir_utils.plugins.tasks.networking']
...
{'nornir.plugins.inventory': ['YAMLInventory = '
 ...
 'nornir.plugins.transform_function': ['load_credentials = '
                                       'nornir_utils.plugins.inventory.transform_functions:load_credentials']}
