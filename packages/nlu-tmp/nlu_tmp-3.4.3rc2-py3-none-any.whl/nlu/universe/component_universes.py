...
def get_jsl_anno_id_for_class_name():
    pass


# 1. Merge OS/HC/OCR anno maps into one
# 2. merge OS/HC/OCR universe to one
# 3 ?

def get_empty_nlu_component(nlu_ref):
