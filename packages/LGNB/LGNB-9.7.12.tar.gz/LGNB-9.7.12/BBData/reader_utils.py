...
class BaseProvider:
    ...
    def alpha_info(field, freq):
        ...
        :return:
        """
        return AlphaD.feature_info(field, freq)
    ...
    def factor_info(field, freq):
        ...
        :return:
        """
        return FactorD.feature_info(field, freq)
    ...
    def combs(fields, start_time=None, end_time=None, freq="Tday", return_mat=False, instruments="all"):
        ...
        if freq == "report_period":
            fields += ["ann_date", ]
        fields = list(fields)  # In case of tuple.
        return CombD.features(instruments, fields, start_time, end_time, freq, return_mat)
    ...
    def combs_mmat(fields, start_time=None, end_time=None, freq="Tday", instruments="all"):
        ...
        if freq == "report_period":
            fields += ["ann_date", ]
        fields = list(fields)  # In case of tuple.
        return CombD.features_mmat(instruments, fields, start_time, end_time, freq)
    ...
    def list_combs(freq="*"):
        ...
        :return: list of features
        """
        return list_features(freq, ftype="combs")

    @staticmethod
    def comb_info(field, freq):
        """
        return the config of the field
        :param field: features str
        :param freq: includdes Aday for natural day; Tday for trading day; report_period for financial statement
        :return:
        """
        return CombD.feature_info(field, freq)
...
def list_features(freq="*", ftype="features"):
    ...
    for i in cal_config.values():
        try:
            features.remove(i["col_name"])
        except:
            pass
    return features
