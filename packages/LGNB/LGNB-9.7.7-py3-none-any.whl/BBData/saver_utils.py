...
class FactorUpdater(AlphaUpdater):
    ...
    def __init__(self, stk_univ="all", start_time=None, end_time=None, freq="Tday", save_primarykey=False):
        super(FactorUpdater, self).__init__(stk_univ, start_time, end_time, freq, not save_primarykey, ftype='factors')
...
class CombUpdater(AlphaUpdater):
    ...
    def __init__(self, stk_univ="all", start_time=None, end_time=None, freq="Tday", save_primarykey=False):
        super(CombUpdater, self).__init__(stk_univ, start_time, end_time, freq, not save_primarykey, ftype='combs')
