...
import ElasticEmail
from ElasticEmail.api.statistics_api import StatisticsApi  # noqa: E501
...
class TestStatisticsApi(unittest.TestCase):
    ...
    def test_statistics_campaigns_by_name_get(self):
    ...
    def test_statistics_campaigns_get(self):
    ...
    def test_statistics_channels_by_name_get(self):
    ...
    def test_statistics_channels_get(self):
