...
def create_user_notification(index_name: str, user_data: dict, model_index="email"):
    """
    ...
    msg_body = {"index": index_name, "user_data": user_data, "model_index": model_index}
...
def read_queue_messages(max_messages=10):
    """
...
def process_messages_queue(limit=1):
    for _ in range(limit):
        ...
        for msg in messages.get("Messages", []):
            ...
            if index_name == APP_UNIQUE_CODE:
                ...
                try:
                    user = User.objects.get(**{msg_body["model_index"]: user_data[msg_body["model_index"]]})
