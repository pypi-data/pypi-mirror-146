...
class core_FlatForward(YieldTermStructure):
    ...
    def __init__(self, ref_date: "Date", forward: "Rate", calendar: "Calendar", dayCounter: "DayCounter", bdc: "BusinessDayConvention", compounding: "Compounding"):
        r"""__init__(core_FlatForward self, Date ref_date, Rate forward, Calendar calendar, DayCounter dayCounter, BusinessDayConvention bdc, Compounding compounding) -> core_FlatForward"""
        _mxdevtool.core_FlatForward_swiginit(self, _mxdevtool.new_core_FlatForward(ref_date, forward, calendar, dayCounter, bdc, compounding))
...
class core_ZeroYieldCurveExt(YieldCurveExt):
    ...
    def __init__(self, ref_date: "Date", periods_str: "StrVector", zero_rates: "DoubleVector", interpolator1DType: "Interpolator1D::Type", extrapolator1DType: "Extrapolator1D::Type", calendar: "Calendar", dayCounter: "DayCounter", bdc: "BusinessDayConvention", compounding: "Compounding"):
...
class core_BootstrapCurve(YieldCurveExt):
    r"""Proxy of C++ BootstrapCurvePtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, refDate: "Date", tenors_str: "StrVector", rateTypes: "StrVector", quotes: "DoubleVector", interpolatorID: "Interpolator1D::Type", extrapolation: "Extrapolation", mc: "MarketConvension"):
        r"""__init__(core_BootstrapCurve self, Date refDate, StrVector tenors_str, StrVector rateTypes, DoubleVector quotes, Interpolator1D::Type interpolatorID, Extrapolation extrapolation, MarketConvension mc) -> core_BootstrapCurve"""
        _mxdevtool.core_BootstrapCurve_swiginit(self, _mxdevtool.new_core_BootstrapCurve(refDate, tenors_str, rateTypes, quotes, interpolatorID, extrapolation, mc))
    __swig_destroy__ = _mxdevtool.delete_core_BootstrapCurve

# Register core_BootstrapCurve in _mxdevtool:
_mxdevtool.core_BootstrapCurve_swigregister(core_BootstrapCurve)

class core_BootstapSwapCurveCCP(YieldCurveExt):
    r"""Proxy of C++ BootstrapSwapCurveCCPPtr class."""
...
class core_IborIndex(InterestRateIndex):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_IborIndex self, std::string const & familyName, Period tenor, Integer settlementDays, Currency currency, Calendar calendar, BusinessDayConvention convention, bool endOfMonth, DayCounter dayCounter, YieldTermStructureHandle h=Handle< YieldTermStructure >()) -> core_IborIndex
        __init__(core_IborIndex self, std::string builtin_familyName, std::string tenor_str) -> core_IborIndex
        """
        _mxdevtool.core_IborIndex_swiginit(self, _mxdevtool.new_core_IborIndex(*args))

    def businessDayConvention(self) -> "BusinessDayConvention":
        r"""businessDayConvention(core_IborIndex self) -> BusinessDayConvention"""
        return _mxdevtool.core_IborIndex_businessDayConvention(self)

    def endOfMonth(self) -> "bool":
        r"""endOfMonth(core_IborIndex self) -> bool"""
        return _mxdevtool.core_IborIndex_endOfMonth(self)

    def forwardingTermStructure(self) -> "Handle< YieldTermStructure >":
        r"""forwardingTermStructure(core_IborIndex self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_IborIndex_forwardingTermStructure(self)

    def clone(self, h: "YieldTermStructureHandle") -> "IborIndexPtr":
        r"""clone(core_IborIndex self, YieldTermStructureHandle h) -> core_IborIndex"""
        return _mxdevtool.core_IborIndex_clone(self, h)

    def setYieldCurve(self, yieldCurve: "YieldTermStructure") -> "void":
        r"""setYieldCurve(core_IborIndex self, YieldTermStructure yieldCurve)"""
        return _mxdevtool.core_IborIndex_setYieldCurve(self, yieldCurve)
    __swig_destroy__ = _mxdevtool.delete_core_IborIndex

# Register core_IborIndex in _mxdevtool:
_mxdevtool.core_IborIndex_swigregister(core_IborIndex)


def as_iborindex(index: "InterestRateIndex") -> "IborIndexPtr":
    r"""as_iborindex(InterestRateIndex index) -> core_IborIndex"""
    return _mxdevtool.as_iborindex(index)
class OvernightIndex(core_IborIndex):
...
class SwapIndex(InterestRateIndex):
    ...
    def __init__(self, *args):
        r"""
        __init__(SwapIndex self, std::string const & familyName, Period tenor, Integer settlementDays, Currency currency, Calendar calendar, Period fixedLegTenor, BusinessDayConvention fixedLegConvention, DayCounter fixedLegDayCounter, core_IborIndex iborIndex) -> SwapIndex
        __init__(SwapIndex self, std::string const & familyName, Period tenor, Integer settlementDays, Currency currency, Calendar calendar, Period fixedLegTenor, BusinessDayConvention fixedLegConvention, DayCounter fixedLegDayCounter, core_IborIndex iborIndex, YieldTermStructureHandle discountCurve) -> SwapIndex
        """
    ...
    def iborIndex(self) -> "IborIndexPtr":
        r"""iborIndex(SwapIndex self) -> core_IborIndex"""
...
class MarketConvension(object):
    r"""Proxy of C++ boost::shared_ptr< MarketConvension > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __deref__(self) -> "MarketConvension *":
...
class core_FixedBondMarketConvension(core_MarketConvension):
    ...
    def __init__(self, calendar: "Calendar", dayCounter: "DayCounter", businessDayConvention: "BusinessDayConvention", settlementDays: "Natural", couponTenor: "Period", compounding: "Compounding", familyname: "std::string"):
...
class core_VanillaSwapMarketConvension(core_MarketConvension):
    ...
    def __init__(self, calendar: "Calendar", dayCounter: "DayCounter", businessDayConvention: "BusinessDayConvention", settlementDays: "Natural", couponTenor: "Period", iborIndex: "core_IborIndex", familyname: "std::string"):
        r"""__init__(core_VanillaSwapMarketConvension self, Calendar calendar, DayCounter dayCounter, BusinessDayConvention businessDayConvention, Natural settlementDays, Period couponTenor, core_IborIndex iborIndex, std::string familyname) -> core_VanillaSwapMarketConvension"""
...
class Schedule(object):
    ...
    def __init__(self, *args):
        ...
        __init__(Schedule self, Date effectiveDate, Period endTenor, Period intervalTenor, Calendar calendar=NullCalendar(), BusinessDayConvention convention=BusinessDayConvention::ModifiedFollowing, DateGeneration::Rule rule=Forward) -> Schedule
        """
...
class FloatingRateBond(Bond):
    ...
    def __init__(self, *args, **kwargs):
        r"""__init__(FloatingRateBond self, Size settlementDays, Real faceAmount, Schedule schedule, core_IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention=Following, Size fixingDays=Null< Size >(), DoubleVector gearings=std::vector< Real >(), DoubleVector spreads=std::vector< Spread >(), DoubleVector caps=std::vector< Rate >(), DoubleVector floors=std::vector< Rate >(), bool inArrears=False, Real redemption=100.0, Date issueDate=Date()) -> FloatingRateBond"""
...
class core_ProcessModel(core_ProcessValue):
    ...
    def model_swaptionATM(self, expiry: "Period", tenor: "Period", familyname: "std::string") -> "double":
        r"""model_swaptionATM(core_ProcessModel self, Period expiry, Period tenor, std::string familyname) -> double"""
        return _mxdevtool.core_ProcessModel_model_swaptionATM(self, expiry, tenor, familyname)

    def model_swaption(self, expiry: "Period", tenor: "Period", strike: "double", familyname: "std::string") -> "double":
        r"""model_swaption(core_ProcessModel self, Period expiry, Period tenor, double strike, std::string familyname) -> double"""
        return _mxdevtool.core_ProcessModel_model_swaption(self, expiry, tenor, strike, familyname)

    def model_discountBond(self, now: "Time", maturity: "Time", rate: "Real") -> "double":
        r"""model_discountBond(core_ProcessModel self, Time now, Time maturity, Real rate) -> double"""
        return _mxdevtool.core_ProcessModel_model_discountBond(self, now, maturity, rate)

    def model_discount(self, t: "Time") -> "double":
        r"""model_discount(core_ProcessModel self, Time t) -> double"""
        return _mxdevtool.core_ProcessModel_model_discount(self, t)

    def model_spot(self, now: "Time", spot_maturity_t: "Time", rate: "Real") -> "double":
        r"""model_spot(core_ProcessModel self, Time now, Time spot_maturity_t, Real rate) -> double"""
        return _mxdevtool.core_ProcessModel_model_spot(self, now, spot_maturity_t, rate)

    def model_forward(self, now: "Time", start_t: "Time", forward_period_t: "Time", rate: "Real") -> "double":
        r"""model_forward(core_ProcessModel self, Time now, Time start_t, Time forward_period_t, Real rate) -> double"""
        return _mxdevtool.core_ProcessModel_model_forward(self, now, start_t, forward_period_t, rate)
...
class core_RsgExternal(IRsgWrapper):
    ...
    def __init__(self, sampleNum: "long", dimension: "long", arr2d: "DoubleVectorVector"):
        r"""
    ...
    def nextSequence(self) -> "std::vector< double,std::allocator< double > >":
        r"""nextSequence(core_RsgExternal self) -> DoubleVector"""
        return _mxdevtool.core_RsgExternal_nextSequence(self)

    def sampleNum(self) -> "long":
        r"""sampleNum(core_RsgExternal self) -> long"""
        return _mxdevtool.core_RsgExternal_sampleNum(self)

    def dimension(self) -> "long":
        r"""dimension(core_RsgExternal self) -> long"""
        return _mxdevtool.core_RsgExternal_dimension(self)
...
class core_ScenarioGenerator2(IEvolverBase):
    ...
    def __init__(self, models: "ProcessValueVector", calcs: "ProcessValueVector", corr: "Matrix", timeGrid: "core_TimeGrid", rsg: "IRsgWrapper", filename: "std::string const &", processMomentMatch: "bool", hashCode: "std::string const &", json_input: "std::string const &"):
        r"""__init__(core_ScenarioGenerator2 self, ProcessValueVector models, ProcessValueVector calcs, Matrix corr, core_TimeGrid timeGrid, IRsgWrapper rsg, std::string const & filename, bool processMomentMatch, std::string const & hashCode, std::string const & json_input) -> core_ScenarioGenerator2"""
...
class VanillaSwap(Swap):
    ...
    def __init__(self, type: "VanillaSwap::Type", nominal: "Real", fixedSchedule: "Schedule", fixedRate: "Rate", fixedDayCount: "DayCounter", floatSchedule: "Schedule", index: "core_IborIndex", spread: "Spread", floatingDayCount: "DayCounter"):
        r"""__init__(VanillaSwap self, VanillaSwap::Type type, Real nominal, Schedule fixedSchedule, Rate fixedRate, DayCounter fixedDayCount, Schedule floatSchedule, core_IborIndex index, Spread spread, DayCounter floatingDayCount) -> VanillaSwap"""
...
class core_VanillaSwapExt(VanillaSwap):
    ...
    def __init__(self, type: "VanillaSwap::Type", nominal: "Real", settlementDate: "Date", maturityTenor: "Period", fixedRate: "Real", spread: "Real", mc: "core_MarketConvension"):
        r"""__init__(core_VanillaSwapExt self, VanillaSwap::Type type, Real nominal, Date settlementDate, Period maturityTenor, Real fixedRate, Real spread, core_MarketConvension mc) -> core_VanillaSwapExt"""
        _mxdevtool.core_VanillaSwapExt_swiginit(self, _mxdevtool.new_core_VanillaSwapExt(type, nominal, settlementDate, maturityTenor, fixedRate, spread, mc))
    ...
    def _setPricingParams_YieldCurve(self, yieldcurve: "YieldTermStructure") -> "void":
        r"""_setPricingParams_YieldCurve(core_VanillaSwapExt self, YieldTermStructure yieldcurve)"""
        return _mxdevtool.core_VanillaSwapExt__setPricingParams_YieldCurve(self, yieldcurve)
...
class core_VanillaSwapCCPExt(core_VanillaSwapExt):
    r"""Proxy of C++ VanillaSwapExtCCPPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, type: "VanillaSwap::Type", nominal: "Real", settlementDate: "Date", maturityTenor: "Period", fixedRate: "Real", iborIndex: "core_IborIndex", spread: "Real", familyName: "std::string"):
        r"""__init__(core_VanillaSwapCCPExt self, VanillaSwap::Type type, Real nominal, Date settlementDate, Period maturityTenor, Real fixedRate, core_IborIndex iborIndex, Real spread, std::string familyName) -> core_VanillaSwapCCPExt"""
        _mxdevtool.core_VanillaSwapCCPExt_swiginit(self, _mxdevtool.new_core_VanillaSwapCCPExt(type, nominal, settlementDate, maturityTenor, fixedRate, iborIndex, spread, familyName))
    __swig_destroy__ = _mxdevtool.delete_core_VanillaSwapCCPExt

# Register core_VanillaSwapCCPExt in _mxdevtool:
_mxdevtool.core_VanillaSwapCCPExt_swigregister(core_VanillaSwapCCPExt)
