...
class FenlMagics(Magics):
    ...
    @argument('--experimental', help='When `True`, then experimental features are allowed. Data returned when using this flag is not guaranteed to be correct.')
    @argument('--changed-since-time', help='Time bound (inclusive) after which results will be produced.')
    @cell_magic
    @line_cell_magic
