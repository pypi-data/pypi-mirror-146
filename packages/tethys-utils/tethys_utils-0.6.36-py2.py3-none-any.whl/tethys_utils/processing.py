...
def update_compare_results(previous_result, version_date, new_path, add_old=True):
    """
    ...
    while True:
        try:
            ...
            ## Test the write
            _ = utils.read_pkl_zstd(new_result_path)
        ...
        if compression == 'zstd':
            ...
            while True:
                try:
                    ...
                    ## Test the write
                    _ = utils.read_pkl_zstd(file_path)
...
def save_new_results(nc_path, metadata, version_date, correct_times=False, system_version=4):
    ...
    for b in chunks_list:
        ...
        while True:
            try:
                _ = write_pkl_zstd(f.to_netcdf(), file_path)
