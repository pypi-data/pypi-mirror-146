    ...
    """
{
    ...
    "package_data": {
        "cdk_tweet_queue._jsii": [
            "cdk-tweet-queue@1.0.231.jsii.tgz"
        ],
        "cdk_tweet_queue": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-dynamodb>=1.152.0, <2.0.0",
        "aws-cdk.aws-events-targets>=1.152.0, <2.0.0",
        "aws-cdk.aws-events>=1.152.0, <2.0.0",
        "aws-cdk.aws-iam>=1.152.0, <2.0.0",
        "aws-cdk.aws-lambda-nodejs>=1.152.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.152.0, <2.0.0",
        "aws-cdk.aws-sqs>=1.152.0, <2.0.0",
        "aws-cdk.core>=1.152.0, <2.0.0",
        "constructs>=3.3.263, <4.0.0",
        "jsii>=1.56.0, <2.0.0",
        "publication>=0.0.3"
    ],
    "classifiers": [
