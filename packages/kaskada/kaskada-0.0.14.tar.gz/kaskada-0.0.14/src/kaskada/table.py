...
class IcebergTable(ExternalTable):
    def __init__(self, catalog_bucket: str, catalog_prefix: str, namespace: str, table_name: str):
...
def create_table(table_name: str, time_column_name: str, entity_key_column_name: str, subsort_column_name: str = None, grouping_id: str = None, source: ExternalTable = None, client: Client = None) -> table_pb.CreateTableResponse:
    """
    Creates a table
