...
def input(prefix=">> ", command=None, free=True, cursor=True, timer=True, timeInfo=None, minLength=0, maxLength=0, iHelp=3, cursorVisibleTime=0.9, cursorNotVisibleTime=0.6):
    if prefix is None:
        prefix = ""
    lastpred = ""
