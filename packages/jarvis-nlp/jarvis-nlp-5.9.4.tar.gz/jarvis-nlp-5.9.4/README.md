...
[![Pypi-format](https://img.shields.io/pypi/format/jarvis-nlp)](https://pypi.org/project/jarvis-nlp/#files)
[![Pypi-status](https://img.shields.io/pypi/status/jarvis-nlp)](https://pypi.org/project/jarvis-nlp)
[![sourcerank](https://img.shields.io/librariesio/sourcerank/pypi/jarvis-nlp)](https://libraries.io/pypi/jarvis-nlp)
...
### Setup
   - Clone this [repository](https://github.com/thevickypedia/Jarvis.git) or download it from [pypi](https://pypi.org/project/jarvis-nlp/)
...
[https://pypi.org/project/jarvis-nlp/](https://pypi.org/project/jarvis-nlp/)
