...
class SupportedPipelineType1(Enum):
    Metadata = 'Metadata'
...
class VerticaConnection(BaseModel):
    ...
    type: Optional[VerticaType] = Field(VerticaType.Vertica, description='Service Type')
    ...
    supportedPipelineTypes: Optional[List[SupportedPipelineType1]] = Field(
