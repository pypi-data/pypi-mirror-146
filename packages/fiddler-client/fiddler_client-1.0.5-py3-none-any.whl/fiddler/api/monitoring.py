...
class Monitoring:
    ...
    def initialize_monitoring(  # noqa
        ...
        :param is_sync:             initialize monitoring synchronously
        ...
        init_result = self._init_monitoring_api_call(
            verbose, enable_backend_modifications, is_sync=is_sync
        )
    ...
    def _init_monitoring_api_call(
        ...
        try:
            ...
            # use celery worker for sketch generation
            payload['async'] = True

            if is_sync:
                # generate sketch in the context of the REST API call
                payload['async'] = False
        ...
        if init_result is not None:
            if init_result['success']:
                """
                TODO : Add code to loop on status of task id for Q1 2022

                For Q1 2022, since all client APIs will remain synchronous, we
                poll here for the celery task status irrespective of is_sync value
                """
