...
import os
os.system('pip install en_core_web_lg')
...
class Text():
    ...
    linguistic features are used that engage, "involve" the reader, in the text. The percentage is found
    as the number of "involved" features to "informational" features. "Informational" features' main objective
    ...
    def __init__(self,input_file):
        ...
        # Calculate the involvedness percent
        self.involvedness_percent = round((self.n_involved_features/self.n_info_features)* 100)
    ...
    def summary(self):
        ...
        print("-----------------------------------------------")
        print("Level of involvedness:", round((self.n_involved_features/self.n_info_features)* 100), "%")
