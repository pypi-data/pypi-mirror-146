...
from quantylab.systrader.xing.res import parser

logger = logging.getLogger(__name__)

XING_RES_BLOCKS, XING_RES_OCCURS = parser.import_all()
...
class XAQuery(object):
    ...
    def query(cls, res_name, in_block, is_service=False, force_continue=False):
        ...
        tr.LoadFromResFile("%s%s.res" % (settings.XING_RES_PATH, res_name))
...
if __name__ == '__main__':
    ...
    from quantylab.systrader.xing.session import XASession
    from quantylab.systrader.xing.query import XAQuery
    from quantylab.systrader.xing.real import XAReal
