...
def compile_po():
    for lang in settings['suppoted_languages']:
        ...
        command = ['msgfmt', '-c', '-o', f'{cwd}/locale/{lang}/LC_MESSAGES/kivyapp.mo',f'{cwd}/locale/{lang}/LC_MESSAGES/kivyapp.po']
        subprocess_wrapper(command)
...
def main():
    ...
    parser.add_argument('--mode', dest='mode', type=str, choices=['get', 'make'], required=True, help='Mode of operation')
    parser.add_argument('--verbose', dest='verbose', action='store_true', help='Surname of the candidate')
