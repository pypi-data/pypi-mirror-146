...
VERSION = "0.6.4"
DESCRIPTION = "Test Branch for the better_cryptography library"
setup(
    name= "better cryptography test branch",
    ...
    ext_modules=cythonize(["better_cryptography_test_branch/file_encryption.pyx"]),
