...
def align_dataframe_with_sample(df,sample, fillvalue=0):
...
def create_class_dictionaries(df_original,class_to_use:str):
    ...
    groupby = df.groupby(class_to_use,dropna=False).agg(BV=('BV', 'mean'),
...
def map_conv_prob_using_dictionary(df, prob_dict, bv_dict, column:str):
    """
