...
setup(
    name='decisao_diretoria_363',  # Nome (não precisa ser o nome do repositório, nem de qualquer pasta...)
    version=__version__,
    ...
    url='https://github.com/gaemapiracicaba/norma_dd_363_11',
    ...
    package_data={'': ['data/tab_dd_363.xlsx']},
)
