...
from lifeomic_chatbot_tools.persistence.record_store.base import BaseRecordStore, Record
...
class BaseArtifactManager(ABC):
    ...
    def load_artifact(self, agent_id: str) -> BaseArtifactRecord:
        ...
        artifact = self._artifacts.get(BaseArtifactRecord.make_id(version, agent_id))
