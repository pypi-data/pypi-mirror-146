...
from todo_cli_typer import ERRORS, __app_name__, __version__, config, database, todo_cli_typer
...
def get_todoer() -> todo_cli_typer.Todoer:
    if config.CONFIG_FILE_PATH.exists():
        ...
        raise typer.Exit(1)
    if db_path.exists():
        return todo_cli_typer.Todoer(db_path)
    else:
