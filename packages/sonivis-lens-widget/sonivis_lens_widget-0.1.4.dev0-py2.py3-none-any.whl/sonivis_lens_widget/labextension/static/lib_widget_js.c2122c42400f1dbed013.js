...
exports.hightlight = exports.renderChart = void 0;
const d3 = __importStar(__webpack_require__(/*! d3 */ "webpack/sharing/consume/default/d3/d3"));
const width = 300;
const height = 200;
const MARKS = 16;
function renderChart(domElement, model, view) {
    const svg = d3
        .select(domElement)
        .append('svg')
        .attr('width', width)
...
function hightlight(domElement, value) {
    d3.select(domElement)
        .selectAll('circle.bubble')
        .attr('stroke-width', '3px')
        .attr('stroke', (d) => d.data.type === value ? d3.schemeTableau10[0] : 'none');
}
...
//# sourceMappingURL=bubbleDemo.js.map
...
const bubbleDemo_1 = __webpack_require__(/*! ./bubbleDemo */ "./lib/bubbleDemo.js");
...
class LensModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: LensModel.model_name, _model_module: LensModel.model_module, _model_module_version: LensModel.model_module_version, _view_name: LensModel.view_name, _view_module: LensModel.view_module, _view_module_version: LensModel.view_module_version, value: 'none', x_field: '', y_field: '', _marks_x: [], _marks_y: [], diameter: 0.1, shape: 'circle' });
    }
}
...
class LensView extends base_1.DOMWidgetView {
    render() {
        ...
        bubbleDemo_1.renderChart(this.el, this.model, this);
    ...
    value_changed() {
        ...
        bubbleDemo_1.hightlight(this.el, this.model.get('value'));
