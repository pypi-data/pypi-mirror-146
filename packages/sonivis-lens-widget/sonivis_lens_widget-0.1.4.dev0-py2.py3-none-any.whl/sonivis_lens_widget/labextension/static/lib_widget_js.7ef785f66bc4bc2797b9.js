...
class LensCursor {
    constructor(view, gPlot) {
        ...
        this.clipId = "clip" + (Math.random().toString(36) + '00000000000000000').slice(2, 14);
...
class ScatterPlot {
    constructor(view) {
        ...
        this.updateSubstrateSize();
        this.view.model.on('change:substrate_width change:substrate_height', () => this.updateSubstrateSize(), this.view);
        this.view.model.on('change:_marks_x change:_marks_y', this.updateScatterPlotData, this);
    }
    updateSubstrateSize() {
        const substWidth = this.view.model.get('substrate_width');
        const substHeight = this.view.model.get('substrate_height');
...
//# sourceMappingURL=lib_widget_js.7ef785f66bc4bc2797b9.js.map