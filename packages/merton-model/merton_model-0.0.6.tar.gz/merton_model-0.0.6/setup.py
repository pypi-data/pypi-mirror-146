...
## References
Wang, Yu. “Structural Credit Risk Modeling: Merton and Beyond.” Society of Actuaries, June 2009, Structural Credit Risk Modeling: Merton and Beyond (soa.org). 

Sundaresan, Suresh. “A Review of Merton’s Model of the Firm’s Capital Structure with its Wide Applications.” Columbia Business School, Merton_review_cap_structure.pdf (columbia.edu). 

Hull, John. "Options, Futures, and Other Derivatives" 9th ed. Pearson. 

Das, S. and Kim. "Credit spreads with dynamic debt." Journal of Banking & Finance. 
"""
    ,
