...
{'all': ['boto3>=1.15,<2.0',
         ...
         'pyyaml>=5.4',
         'ujson>=4.0'],
 'all:python_version < "3.9"': ['pymongo>=3,<4.1', 'redis>=3,<4.2'],
 'all:python_version >= "3.9"': ['pymongo>=3', 'redis>=3'],
 'bson': ['bson>=0.5'],
 'docs': ['furo>=2022.3.4,<2023.0.0',
          'linkify-it-py>=1.0,<2.0',
          'myst-parser>=0.17',
          'sphinx>=4.5.0,<5.0.0',
 ...
 'json': ['ujson>=4.0'],
 'mongodb:python_version < "3.9"': ['pymongo>=3,<4.1'],
 'mongodb:python_version >= "3.9"': ['pymongo>=3'],
 'redis:python_version < "3.9"': ['redis>=3,<4.2'],
 'redis:python_version >= "3.9"': ['redis>=3'],
