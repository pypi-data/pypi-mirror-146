...
class ExceptionHandler:
    exceptionmessages = {
        ...
        "Cache.insert": "Invalid set of arguments passed. Please provide value for \"key: str and item: object\" or \""
                        "key: str and item: CacheItem\" or\"key: str, value: CacheItem, lockhandle: LockHandle and "
                        "releaselock: bool\"",
        ...
        "Cache.get_cacheitem": "Invalid set of arguments passed. Please provide value for \"key\" or \"key , "
                               "acquirelock, lockhandle and locktimeout\"",
        "Cache.delete": "Invalid set of arguments passed. Please provide value for \"key\" or \"key and lockhandle\"",
        "Cache.remove": "Invalid set of arguments passed. Please provide value for \"key and objtype\" or \"key, "
                        "objtype\" or \"key, lockhandle, version and objtype\"",
    ...
    def get_invalid_cache_insert_exception_message(itemtype):
        return "lockhandle and releaselock can only be used with item of type " + str(itemtype)
