import pydot
from seqslab.wes.commands import Jobs
...
class TrsCreateTemplate:
    ...
    def create(self, inputs_json: dict, primary_descriptor: str, zip_file: str, **kwargs) -> dict:
        parameter = Jobs.parameter(primary_descriptor=primary_descriptor,
                                   zip_file=zip_file)
    ...
    def desc_template(self, parameter: dict):
        ...
        exec_tmp_json = {"path": "exec.json", "file_type": "EXECUTION_FILE"}
        workflow.append(inputs_json)
        workflow.append(exec_tmp_json)
        return workflow
