...
import jess.JESS_filters_generic as Jf_generic
...
if __name__ == "__main__":
    ...
    if args.gpu_id < 0 or not BACKEND_GPU:
        print("in if")
        BACKEND_GPU = False
        print(type(Jf_generic.xp))
        Jf_generic.xp = np
        Jf_generic.BACKEND_GPU = False
        mad_spectra_flat = Jf_generic.mad_spectra_flat
        master_cleaner(
            file=args.file,
