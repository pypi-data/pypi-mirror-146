...
"""
    ...
    OpenAPI spec version: 16.7.0-rc.0
...
class GearsApi(object):
    ...
    def add_gear_permission(self, gear_name, permissions_type, gear_permissions_input, **kwargs):  # noqa: E501
        """Add individual user, project, or group to the allow-list for a specific gear series.

        This method makes a synchronous HTTP request by default.

        :param str gear_name: Name of the gear to interact with (required)
        :param str permissions_type: Permissions type to add to the gear (required)
        :param GearPermissionsInput gear_permissions_input: (required)
        :param bool async_: Perform the request asynchronously
        :return: GearSeries
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.add_gear_permission_with_http_info(gear_name, permissions_type, gear_permissions_input, **kwargs)  # noqa: E501
        else:
            (data) = self.add_gear_permission_with_http_info(gear_name, permissions_type, gear_permissions_input, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def add_gear_permission_with_http_info(self, gear_name, permissions_type, gear_permissions_input, **kwargs):  # noqa: E501
        """Add individual user, project, or group to the allow-list for a specific gear series.
        ...
        all_params = ['gear_name', 'permissions_type', 'gear_permissions_input']  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'permissions_type' is set
        if ('permissions_type' not in params or
                params['permissions_type'] is None):
            raise ValueError("Missing the required parameter `permissions_type` when calling `add_gear_permission`")  # noqa: E501
        # verify the required parameter 'gear_permissions_input' is set
        if ('gear_permissions_input' not in params or
                params['gear_permissions_input'] is None):
            raise ValueError("Missing the required parameter `gear_permissions_input` when calling `add_gear_permission`")  # noqa: E501
        ...
        if 'permissions_type' in params:
            path_params['PermissionsType'] = params['permissions_type']  # noqa: E501
        ...
        body_params = None
        if 'gear_permissions_input' in params:
            body_params = flywheel.models.GearPermissionsInput.positional_to_model(params['gear_permissions_input'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{GearName}/permissions/{PermissionsType}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_gear_permission(self, gear_name, permissions_type, permissions_id, **kwargs):  # noqa: E501
        """Remove individual user, project, or group from the allow-list for a specific gear series.

        This method makes a synchronous HTTP request by default.

        :param str gear_name: Name of the gear to interact with (required)
        :param str permissions_type: Permissions type to add to the gear (required)
        :param str permissions_id: Id of the user/group/permission that you want to add (required)
        :param bool async_: Perform the request asynchronously
        :return: None
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.delete_gear_permission_with_http_info(gear_name, permissions_type, permissions_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_gear_permission_with_http_info(gear_name, permissions_type, permissions_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def delete_gear_permission_with_http_info(self, gear_name, permissions_type, permissions_id, **kwargs):  # noqa: E501
        """Remove individual user, project, or group from the allow-list for a specific gear series.
        ...
        all_params = ['gear_name', 'permissions_type', 'permissions_id']  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('permissions_type' not in params or
                params['permissions_type'] is None):
            raise ValueError("Missing the required parameter `permissions_type` when calling `delete_gear_permission`")  # noqa: E501
        # verify the required parameter 'permissions_id' is set
        if ('permissions_id' not in params or
                params['permissions_id'] is None):
            raise ValueError("Missing the required parameter `permissions_id` when calling `delete_gear_permission`")  # noqa: E501
        ...
        if 'permissions_type' in params:
            path_params['PermissionsType'] = params['permissions_type']  # noqa: E501
        if 'permissions_id' in params:
            path_params['PermissionsId'] = params['permissions_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{GearName}/permissions/{PermissionsType}/{PermissionsId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_permissions(self, gear_name, **kwargs):  # noqa: E501
        """Remove the allow list and deny list to give everyone access to the gear series.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.delete_permissions_with_http_info(gear_name, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_permissions_with_http_info(gear_name, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def delete_permissions_with_http_info(self, gear_name, **kwargs):  # noqa: E501
        """Remove the allow list and deny list to give everyone access to the gear series.
        ...
        if ('gear_name' not in params or
                params['gear_name'] is None):
            raise ValueError("Missing the required parameter `gear_name` when calling `delete_permissions`")  # noqa: E501
    ...
    def get_gear_series(self, gear_name, **kwargs):  # noqa: E501
        """Get the gear series associated witha specific gear name.
    ...
    def replace_gear_permissions(self, gear_name, gear_permissions, **kwargs):  # noqa: E501
        """Replace the entire permissions for a gear series.

        This method makes a synchronous HTTP request by default.

        :param str gear_name: Name of the gear to interact with (required)
        :param GearPermissionsInput gear_permissions: Permissions to replace the old permissions with (required)
        :param bool async_: Perform the request asynchronously
        :return: GearSeries
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.replace_gear_permissions_with_http_info(gear_name, gear_permissions, **kwargs)  # noqa: E501
        else:
            (data) = self.replace_gear_permissions_with_http_info(gear_name, gear_permissions, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def replace_gear_permissions_with_http_info(self, gear_name, gear_permissions, **kwargs):  # noqa: E501
        """Replace the entire permissions for a gear series.
        ...
        all_params = ['gear_name', 'gear_permissions']  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'gear_permissions' is set
        if ('gear_permissions' not in params or
                params['gear_permissions'] is None):
            raise ValueError("Missing the required parameter `gear_permissions` when calling `replace_gear_permissions`")  # noqa: E501
        ...
        body_params = None
        if 'gear_permissions' in params:
            body_params = flywheel.models.GearPermissionsInput.positional_to_model(params['gear_permissions'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
