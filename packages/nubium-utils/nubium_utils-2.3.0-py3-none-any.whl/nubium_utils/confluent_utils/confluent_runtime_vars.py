...
def default_env_vars():
    ...
    """
    return {
        'NU_CONSUMER_POLL_TIMEOUT': environ.get('NU_CONSUMER_POLL_TIMEOUT', '5'),
        ...
        'NU_CONSUMER_HEARTBEAT_TIMEOUT_SECONDS': str(environ.get('NU_CONSUMER_HEARTBEAT_TIMEOUT_SECONDS', '90')),
