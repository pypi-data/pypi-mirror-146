...
[![Python package builder](https://gitlab.com/omegax/target-core/badges/main/pipeline.svg)](https://gitlab.com/omegax/target-core/-/commits/main)
...
[![Coverage](https://codecov.io/gl/omegax/target-core/branch/\x6d61696e/graph/badge.svg?token=CM6FJI0P5D)](https://codecov.io/gl/omegax/target-core)[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/target-core.svg)](https://pypi.org/project/target-core/)
...
. venv/bin/activate
pip install --upgrade pip
pip install --upgrade https://gitlab.com/ome9ax/target-core/archive/main.tar.gz
```
