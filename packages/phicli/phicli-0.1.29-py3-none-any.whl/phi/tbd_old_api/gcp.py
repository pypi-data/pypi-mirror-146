...
# from phi.utils.common import pprint_error, pprint_network_error
# from phi.utils.log import logger
# from phi.zeus_api.client import ZeusApi, get_authenticated_client, validate_response
#
#
...
#         )
#
#     # If the request failed, display the message from BackendResponse
#     if (
