...
#     dict1={"host":"127.0.0.1","db_name":"8833","port":"883","user":"8833","password":"8833"}
#     print(mysqlDB(dict1).execute("select * from aaa"))
#     print(mysqlDB("shopping.test.mysql1").execute("select * from aaa")
#     mysqlDB(dict1),exec("")
