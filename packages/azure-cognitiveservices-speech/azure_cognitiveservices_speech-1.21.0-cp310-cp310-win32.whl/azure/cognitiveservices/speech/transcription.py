...
class Participant():
    ...
    def set_voice_signature(self, signature: str):
        """
    ...
    @staticmethod
    def _get_impl(object_type, user_id, preferred_language, voice_signature):
...
class Conversation():
    ...
    def mute_participant_async(self, participant_id: str):
        """
    ...
    def unmute_participant_async(self, participant_id: str):
        """
    ...
    @staticmethod
    def _get_impl(object_type, speech_config, conversation_id):
...
class ConversationTranscriber(Recognizer):
    ...
    def join_conversation_async(self, conversation: Conversation):
        """
    ...
    @staticmethod
    def _get_impl(object_type, audio_config):
