...
from corai.src.train.history import history_create
...
def nn_train(net, data_X, data_Y, params_training, indic_train_X, indic_train_Y,
    ...
    X_val_on_device, Y_val_on_device, history = _prep_data_history(data_X, data_Y, device, epoch, indic_val_X,
...
def _prep_data_history(data_X, data_Y, device, epoch, indic_validation_X, indic_validation_Y,
