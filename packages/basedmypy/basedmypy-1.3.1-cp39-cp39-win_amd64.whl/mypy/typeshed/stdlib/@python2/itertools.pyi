from typing import Any, Callable, Generic, Iterable, Iterator, Sequence, Tuple, TypeVar, overload
...
@overload
def islice(iterable: Iterable[_T], start: int | None, stop: int | None, step: int | None = ...) -> Iterator[_T]: ...
