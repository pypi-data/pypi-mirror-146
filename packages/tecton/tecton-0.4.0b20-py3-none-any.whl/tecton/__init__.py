...
from tecton._fwv5.entity import Entity as fwv5_Entity

# This is a type alias for a "true" entity FCO (FWv3 or FWv5), provided for
# convenience. OverriddenEntity is not included here since that is a mechanism
# to override join keys which differs between FWv3 and FWv5.
ENTITY_TYPE = Union[Entity, fwv5_Entity]
