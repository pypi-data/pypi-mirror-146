...
def convert_column_to_value(col, col_type):
    ...
    elif col_type == odbc_pb2.FLOAT32:
        return struct.unpack('f', int.from_bytes(col, byteorder='little', signed=False).to_bytes(4, byteorder="little"))[0]
    elif col_type == odbc_pb2.FLOAT64:
        raise Exception('Python does not support native FLOAT64 columns. Try casting the datatype of your column to string or float32. Ex STRING(<column_name>)')
