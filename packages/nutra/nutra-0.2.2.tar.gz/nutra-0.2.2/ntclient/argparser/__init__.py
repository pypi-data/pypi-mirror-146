...
from ntclient.argparser import funcs as parser_funcs, types
...
################################################################################
def build_init_subcommand(subparsers):
...
def build_nt_subcommand(subparsers):
...
def build_search_subcommand(subparsers):
    """Search: terms [terms ... ]"""
...
def build_sort_subcommand(subparsers):
...
def build_analyze_subcommand(subparsers):
...
def build_day_subcommand(subparsers):
...
def build_recipe_subcommand(subparsers):
...
def build_biometric_subcommand(subparsers):
