...
def SecurityGroupRule(stem, props, sg_id=None, type=None, from_port=None, to_port=None, protocol=None, cidr=None, description=None, provider=None, parent=None, depends_on=None):
    sgr =  ec2_classic.SecurityGroupRule(
        f'secgrprule-{type}-{stem}',
        type=type,
        from_port=from_port,
        to_port=to_port,
        protocol=protocol,
