...
class GPUShaderCreateInfo:
  ...
  * ``BOOL``
      ...
      :param size:      
        If not zero, indicates that the constant is an array with the specified size.
  ...
  * ``DEPTH_CUBE_ARRAY``
      ...
      :param name:      
        The image texture sampler name.
  ...
  * ``BOOL``
  ...
  def __init__(self) -> None:
    ...
    :param blend:     
      Dual Source Blending Index. It can be 'NONE', 'SRC_0' or 'SRC_1'.
  ...
  def fragment_out(self, slot: int, type: typing.Any, name: typing.Any, blend: typing.Any = 'NONE') -> None:
  ...
  def fragment_source(self, source: typing.Any) -> None:
  ...
  def push_constant(self, type: typing.Any, name: typing.Any, size: typing.Any = 0) -> None:
  ...
  def sampler(self, slot: int, type: typing.Any, name: typing.Any) -> None:
  ...
  def vertex_in(self, slot: int, type: typing.Any, name: typing.Any) -> None:
  ...
  def vertex_source(self, source: typing.Any) -> None:
...
class GPUStageInterfaceInfo:
  ...
  * ``BOOL``
  ...
  def flat(self, type: typing.Any, name: typing.Any) -> None:
  ...
  def no_perspective(self, type: typing.Any, name: typing.Any) -> None:
  ...
  def smooth(self, type: typing.Any, name: typing.Any) -> None:
