...
class FieldMapping(object):
    ...
    @classmethod
    def mapping(
        cls, name, is_drop_all_fields=None, input_fields=None, output_field=None
    ):
    ...
    def input_field(cls, field_name, param=None, if_missing=None, is_drop=None):
        ...
        """
        return InputField(
            field_name=field_name, param=param, if_missing=if_missing, is_drop=is_drop
        )
    ...
    def output_field(cls, field_name, sql_expression, on_error=None):
        ...
        """
        return OutputField(
            field_name=field_name, sql_expression=sql_expression, on_error=on_error
        )


class Mapping(FieldMapping):
    def __init__(
        self, name, is_drop_all_fields=None, input_fields=None, output_field=None
    ):
        self.name = name
