...
class UsersApi(object):
    ...
    def get_0(self, user, **kwargs):  # noqa: E501
        """Retrieve User  # noqa: E501

        Retrieve user by email.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_0(user, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_0_with_http_info(user, **kwargs)  # noqa: E501
        else:
            (data) = self.get_0_with_http_info(user, **kwargs)  # noqa: E501
            return data

    def get_0_with_http_info(self, user, **kwargs):  # noqa: E501
        """Retrieve User  # noqa: E501

        Retrieve user by email.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_0_with_http_info(user, async_req=True)
        >>> result = thread.get()
