        ...
        if self.extension == ".rdy":
            ...
            if (self._series is not None and AccelerationUncalibratedSeries in self._series) or self._series is None:
                try:
                    ...
                    logger.error("(%s) DatabaseError occurred when accessing acc_uncal_measurements_table" % self.filename)
                    logger.error(e)
            ...
            if (self._series is not None and MagnetometerUncalibratedSeries in self._series) or self._series is None:
                try:
                    ...
                    logger.error("(%s) DatabaseError occurred when accessing mag_uncal_measurements_table" % self.filename)
                    logger.error(e)
            ...
            if (self._series is not None and GNSSClockMeasurementSeries in self._series) or self._series is None:
                try:
                    ...
                    logger.error("(%s) DatabaseError occurred when accessing gnss_clock_measurement_table" % self.filename)
                    logger.error(e)
