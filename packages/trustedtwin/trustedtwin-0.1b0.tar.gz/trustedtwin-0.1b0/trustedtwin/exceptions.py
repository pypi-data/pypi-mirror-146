...
ERR_MSG_TEMPLATE = 'Error occurred for API operation: "{api_operation}", sub code: "{sub_code}", reason: "{desc}".'
...
class TTInternalError(TTAPIResponseException):              # pylint: disable=missing-class-docstring
    pass


class TTUnauthorizedError(TTAPIResponseException):      # pylint: disable=missing-class-docstring
    pass
...
class TTResponseTimeout(TTAPIResponseException):        # pylint: disable=missing-class-docstring
    pass


class TTResourceNotFound(TTAPIResponseException):       # pylint: disable=missing-class-docstring
    pass


class TTForbiddenError(TTAPIResponseException):         # pylint: disable=missing-class-docstring
    pass


class TTProcessingError(TTAPIResponseException):        # pylint: disable=missing-class-docstring
    pass


def get_tt_exception(response: 'TTResponse', api_operation: str) -> TTAPIResponseException:
    ...
    exc = sub_code_to_exception.get(sub_code, TTInternalError)
