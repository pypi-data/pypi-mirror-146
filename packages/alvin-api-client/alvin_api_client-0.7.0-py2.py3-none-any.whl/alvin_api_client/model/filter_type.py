...
class FilterType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["TEXT_INPUT", "NUM_RANGE", "DROPDOWN", "TAG", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["TEXT_INPUT", "NUM_RANGE", "DROPDOWN", "TAG", ]  # noqa: E501
