...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_data_entity_dependencies_api_v1_entity_dependency_get_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/entity/dependency',
                'operation_id': 'find_data_entity_dependencies_api_v1_entity_dependency_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
                'all': [
                    'to_or_from_data_entity_ids',
                ],
                'required': [
                    'to_or_from_data_entity_ids',
                ],
            ...
            root_map={
                ...
                'attribute_map': {
                    'to_or_from_data_entity_ids': 'to_or_from_data_entity_ids',
                },
                'location_map': {
                    'to_or_from_data_entity_ids': 'query',
                },
                'collection_format_map': {
                    'to_or_from_data_entity_ids': 'multi',
                }
            },
            headers_map={
                'accept': [
    ...
    def find_data_entity_dependencies_api_v1_entity_dependency_get(
        self,
        to_or_from_data_entity_ids,
        **kwargs
    ):
        ...
        >>> thread = api.find_data_entity_dependencies_api_v1_entity_dependency_get(to_or_from_data_entity_ids, async_req=True)
        >>> result = thread.get()

        Args:
            to_or_from_data_entity_ids ([str]):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['to_or_from_data_entity_ids'] = \
            to_or_from_data_entity_ids
        return self.find_data_entity_dependencies_api_v1_entity_dependency_get_endpoint.call_with_http_info(**kwargs)
