...
def create_input(type='usb', *args, **kwargs):
    '''
    Factory method for creating a video or audio input interface.
    Supports types: 'ffmpeg', 'pylon', 'raw_video', 'ueye', 'usb'/'video', 'microphone'
    '''
    if type == 'ffmpeg':
