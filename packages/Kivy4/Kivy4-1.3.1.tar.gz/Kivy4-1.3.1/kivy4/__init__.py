...
class Kivy4(MDApp):
    ...
    def __init__(self, string: str = '', app_name: str = '', list_of_files: list = None,
                 screen_size=None, min_x: int = 0.1, min_y: int = 0.1, center: bool = True,
                 run_at_build: bool = False, sun_icon: str = 'white-balance-sunny',
                 moon_icon: str = 'weather-night', main_color: str = 'Blue', icon: str = '',
                 toolbar = False, custom_classes: bool = True, **kwargs):
    ...
    def getToolbar(self, properties: list):
        if properties == True:
            properties = ['toolbar', self.app_name, '[]', '[app.dark_mode_icon, lambda x: self.reverseDarkMode()]']
