...
def Spec(name: str, filename: str = 'main.py', icon: str = '', path: str = os.getcwd()):
...
class Kivy4(MDApp):
    ...
    def __init__(self, string: str = '', app_name: str = '', list_of_files: list = None,
                 ...
                 toolbar = False, custom_classes: bool = True, disable_x: bool = False, **kwargs):
    ...
    def getToolbar(self, properties: list):
        if properties == True:
            properties = ['toolbar', self.app_name, '[]', '[[app.dark_mode_icon, lambda x: app.reverseDarkMode()]]']
