...
class SDK(Integration):
    ...
    def make_sdk(access_token: str, secret_token: str):
        host: str = get_fact_endpoint("ehelply-security")
    ...
    @staticmethod
    def make_client(include_default_headers: bool = True) -> ApiClient:
        api_client: ApiClient = ApiClient(configuration=SDK.configuration)
