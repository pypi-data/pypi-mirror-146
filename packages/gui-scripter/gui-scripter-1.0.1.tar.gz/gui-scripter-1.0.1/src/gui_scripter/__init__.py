...
class Gui:
    ...
    def __init__(self):
        ...
        self.icon = ImageTk.PhotoImage(Image.open(os.path.join(self._SRC_PATH, 'gui_scripter/static/rob_icon.png')))
        self.root.iconphoto(False, self.icon)

        self.app_frame = ttk.Frame(self.root, width=self.app_width, height=self.app_height)

        self.main_image = ImageTk.PhotoImage(Image.open(os.path.join(self._SRC_PATH, 'gui_scripter/static/rob.png')))
