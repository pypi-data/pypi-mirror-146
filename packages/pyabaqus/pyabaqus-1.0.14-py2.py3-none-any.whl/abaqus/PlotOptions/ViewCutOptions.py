...
class ViewCutOptions:
    ...
    *viewCutOptions* members are created. These settings can be set to customize user 
    ...
    freeBodyStepThru: SymbolicConstant
    ...
    showHeatFlowRate: SymbolicConstant
    ...
    componentResolution: SymbolicConstant
    ...
    def setValues(self, options: 'ViewCutOptions' = None, belowOptions: str = None,
        ...
        ----------
        options
            A ViewCutOptions object from which values are to be copied. If other arguments are also 
