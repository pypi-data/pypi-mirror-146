...
class DisplacementAdaptiveMeshConstraintState(AdaptiveMeshConstraintState):
    ...
    def __init__(self, u1: float = None, u2: float = None, u3: float = None, ur1: float = None, ur2: float = None,
                 ur3: float = None, u1State: SymbolicConstant = None, u2State: SymbolicConstant = None,
                 u3State: SymbolicConstant = None, ur1State: SymbolicConstant = None, ur2State: SymbolicConstant = None,
                 ur3State: SymbolicConstant = None, amplitudeState: SymbolicConstant = None,
