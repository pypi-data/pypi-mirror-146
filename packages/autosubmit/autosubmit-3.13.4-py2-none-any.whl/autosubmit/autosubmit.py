            ...
            with portalocker.Lock(os.path.join(tmp_path, 'autosubmit.lock'), timeout=1) as fh:
                try:
                    ...
                    try:
                        ...
                        Log.debug("Autosubmit couldn't set your experiment as running on the main database: {1}. Exception: {0}".format(str(e), os.path.join(BasicConfig.DB_DIR, BasicConfig.AS_TIMES_DB)), 7003)
                    if allowed_members:
