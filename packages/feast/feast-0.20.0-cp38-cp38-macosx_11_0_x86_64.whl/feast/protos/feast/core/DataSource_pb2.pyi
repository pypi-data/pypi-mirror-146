...
class DataSource(google.protobuf.message.Message):
    ...
    class PushOptions(google.protobuf.message.Message):
        ...
        SCHEMA_FIELD_NUMBER: builtins.int
        @property
        def schema(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, feast.types.Value_pb2.ValueType.Enum.ValueType]:
            """Mapping of feature name to type"""
            pass
        def __init__(self,
            *,
            schema : typing.Optional[typing.Mapping[typing.Text, feast.types.Value_pb2.ValueType.Enum.ValueType]] = ...,
            ) -> None: ...
