...
def get_permission(id: str):
    endpoint = f"document-registry/documents/permission/{id}"
    return __get_request(endpoint)


@data_request(transformer=no_transform)
def get_permission_by_resource_id(resource_id: str):
    endpoint = f"document-registry/documents/permission/resource/{resource_id}"
    return __get_request(endpoint)


@data_request(transformer=no_transform)
def get_permissions_by_resource_id(resource_id: str):
    endpoint = f"document-registry/documents/permission/resource/{resource_id}/permissions"
    return __get_request(endpoint)
