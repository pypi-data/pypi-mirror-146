...
PADDLE_API Tensor arange(const Tensor& start, const Tensor& end, const Tensor& step, DataType dtype, Place place={});
...
PADDLE_API Tensor copy_to(const Tensor& x, Place place, bool blocking);
...
PADDLE_API Tensor empty(const IntArray& shape, DataType dtype=DataType::FLOAT32, Place place=CPUPlace());

PADDLE_API Tensor empty_like(const Tensor& x, DataType dtype=DataType::UNDEFINED, Place place={});
...
PADDLE_API Tensor full(const IntArray& shape, const Scalar& value, DataType dtype=DataType::FLOAT32, Place place=CPUPlace());

PADDLE_API Tensor full_batch_size_like(const Tensor& input, const std::vector<int>& shape, DataType dtype, const Scalar& value, int input_dim_idx, int output_dim_idx, Place place=CPUPlace());

PADDLE_API Tensor full_like(const Tensor& x, const Scalar& value, DataType dtype=DataType::UNDEFINED, Place place={});
...
PADDLE_API Tensor ones_like(const Tensor& x, DataType dtype=DataType::UNDEFINED, Place place={});
...
PADDLE_API Tensor randint(int low, int high, const IntArray& shape, DataType dtype=DataType::INT64, Place place={});

PADDLE_API Tensor randperm(int n, DataType dtype, Place place={});
...
PADDLE_API Tensor truncated_gaussian_random(const std::vector<int>& shape, float mean, float std, int seed, DataType dtype=DataType::FLOAT32, Place place={});
...
PADDLE_API Tensor uniform_random(const IntArray& shape, DataType dtype, float min, float max, int seed, Place place={});
...
PADDLE_API std::tuple<Tensor,Tensor> unsqueeze(const Tensor& x, const IntArray& axes);
...
PADDLE_API Tensor zeros_like(const Tensor& x, DataType dtype=DataType::UNDEFINED, Place place={});
