...
from bounding_ai_tool.python.utility.Initializer import init, cleanup
...
class InitializerModule(Module):
    """ Does some basic initialization of the blender project.
     ...
     If you want deterministic outputs use the environment variable: "BOUNDING_AI_TOOL_RANDOM_SEED" and set it to
