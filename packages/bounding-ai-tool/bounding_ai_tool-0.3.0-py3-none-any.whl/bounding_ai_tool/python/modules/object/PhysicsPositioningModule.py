...
from bounding_ai_tool.python.types.MeshObjectUtility import MeshObject
from bounding_ai_tool.python.object.PhysicsSimulation import simulate_physics_and_fix_final_poses
...
class PhysicsPositioningModule(Module):
    ...
    **Configuration**:
    ...
    .. list-table::
        ...
        * - convex_decomposition_cache_path
          - If a directory is given, convex decompositions are stored there named after the meshes hash. If the same mesh is decomposed a second time, the result is loaded from the cache and the actual decomposition is skipped.
            Default: "bounding_ai_tool_resources/decomposition_cache"
          - string
        * - vhacd_path
          - The directory in which vhacd should be installed or is already installed.
            Default: "bounding_ai_tool_resources/vhacd"
          - string
    """
    ...
    def __init__(self, config):
        ...
        self.convex_decomposition_cache_path = self.config.get_string("convex_decomposition_cache_path", "bounding_ai_tool_resources/decomposition_cache")
        self.vhacd_path = self.config.get_string("vhacd_path", "bounding_ai_tool_resources/vhacd")
