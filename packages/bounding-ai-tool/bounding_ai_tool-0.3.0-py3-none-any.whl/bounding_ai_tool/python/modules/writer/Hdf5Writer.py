...
from bounding_ai_tool.python.modules.writer.WriterInterface import WriterInterface
    ...
    def run(self):
        ...
        for frame in range(bpy.context.scene.frame_start, bpy.context.scene.frame_end):
            ...
            with h5py.File(hdf5_path, "w") as f:
                ...
                if bounding_ai_tool_version:
                    WriterUtility._write_to_hdf_file(f, "bounding_ai_tool_version", np.string_(bounding_ai_tool_version))
