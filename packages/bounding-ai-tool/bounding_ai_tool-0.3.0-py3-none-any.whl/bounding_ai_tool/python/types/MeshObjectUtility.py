...
if platform != "win32":
    ...
    from bounding_ai_tool.external.vhacd.decompose import convex_decomposition
...
from bounding_ai_tool.python.material import MaterialLoaderUtility
...
class MeshObject(Entity):
    ...
    def build_convex_decomposition_collision_shape(self, vhacd_path: str, temp_dir: str = None, cache_dir: str = "bounding_ai_tool_resources/decomposition_cache"):
