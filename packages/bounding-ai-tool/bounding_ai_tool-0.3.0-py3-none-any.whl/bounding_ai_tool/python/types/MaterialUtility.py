...
from bounding_ai_tool.python.utility import BlenderUtility
...
class Material(Struct):
    ...
    def __init__(self, material: bpy.types.Material):
        ...
        if not material.use_nodes:
            raise Exception("The given material " + material.name + " does not have nodes enabled and can therefore not be handled by Bounding AI Tool's Material wrapper class.")
