...
class BatchResponse(BaseBatchResponse[Response]):
    ...
    @property
    def responses(self) -> frozenset[Response]:  # pragma: no cover
        """
        Returns the :py:class:`frozenset` object representing a copy of the :class:`jsonrpc.BatchResponse` iterable object.
    ...
    def json(self) -> list[dict[str, Any]]:
        ...
        """
        sorter: Callable[[dict[str, Any]], bool] = lambda obj: "result" in obj and "error" not in obj
