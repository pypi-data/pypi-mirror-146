...
class ResponseBillingHistoryInfo(object):
    ...
    def __init__(self, amount=None, created_by=None, created_dt=None, experiment=None, project=None, status=None, total=None, type=None, workspace=None, local_vars_configuration=None):  # noqa: E501
