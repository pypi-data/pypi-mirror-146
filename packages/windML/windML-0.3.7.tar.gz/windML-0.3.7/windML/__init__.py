...
from windML.oneshot.models.recurrent_elm import RecurrentELM
from windML.fewshot.recurrent_neural_network.rnn import RNN
from windML.fewshot.recurrent_neural_network.character_rnn import charRNN
