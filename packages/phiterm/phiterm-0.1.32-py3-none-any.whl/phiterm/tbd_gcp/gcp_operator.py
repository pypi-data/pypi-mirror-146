...
#
#
# def get_default_sa_key_path_(ws_dir_path: Path) -> Path:
#     return ws_dir_path.joinpath("phi").joinpath("keys").joinpath("phidata-sa-pk.json")
#
#
...
#
#     Steps:
#     1. Validate the ws_data, ws_dir_path and ws_config_file_path
...
#     ######################################################
#     # Step 1: Validate the ws_data, ws_dir_path and ws_config_file_path
...
#         return None
#
#     # Validate that this workspace has a ws_dir_path and ws_config_file_path set
#     # Because without the ws_dir_path and ws_config_file_path there's not point in reading the config
#     ws_dir_path: Optional[Path] = ws_data.ws_dir_path
#     ws_config_file_path: Optional[Path] = ws_data.ws_config_file_path
#     if ws_dir_path is None or ws_config_file_path is None:
#         pprint_error(
...
#         else get_default_sa_key_path_(ws_dir_path)
#     )
#
