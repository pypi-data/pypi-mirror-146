...
class CustomRolesApi(object):
    ...
    def get(self, role_name, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_with_http_info(role_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_with_http_info(role_name, **kwargs)  # noqa: E501
            return data

    def get_with_http_info(self, role_name, **kwargs):  # noqa: E501
        """Retrieve role  # noqa: E501

        Retrieve a role by name for your organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_with_http_info(role_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('role_name' not in params or
                params['role_name'] is None):
            raise ValueError("Missing the required parameter `role_name` when calling `get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/orgs/self/roles/{roleName}', 'GET',
            body_params,
            path_params,
            query_params,
            header_params,
