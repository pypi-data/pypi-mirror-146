...
setuptools.setup(
    ...
    package_data={
        "faster_dj_dev.templates": ["*.html", "*.py"],
    ...
    license='MIT',
    packages=['faster_dj_dev','faster_dj_dev.templates', 'faster_dj_dev.core', 'faster_dj_dev.data', 'faster_dj_dev.utils', 'faster_dj_dev.venvs', 'faster_dj_dev.commands'],
    install_requires=['black==22.3.0', 'click==8.1.0', 'colorama==0.4.4', 'termcolor==1.1.0'],
)
