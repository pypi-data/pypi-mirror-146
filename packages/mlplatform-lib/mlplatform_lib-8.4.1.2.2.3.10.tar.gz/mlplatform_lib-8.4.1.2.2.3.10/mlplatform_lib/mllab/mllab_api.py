...
class MllabApi:
    ...
    def save_do(self, input_data: pd.DataFrame, do_id: str, is_truncated: str = False) -> bool:
        if self.api_client.run_mode == RunMode.KUBERNETES:
            ...
            print("Current mode is local, Skip save_do.")
    ...
    def save_do_with_create_do(self, input_data: pd.DataFrame):
        ...
        if self.api_client.run_mode == RunMode.KUBERNETES:
            ...
            print("Current mode is local, Skip save_do_with_create_do.")
