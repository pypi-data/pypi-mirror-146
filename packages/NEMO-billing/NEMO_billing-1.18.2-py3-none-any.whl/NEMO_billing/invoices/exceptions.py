...
class NoProjectCategorySetException(NEMOException):
    def __init__(self, rate_type: RateType, project: Project):
        self.rate_type = rate_type
        self.project = project
        msg = f"{self.rate_type.get_type_display()} is category specific but no category is set on project {project.name}"
        super().__init__(msg)
