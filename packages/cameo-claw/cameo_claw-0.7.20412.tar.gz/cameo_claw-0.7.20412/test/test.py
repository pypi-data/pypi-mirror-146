...
from cameo_claw import it_distinct, it_streaming_pd, it_group, it_filter, server, it_filter_group
import time
...
def test_it_download():
    ...
    for int_progress, done_url in it_streaming_pd(get_lst_url_taipei_100(), target_directory):
