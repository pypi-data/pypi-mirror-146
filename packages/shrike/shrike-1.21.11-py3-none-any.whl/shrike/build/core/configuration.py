...
class Configuration:
    ...
    component_cli_version: str = field(default="0.9.6")
    ...
    workspaces: List[str] = field(default_factory=lambda: _EMPTY_LIST, metadata={"nargs": "*"})
    ...
    registries: List[str] = field(default_factory=lambda: _EMPTY_LIST, metadata={"nargs": "*"})
