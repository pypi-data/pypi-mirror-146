...
from owlery_client.api.knowledgebases_api_endpoints.kbs_get import KbsGet
from owlery_client.api.knowledgebases_api_endpoints.kbs_kb_get import KbsKbGet
