__all__ = ('UserProfilePoint', 'RussianProfilePoint', 'RussianProfileObjectPoint', 'UpdateProfileCreditScoringPoint')
...
class ProfileReadContract(ProfileCreateContract):
    ...
    credit_score_created = serializers.DateTimeField()
    # Address
    address_code = serializers.CharField(max_length=64, allow_null=True)
    address_coordinates = serializers.CharField(max_length=64, allow_null=True)
    # property
...
class UpdateProfileCreditScoringCreateContract(Contract):
...
class UpdateProfileCreditScoringID(ID):
    _service = SERVICE
    _app = 'profiles'
    _view_set = 'update_profile_credit_scoring'
...
class UpdateProfileCreditScoringPoint(CreatePointMixin, ContractPoint):
    _point_id = UpdateProfileCreditScoringID()
    _create_contract = UpdateProfileCreditScoringCreateContract
