...
class QLevelOfDetailBoundingSphere(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QLevelOfDetailBoundingSphere') -> bool: ...
    def __eq__(self, other: 'QLevelOfDetailBoundingSphere') -> bool: ...
...
class QTextureDataUpdate(PyQt6.sip.simplewrapper):
    ...
    def __eq__(self, rhs: 'QTextureDataUpdate') -> bool: ...
    def __ne__(self, rhs: 'QTextureDataUpdate') -> bool: ...
...
class QTextureImageDataGenerator(Qt3DCore.QAbstractFunctor):
    ...
    def __ne__(self, other: 'QTextureImageDataGenerator') -> bool: ...
    def __eq__(self, other: 'QTextureImageDataGenerator') -> bool: ...
