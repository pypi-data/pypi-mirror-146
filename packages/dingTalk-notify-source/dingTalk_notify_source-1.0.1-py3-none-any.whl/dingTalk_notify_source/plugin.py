"""
  @Project     : dingTalk_notify_source
...
class DingTalkNotifyPlugin(CorePluginMixin, notify.NotificationPlugin):
    title = "DingTalk Notify To People"
    slug = "dingtalknotifytopeople"
    description = "Post notifications to Dingtalk @ people."
    conf_key = "dingtalknotifytopeople"
    required_field = "webhook"
    author = "sourceGods"
    # author_url = "https://github.com/source/sentry-dingtalk"
    version = "1.0.1"
    # resource_links = [
    #     ("Report Issue", "https://github.com/source/sentry-dingtalk/issues"),
    #     ("View Source", "https://github.com/source/sentry-dingtalk"),
    # ]
    ...
    def _post(self, group, project):
        ...
        payload = f"{payload} > 查看详情: [{group.title}]({issue_link}) \n\n"
