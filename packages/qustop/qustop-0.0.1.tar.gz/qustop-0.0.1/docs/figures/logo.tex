...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[text depth=1pt,bend angle=45]
			...
			\tikzstyle{Charlie}=[shape=regular polygon, regular polygon sides=8, draw, minimum height=20mm, minimum width=20mm,draw=black!50, thick, fill=red!70]			

				\node[Charlie] (Charlie) at (5,0) {\textcolor{white}{\huge{QUSTOP}}};
				\node (name) at (5, -1) {\huge{\textcolor{white}{$\ket{\psi}$}}};
