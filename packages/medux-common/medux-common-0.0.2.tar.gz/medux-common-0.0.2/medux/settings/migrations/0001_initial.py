    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scope",
                    enumfields.fields.EnumIntegerField(enum=medux.settings.Scope),
                ),
                (
                    "tenant",
                    models.ForeignKey(
            ...
            options={
                ...
                "permissions": [
                    (
                        "change_own_user_settings",
                        "Can change own user's scoped settings",
                    ),
                    (
                        "change_own_tenant_settings",
                        "Can change own tenant's scoped settings",
                    ),
                ],
                "unique_together": {
