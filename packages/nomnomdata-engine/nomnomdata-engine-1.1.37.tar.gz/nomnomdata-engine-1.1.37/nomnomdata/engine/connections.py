...
DatabricksConnection = Connection(
    alias="Databricks Connection",
    description="Credentials to use to connect to Databricks' REST API.",
    ...
    parameter_groups=[
        ParameterGroup(
            Parameter(
                ...
                description="Databricks machine instance URL.  Formatted as: abc-d1e2345f-a6b2.cloud.databricks.com",
                type=String(),
                required=True,
            ),
            Parameter(
                ...
                description="Username for authentication. Leave blank to use a personal access token.",
                type=String(),
                required=False,
                default="",
            ),
            Parameter(
                ...
                description="Password for authentication. Leave blank to use a personal access token.",
                type=Password(),
                required=False,
            ),
            Parameter(
                name="token",
                display_name="Token",
                description="Personal access token for authentication. Leave blank to use a username and password.  If specifed, any username and password specified will be ignored.",
                type=Password(),
                required=False,
            ),
...
SanMarPOWSConnection = Connection(
    alias="SanMar Purchase Ordering Connection",
    description="Credentials to use to connect to SanMar's Purchase Ordering web service.",
    ...
    parameter_groups=[
        ParameterGroup(
            Parameter(
                ...
                description="Select the type of Purchase Ordering web service to access.",
            ...
            Parameter(
                ...
                description="Customer number to use to connect to SanMar's Purchase Ordering web service.",
                type=String(),
                required=True,
            ),
            Parameter(
                name="sanMarUserName",
                display_name="Username",
                description="Username used to use to connect to SanMar's Purchase Ordering web service.",
                type=String(),
                required=True,
            ),
            Parameter(
                ...
                display_name="Password",
                description="Password to use to connect to SanMar's Purchase Ordering web service.",
                type=Password(),
                required=True,
            ),
