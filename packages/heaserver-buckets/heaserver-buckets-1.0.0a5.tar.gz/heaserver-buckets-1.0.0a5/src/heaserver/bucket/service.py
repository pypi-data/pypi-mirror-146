...
async def get_bucket_options(request: web.Request) -> web.Response:
    ...
    responses:
      ...
      '404':
        $ref: '#/components/responses/404'
    """
    return await awsservicelib.get_options(request, ['GET', 'POST', 'HEAD', 'OPTIONS'], awsservicelib.has_bucket)
...
async def get_buckets_options(request: web.Request) -> web.Response:
    ...
    responses:
      ...
      '404':
        $ref: '#/components/responses/404'
    """
    return await awsservicelib.get_options(request, ['GET', 'HEAD', 'OPTIONS'], awsservicelib.has_volume)
