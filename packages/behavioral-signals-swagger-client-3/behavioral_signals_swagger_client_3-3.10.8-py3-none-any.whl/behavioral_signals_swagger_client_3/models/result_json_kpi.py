...
class ResultJSONKpi(object):
    ...
    def customer_satisfaction(self, customer_satisfaction):
        ...
        :type: float
        """
        if customer_satisfaction is not None and customer_satisfaction > 1:  # noqa: E501
            raise ValueError("Invalid value for `customer_satisfaction`, must be a value less than or equal to `1`")  # noqa: E501
        if customer_satisfaction is not None and customer_satisfaction < 0:  # noqa: E501
            raise ValueError("Invalid value for `customer_satisfaction`, must be a value greater than or equal to `0`")  # noqa: E501
