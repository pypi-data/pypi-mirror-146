...
class TableListLoader(ResultLoader):
    def __init__(self, create_session: Callable[[], Session], initial_url: str):
        self.__create_session = create_session
    ...
    def load(self) -> List[Table]:
        ...
        try:
            ...
            if status_code == 401:
                ...
                raise ApiError(self.__initial_url, status_code, response_text)
...
class QueryLoader(ResultLoader):
    ...
    def __init__(self, create_session: Callable[[], Session], initial_url: str, query: Optional[str] = None):
        self.__create_session = create_session
        self.__initial_url = initial_url
        self.__current_url: Optional[str] = None
        self.__query = query
...
class TableWrapper:
    ...
    def __init__(self, create_session: Callable[[], Session], table_name: str, url: str):
        self.__create_session = create_session
    ...
    def info(self):
        ...
        try:
            ...
            if status_code == 401:
                ...
                raise ApiError(self.__url, status_code, raw_response_body)
    ...
    def data(self) -> Iterator[Dict[str, Any]]:
        ...
        return ResultIterator(QueryLoader(create_session=self.__create_session,
...
class DataConnectClient(BaseServiceClient):
    ...
    def query(self, query: str) -> Iterator[Dict[str, Any]]:
        """ Run an SQL query """
        return ResultIterator(QueryLoader(create_session=self.create_request_session,
                                          initial_url=urljoin(self.url, r'search'),
                                          query=query))

    def iterate_tables(self) -> Iterator[Table]:
        """ Iterate the list of tables """
        return ResultIterator(TableListLoader(create_session=self.create_request_session,
    ...
    def table(self, table: Union[Table, TableWrapper, str]) -> TableWrapper:
        ...
        return TableWrapper(create_session=self.create_request_session,
