...
class BodyAssignAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidAssignPost(ModelNormal):
    ...
    def _from_openapi_data(cls, assignee, *args, **kwargs):  # noqa: E501
        """BodyAssignAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidAssignPost - a model defined in OpenAPI
