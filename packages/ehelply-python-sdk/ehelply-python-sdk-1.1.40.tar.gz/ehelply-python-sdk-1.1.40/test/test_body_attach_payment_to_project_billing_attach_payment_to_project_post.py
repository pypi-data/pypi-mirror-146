...
class TestBodyAttachPaymentToProjectBillingAttachPaymentToProjectPost(unittest.TestCase):
    """BodyAttachPaymentToProjectBillingAttachPaymentToProjectPost unit test stubs"""
    ...
    def testBodyAttachPaymentToProjectBillingAttachPaymentToProjectPost(self):
        """Test BodyAttachPaymentToProjectBillingAttachPaymentToProjectPost"""
        # FIXME: construct object with mandatory attributes with example values
        # model = BodyAttachPaymentToProjectBillingAttachPaymentToProjectPost()  # noqa: E501
        pass
