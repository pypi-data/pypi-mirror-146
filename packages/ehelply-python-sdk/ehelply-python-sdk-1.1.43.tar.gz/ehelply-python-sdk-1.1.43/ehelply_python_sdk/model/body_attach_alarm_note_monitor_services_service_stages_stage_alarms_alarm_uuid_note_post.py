...
class BodyAttachAlarmNoteMonitorServicesServiceStagesStageAlarmsAlarmUuidNotePost(ModelNormal):
    ...
    def _from_openapi_data(cls, note, *args, **kwargs):  # noqa: E501
        """BodyAttachAlarmNoteMonitorServicesServiceStagesStageAlarmsAlarmUuidNotePost - a model defined in OpenAPI
