...
def budget_allocator_c(df, name_date_column, medias, all_features, model, spends, response_get_budget,
                       lower_bounds, upper_bounds, df_aggregated, maxeval=5000, date_get_budget='', algoritm='LD_MMA', number_tail=15):
