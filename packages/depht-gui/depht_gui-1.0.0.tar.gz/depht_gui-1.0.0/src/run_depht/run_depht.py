...
from depht.__main__ import (ATT_SENSITIVITY, TMP_DIR, MIN_LENGTH, MODEL_DIR,
                            LOCAL_MODELS, CPUS, GLOBAL_VARIABLES,
                            MIN_CDS_FEATURES, EXTEND_BY, MIN_PRODUCTS_NORMAL,
                            MIN_PRODUCTS_STRICT, PROPHAGE_PREFIX,
                            PROPHAGE_DELIMITER)
from depht.__main__ import (load_contigs, load_initial_prophages,
                            detect_att_sites, write_prophage_output, )


def run_depht(infiles, outdir, product_threshold, model=LOCAL_MODELS[0],
