...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, manifest_signing_service=None, name=None, versions_href=None, pulp_labels=None, pulp_href=None, pulp_created=None, retain_repo_versions=None, description=None, local_vars_configuration=None):  # noqa: E501
