...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, pulp_created=None, description=None, pulp_href=None, latest_version_href=None, name=None, pulp_labels=None, manifest_signing_service=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
