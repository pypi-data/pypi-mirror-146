...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, manifest_signing_service=None, pulp_href=None, versions_href=None, pulp_labels=None, name=None, latest_version_href=None, pulp_created=None, description=None, local_vars_configuration=None):  # noqa: E501
