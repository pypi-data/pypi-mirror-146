...
class SimpleStocksApi(object):
    ...
    def simple_stocks_real_time_stock_product_stock_read(self, **kwargs):  # noqa: E501
        """simple_stocks_real_time_stock_product_stock_read  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.simple_stocks_real_time_stock_product_stock_read(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.simple_stocks_real_time_stock_product_stock_read_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.simple_stocks_real_time_stock_product_stock_read_with_http_info(**kwargs)  # noqa: E501
            return data

    def simple_stocks_real_time_stock_product_stock_read_with_http_info(self, **kwargs):  # noqa: E501
        """simple_stocks_real_time_stock_product_stock_read  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.simple_stocks_real_time_stock_product_stock_read_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method simple_stocks_real_time_stock_product_stock_read" % key
                )
            params[key] = val
        del params['kwargs']
