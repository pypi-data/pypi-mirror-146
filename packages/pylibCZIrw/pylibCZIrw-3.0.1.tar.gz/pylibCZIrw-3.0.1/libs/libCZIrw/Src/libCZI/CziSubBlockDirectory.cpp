...
/*
bool CReaderWriterCziSubBlockDirectory::SubBlkEntryCompare:: operator()(const SubBlkEntry& a, const SubBlkEntry& b) const
{
	// returns true if the first argument goes before the second argument in the strict weak ordering it defines,
	// and false otherwise.

	// 1st check  coordinate
	// 2nd check  m-Index
...
bool CReaderWriterCziSubBlockDirectory::TryGetSubBlock(int key, SubBlkEntry* entry)
{
