...
public:
	...
	/// Returns the dimension of the BitmapData
	/// For now should always be 2
	std::uint8_t get_ndim() const { return 2; }
	...
	std::vector<size_t> get_shape() const { return {this->ptrBitmapData->GetHeight(), this->ptrBitmapData->GetWidth() }; }
