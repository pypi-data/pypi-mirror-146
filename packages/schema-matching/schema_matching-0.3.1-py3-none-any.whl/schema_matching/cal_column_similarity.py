...
def schema_matching(pth,threshold=None,strategy="many-to-many",model_pth=None):
    """
    Do schema matching!
    """
...
if __name__ == '__main__':
    ...
    df_pred,df_pred_labels,predicted_pairs = schema_matching(args.path,threshold=args.threshold,strategy=args.strategy,model_pth=args.model)
