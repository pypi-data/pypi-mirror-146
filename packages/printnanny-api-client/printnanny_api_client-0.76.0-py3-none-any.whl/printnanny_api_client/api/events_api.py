...
class EventsApi(object):
    ...
    def events_create(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.events_create_with_http_info(**kwargs)  # noqa: E501

    def events_create_with_http_info(self, **kwargs):  # noqa: E501
        """events_create  # noqa: E501
    ...
    def events_retrieve(self, id, **kwargs):  # noqa: E501
        """events_retrieve  # noqa: E501

        Generic events viewset  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.events_retrieve(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.events_retrieve_with_http_info(id, **kwargs)  # noqa: E501

    def events_retrieve_with_http_info(self, id, **kwargs):  # noqa: E501
        """events_retrieve  # noqa: E501
        ...
        >>> thread = api.events_retrieve_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method events_retrieve" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and local_var_params.get('id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `events_retrieve`")  # noqa: E501
