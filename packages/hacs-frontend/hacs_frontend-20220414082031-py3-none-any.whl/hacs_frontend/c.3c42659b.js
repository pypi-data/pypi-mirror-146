import{a as e,f as a,e as t,t as i,i as s,$ as o,av as n,o as r,j as d,r as l,n as c,H as h,m as p,P as m,Q as u,aw as v,X as g,Y as y,ax as x,al as _,am as f,ag as k,s as b,d as $}from"./main-79b6d9fd.js";import{a as w}from"./c.c3c5c58e.js";import"./c.d747c696.js";import{n as z}from"./c.e61d287a.js";import{s as j}from"./c.92e02d6a.js";import{m as R}from"./c.da22e2dd.js";import{u as C}from"./c.daee3d52.js";import"./c.eb75d0ad.js";import"./c.a96b93f0.js";import"./c.743a15a1.js";import"./c.fc11182e.js";import"./c.8e28b461.js";e([c("ha-expansion-panel")],(function(e,a){return{F:class extends a{constructor(...a){super(...a),e(this)}},d:[{kind:"field",decorators:[t({type:Boolean,reflect:!0})],key:"expanded",value:()=>!1},{kind:"field",decorators:[t({type:Boolean,reflect:!0})],key:"outlined",value:()=>!1},{kind:"field",decorators:[t()],key:"header",value:void 0},{kind:"field",decorators:[t()],key:"secondary",value:void 0},{kind:"field",decorators:[i()],key:"_showContent",value(){return this.expanded}},{kind:"field",decorators:[s(".container")],key:"_container",value:void 0},{kind:"method",key:"render",value:function(){return o`
      <div
        id="summary"
    ...
    `:o``}},{kind:"method",key:"_updateRepository",value:async function(){this._updating=!0;const e=this._getRepository(this.hacs.repositories,this.repository);e&&("commit"!==e.version_or_commit?await _(this.hass,e.id,e.available_version):await f(this.hass,e.id),"plugin"===e.category&&"storage"===this.hacs.status.lovelace_mode&&await C(this.hass,e,e.available_version),this._updating=!1,this.dispatchEvent(new Event("hacs-dialog-closed",{bubbles:!0,composed:!0})),"plugin"===e.category&&j(this,{title:this.hacs.localize("common.reload"),text:o`${this.hacs.localize("dialog.reload.description")}<br />${this.hacs.localize("dialog.reload.confirm")}`,dismissText:this.hacs.localize("common.cancel"),confirmText:this.hacs.localize("common.reload"),confirm:()=>{k.location.href=k.location.href}}))}},{kind:"method",key:"_getChanglogURL",value:function(){const e=this._getRepository(this.hacs.repositories,this.repository);if(e)return"commit"===e.version_or_commit?`https://github.com/${e.full_name}/compare/${e.installed_version}...${e.available_version}`:`https://github.com/${e.full_name}/releases`}},{kind:"get",static:!0,key:"styles",value:function(){return[b,$,l`
        .content {
          width: 360px;
          display: contents;
        }
