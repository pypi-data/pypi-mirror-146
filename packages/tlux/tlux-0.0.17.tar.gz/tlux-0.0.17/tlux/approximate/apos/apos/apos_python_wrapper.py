...
_ordered_dependencies = ['apos.f90', 'matrix_operations.f90', 'sort_and_select.f90', 'apos_c_wrapper.f90']
# 
# --------------------------------------------------------------------
#               AUTO-COMPILING
#
