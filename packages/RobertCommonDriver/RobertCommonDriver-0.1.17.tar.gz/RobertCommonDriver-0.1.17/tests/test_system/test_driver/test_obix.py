...
def test_scrap():
    point_dict = {
        'Chiller_1_CHW_ENT': {'name': 'Chiller_1_CHW_ENT', 'point_writable': True, 'url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CHW_ENT/', 'type': 'real', 'description': '43.50 °F {ok}', 'val': '43.5'},
        'Chiller_1_CHW_LVT': {'name': 'Chiller_1_CHW_LVT', 'point_writable': True, 'url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CHW_LVT/', 'type': 'real', 'description': '44.20 °F {ok}', 'val': '44.20000076293945'},
        'Chiller_1_CW_ENT': {'name': 'Chiller_1_CW_ENT', 'point_writable': True, 'url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CW_ENT/', 'type': 'real', 'description': '79.50 °F {ok}', 'val': '79.5'},
        'Chiller_1_CW_LVT': {'name': 'Chiller_1_CW_LVT', 'point_writable': True, 'url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CW_LVT/', 'type': 'real', 'description': '79.70 °F {ok}', 'val': '79.69999694824219'},
        }
...
def test_all():
    ...
    dict_config = {'username': 'beop_950', 'password': 'RNB.beop-2020', 'url': 'http://localhost:5002', 'timeout': 30}
    dict_point = {}
...
def test_all1():
    dict_config = {'username': '_sample', 'password': 'RNB.-2020', 'url': 'http://40.114.109.92:5002', 'timeout': 30}
    ...
    #dict_point = {'Chiller_1_CHW_ENT': {'point_name': 'Chiller_1_CHW_ENT', 'point_writable': True,'point_url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CHW_ENT/', 'point_type': 'real','point_description': '43.50 °F {ok}', 'point_sample_value': '43.5'},'Chiller_1_CHW_LVT': {'point_name': 'Chiller_1_CHW_LVT', 'point_writable': True,'point_url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CHW_LVT/', 'point_type': 'real', 'point_description': '44.20 °F {ok}', 'point_sample_value': '44.20000076293945'},'Chiller_1_CW_ENT': {'point_name': 'Chiller_1_CW_ENT', 'point_writable': True,'point_url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CW_ENT/', 'point_type': 'real', 'point_description': '79.50 °F {ok}', 'point_sample_value': '79.5'},'Chiller_1_CW_LVT': {'point_name': 'Chiller_1_CW_LVT', 'point_writable': True, 'point_url': '/obix/config/Drivers/BacnetNetwork/Chiller_1/points/CW_LVT/', 'point_type': 'real','point_description': '79.70 °F {ok}', 'point_sample_value': '79.69999694824219'},}
    driver = ObixDriver(dict_config, dict_point)
    while True:
        point_dict = driver.get_points()
        print(point_dict)
