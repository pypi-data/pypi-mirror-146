...
from ..models.sequence_annotation import SequenceAnnotation
...
class RnaSequenceForBulkUpdateRequest:
    ...
    _annotations: Union[Unset, List[SequenceAnnotation]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_annotations() -> Union[Unset, List[SequenceAnnotation]]:
            annotations = []
            _annotations = d.pop("annotations")
            for annotations_item_data in _annotations or []:
                annotations_item = SequenceAnnotation.from_dict(annotations_item_data)
        ...
        annotations = (
            get_annotations() if "annotations" in d else cast(Union[Unset, List[SequenceAnnotation]], UNSET)
        )
    ...
    def is_circular(self) -> bool:
        """Whether the sequence is circular or linear. RNA sequences can only be linear"""
    ...
    def aliases(self) -> List[str]:
        """ Aliases to add to the sequence """
    ...
    def annotations(self) -> List[SequenceAnnotation]:
        """Annotations to create on the sequence."""
        if isinstance(self._annotations, Unset):
            raise NotPresentError(self, "annotations")
        return self._annotations

    @annotations.setter
    def annotations(self, value: List[SequenceAnnotation]) -> None:
    ...
    def author_ids(self) -> List[str]:
        """ IDs of users to set as the sequence's authors. """
    ...
    def translations(self) -> List[Translation]:
        """Translations to create on the sequence."""
