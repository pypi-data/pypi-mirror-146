...
def ptr_cvPoint2fVector_frompointer(t):
    return _swigPageXML.ptr_cvPoint2fVector_frompointer(t)
...
def PageXML_printVersions(*args, **kwargs):
    r"""
...
def PageXML_setValidationEnabled(val):
    r"""
...
def PageXML_stringToPoints(*args):
    r"""
...
def PageXML_pointsToString(points, rounded=False):
    r"""
...
def PageXML_pointsLimits(points, xmin, xmax, ymin, ymax):
    r"""
