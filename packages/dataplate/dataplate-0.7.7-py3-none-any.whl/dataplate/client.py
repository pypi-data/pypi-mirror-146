...
class DataPlate:
    ...
    def run_notebook(self, notebook_file_path, instance_type = "ml.m5.large", parameters = "{}", image = None, max_time_limit_minutes = 180, securityGroupIds = [], subnets= [], role = None):
    ...
    def schedule_notebook(self, notebook_file_path, rule_name = None, schedule = None, event_pattern = None, instance_type = "ml.m5.large", parameters = "{}", image = None, max_time_limit_minutes = 180, securityGroupIds = [], subnets= [], role = None):
    ...
    def run_notebook_after_schedule(self, notebook_file_path, rule_name = None, trigger_rule_name = None, trigger_rule_status = "Completed" ,instance_type = "ml.m5.large", parameters = "{}", image = None, max_time_limit_minutes = 180, securityGroupIds = [], subnets= [], role = None):
    ...
    def run_notebook_after_notebook(self, notebook_file_path, rule_name = None, trigger_notebook_name = None, trigger_notebook_status = "Completed" ,instance_type = "ml.m5.large", parameters = "{}", image = None, max_time_limit_minutes = 180, securityGroupIds = [], subnets= [], role = None):
        """invoke a notebook run after another scheduled notebook Completed/InProgress/Failed.
    ...
    def report_statistic(self, notebook_name, number_runs=5, include_data=False, embed_report=True):
