...
setup(
    ...
    # Project URLs.
    project_urls = {
        "Changelog":  "https://hg.sr.ht/~rattlerake/sonse/browse/default/changes.md",
        "License":    "https://hg.sr.ht/~rattlerake/sonse/browse/default/license.md",
        "Repository": "https://hg.sr.ht/~rattlerake/sonse",
        "Issues":     "https://todo.sr.ht/~rattlerake/sonse",
    },
