...
class Image(_Image):
    ...
    def warpPerspective(self, matrix: np.ndarray, size: Union[Tuple[int, int], List[int, int], Size], flags: int = cv2.INTER_LINEAR, borderMode: int = cv2.BORDER_CONSTANT, borderValue: int = 0) -> Image: ...
