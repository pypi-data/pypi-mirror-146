...
def Decompose(ts_data_processed,
    ...
    #     if country == '中国':
    #         district = sorted_provinces
    #     elif country == '美国':
    #         district = sorted_state
    ...
    print('-'*40 + 'TOTAL' + '-'*41)
    print(f"截至目前【{country}】累计确诊：{Fore.BLUE}{cum_cases_total}{Style.RESET_ALL} | 新增确诊：{Fore.BLUE}{incre_cases_total}{Style.RESET_ALL}\n"
          f"截至目前【{country}】累计死亡：{Fore.RED}{cum_deaths_total}{Style.RESET_ALL} | 新增死亡：{Fore.RED}{incre_deaths_total}{Style.RESET_ALL}")
    if specify is not None:
    ...
    if specify is not None:
        ...
        plt.suptitle(f"{country}各省/州疫情趋势图", fontsize=50, y = 0.9)
