...
from srf.fields import (empty, SkipField, Field, DateTimeField)
...
class ModelSerializer(Serializer):
    ...
    def get_effective_field(self, model_fields) -> dict:
        ...
        if meta_exclude is not None:
            ...
            return {k: v for k, v in model_fields.items() if
                    (k.rsplit("_")[0] if isinstance(v, tortoise_fields.UUIDField) else k) in meta_fields}
