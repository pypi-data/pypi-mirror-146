...
class MFTClient:
    ...
    def __init__(self, transfer_api_host = "localhost",
        ...
        # TODO implement secure channel
        self.resource_api = airavata_mft_sdk.resource.ResourceService_pb2_grpc.GenericResourceServiceStub(self.resource_channel)
        self.azure_storage_api = airavata_mft_sdk.azure.AzureStorageService_pb2_grpc.AzureStorageServiceStub(self.resource_channel)
        self.box_storage_api = airavata_mft_sdk.box.BoxStorageService_pb2_grpc.BoxStorageServiceStub(self.resource_channel)
        self.dropbox_storage_api = airavata_mft_sdk.dropbox.DropboxStorageService_pb2_grpc.DropboxStorageServiceStub(self.resource_channel)
        self.ftp_storage_api = airavata_mft_sdk.ftp.FTPStorageService_pb2_grpc.FTPStorageServiceStub(self.resource_channel)
        self.gcs_storage_api = airavata_mft_sdk.gcs.GCSStorageService_pb2_grpc.GCSStorageServiceStub(self.resource_channel)
        self.local_storage_api = airavata_mft_sdk.local.LocalStorageService_pb2_grpc.LocalStorageServiceStub(self.resource_channel)
        self.s3_storage_api = airavata_mft_sdk.s3.S3StorageService_pb2_grpc.S3StorageServiceStub(self.resource_channel)
        self.scp_storage_api = airavata_mft_sdk.scp.SCPStorageService_pb2_grpc.SCPStorageServiceStub(self.resource_channel)
        self.storage_secret_map_api = airavata_mft_sdk.storagesecretmap.StorageSecretMap_pb2_grpc.StorageSecretServiceStub(self.resource_channel)
