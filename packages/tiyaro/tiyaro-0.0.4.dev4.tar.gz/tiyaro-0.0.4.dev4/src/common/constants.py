...
HANDLER_MODEL_BASE_HANDLER_FILE = f'{TIYARO_HANDLER_DIR}/base_handler.py'
...
CLEAR_HELP = f'Forcefully clear {TIYARO_HANDLER_DIR}, {HANDLER_MODEL_MODEL_TEST_FILE} templates'
