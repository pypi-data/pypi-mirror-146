...
class SimilarityUtils:
    ...
    @staticmethod
    def add_content_similarity_all_content(content_node, content_label, graph,tags_content_df, content_core_content_df):
        ...
        all_content_new_df = combine_features(all_content_df, graph, tags_content_df,
    ...
    @staticmethod
    def add_content_similarity_property(content_id, content_label, content_homepage_id, graph,tags_content_df,
                                        content_core_content_df):
        try:
            ...
            try:
                ...
                list_new_df_homepage = generate_new_features(list_dataframe_homepage, graph,
                                                             tags_content_df, content_core_content_df)
