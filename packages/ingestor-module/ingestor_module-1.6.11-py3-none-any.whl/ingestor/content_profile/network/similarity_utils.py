    ...
    def add_content_similarity_property(content_node, content_label, content_homepage_id, graph):
        try:
            ...
            try:
                ...
                print('Not able to add content similarity based on home page id', content_node)

            try:
                SimilarityUtils.add_content_similarity_all_content(content_node, content_label, graph)
            except Exception:
                print('Not able to add content similarity for all contents', content_node)

        except Exception:
            print('Not able to add content similarity for all contents and home page id', content_node)
        return content_node
