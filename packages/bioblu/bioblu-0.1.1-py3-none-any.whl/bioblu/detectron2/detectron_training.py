...
from bioblu.detectron2 import detectron
...
if __name__ == "__main__":
    ...
    # ToDo: Adjust this and think about it.
    ds_name = "dataset_04_gnejna"
    ds_root_dir = "/opt/nfs/shared/scratch/bioblu/datasets/"
    coco_ds = yolo_ds + "_coco"

    ds_convert.convert_yolo_to_coco(yolo_ds, coco_ds, os.path.split(coco_ds)[-1], {0: "trash"})
    ...
    training_imgs = detectron.create_detectron_img_dict_list(fpath_json_train)
    validation_imgs = detectron.create_detectron_img_dict_list(fpath_json_valid)
