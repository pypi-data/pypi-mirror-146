...
img_fpath = "/opt/nfs/shared/scratch/bioblu/detectron_test_input.jpg"
fpath_output = "/opt/nfs/shared/scratch/bioblu"

model_zoo.get_config_file()
# Load img
im = cv2.imread(img_fpath)
# cv2_imshow(im) # Skip because no UI
if not im:
    print("[ WARNING ] Image for inference test seemingly not loaded successfully.")
