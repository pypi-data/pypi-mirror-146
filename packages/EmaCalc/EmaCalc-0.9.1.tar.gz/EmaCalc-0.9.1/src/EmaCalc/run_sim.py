...
if __name__ == '__main__':
    ...
    emf = EmaFrame(scenarios={'Stage': ('',),   # Test Stage(s)  -******** use non-empty label !!! ***
    ...
    # NOTE: First scenario dimension is always Stage, even if only ONE
    ...
    mean_grades.save(result_path / 'Attribute_mean_grades.txt')
