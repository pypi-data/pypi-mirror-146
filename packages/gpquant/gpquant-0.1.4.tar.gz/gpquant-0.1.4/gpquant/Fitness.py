...
class Fitness:
    def __init__(self, function, greater_is_better:bool):
...
def _direction_accuracy(close:pd.Series, factor):
...
fitness_map = {'ann return': ann_return,
