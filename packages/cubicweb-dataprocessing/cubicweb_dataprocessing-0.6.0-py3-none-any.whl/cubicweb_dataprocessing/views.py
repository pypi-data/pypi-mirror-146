...
class ScriptImplementationBreadCrumbsAdapter(ibreadcrumbs.IBreadCrumbsAdapter):
    ...
    __select__ = ibreadcrumbs.IBreadCrumbsAdapter.__select__ & has_related_entities(
        "implemented_by", role="object"
    )
...
afs.tag_object_of(
    ("*", "transformation_sequence", "TransformationSequence"), "main", "hidden"
)
afs.tag_object_of(("*", "validation_script", "ValidationScript"), "main", "hidden")
