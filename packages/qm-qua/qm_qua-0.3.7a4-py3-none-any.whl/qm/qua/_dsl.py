...
def set_dc_offset(element, element_input, offset):
    """
    Set the DC offset of an element's input.

    -- Available from QOP 2.20 --

    :param element: The element to update its DC offset
    :param element_input: desired input of the element, can be 'single' for a 'singleInput' element or 'I' or 'Q' for a
        'mixInputs' element
...
class TimeTagging:
    ...
    def analog(self, target, max_time, targetLen=None, element_output=""):
        ...
        :param element_output: the output of an element from which to get ADC results
