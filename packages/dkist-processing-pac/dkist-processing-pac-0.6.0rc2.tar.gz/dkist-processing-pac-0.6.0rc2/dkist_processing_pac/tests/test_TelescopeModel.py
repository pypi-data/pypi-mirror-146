...
class TestComponents(TestCase):
    ...
    def setUp(self):
        ...
        self.TM = TelescopeModel(azimuth=[0,90.], elevation=[60, 75.], table_angle=[180, 90.])
    ...
    def test_R67(self):
        np.testing.assert_almost_equal(self.TM.R67, np.transpose(np.dstack((Data.rotation(0.),
