...
class DCDrawer(Drawer):
    ...
    def fit_intensity_trend(self):
        ...
        try:
            ...
            logging.info('WARNING: clear frames have not yet been identified. Use .find_clears() to do so')
            return
        if len(self.clear_objs) == 0:
            logging.info('WARNING: this Drawer does not contain any clear measurements. No correction is possible.')
            return
