...
def ThermalConductivity(Temperature):
    ...
    This function return the thermal conductivity of Cu46Ni13Zn41
    ...
    if Temperature <= 20 and Temperature >= 2:
        ...
        return 4.7*1e-2*Temperature**1.5
    
        ################## SINON NAN #########################################

    else:

        print('Warning: The thermal conductivity of Cu46Ni13Zn41 is not defined for T = '+str(Temperature)+' K')
        return np.nan
