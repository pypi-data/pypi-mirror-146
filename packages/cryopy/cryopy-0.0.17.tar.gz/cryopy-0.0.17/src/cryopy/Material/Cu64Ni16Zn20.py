...
def ThermalConductivity(Temperature):
    ...
    This function return the thermal conductivity of Cu64Ni16Zn20
    ...
    if Temperature <= 20 and Temperature >= 2:
        ...
        return 3.8*1e-2*Temperature**2
    
        ################## SINON NAN #########################################

    else:

        print('Warning: The thermal conductivity of Cu64Ni16Zn20 is not defined for T = '+str(Temperature)+' K')
        return np.nan
