...
from PyQt5.QtWidgets import QFrame, QPushButton, QGridLayout, QLayout, QHBoxLayout, QVBoxLayout, QLabel, QTabWidget\
    , QStatusBar, QButtonGroup, QAbstractButton, QRadioButton
...
class Element:
    def __init__(self, parser, parent, name, dom):
        ...
        self.useFunc = {
            ...
            'bbutton-group': [self.createButtonGroup, self.afterCreateButtonGroup],
    ...
    def afterCreateButtonGroup(self):
        id = 1
        for c in self.childs:
            if isinstance(c.qt, QAbstractButton):
