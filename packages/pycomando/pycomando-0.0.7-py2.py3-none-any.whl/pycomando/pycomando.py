...
class Comando:
    def __init__(self, yml='args.yml', elasticsearchlink=None, redis_server=None, redis_port: int = 0, f__version__init__=False, log_level=None):
    ...
    def output_list_of_dict(self, data, fmt, fields=[], fd=None):
        ...
        if fmt == "json":
            ...
            fd.write(json.dumps(data, default=self.json_serial, indent=4))
        elif fmt == "txt":
