...
class JManFb:
    ...
    def c_sync_moviments_magatzems_pendents(self, p_magatzem_entrada_id: int):
        return self.select(sql=fb_consultes.sync_moviments_magatzems_pendents, args=(p_magatzem_entrada_id,))
