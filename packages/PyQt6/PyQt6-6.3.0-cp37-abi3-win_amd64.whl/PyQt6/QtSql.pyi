...
class QSqlError(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QSqlError') -> bool: ...
    def __eq__(self, other: 'QSqlError') -> bool: ...
    def isValid(self) -> bool: ...
    def text(self) -> str: ...
...
class QSqlField(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QSqlField') -> bool: ...
    def __eq__(self, other: 'QSqlField') -> bool: ...
...
class QSqlRecord(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QSqlRecord') -> bool: ...
    def __eq__(self, other: 'QSqlRecord') -> bool: ...
