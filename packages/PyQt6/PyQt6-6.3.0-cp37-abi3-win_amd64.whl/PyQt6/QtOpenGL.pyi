...
class QOpenGLDebugMessage(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, debugMessage: 'QOpenGLDebugMessage') -> bool: ...
    def __eq__(self, debugMessage: 'QOpenGLDebugMessage') -> bool: ...
    @staticmethod
...
class QOpenGLFramebufferObjectFormat(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QOpenGLFramebufferObjectFormat') -> bool: ...
    def __eq__(self, other: 'QOpenGLFramebufferObjectFormat') -> bool: ...
...
class QOpenGLVersionProfile(PyQt6.sip.simplewrapper):
    ...
    def __eq__(self, rhs: 'QOpenGLVersionProfile') -> bool: ...
    def __ne__(self, rhs: 'QOpenGLVersionProfile') -> bool: ...
