...
class QNdefMessage(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QNdefMessage') -> bool: ...
    @staticmethod
    ...
    def __eq__(self, other: 'QNdefMessage') -> bool: ...
...
class QNdefRecord(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QNdefRecord') -> bool: ...
    def __eq__(self, other: 'QNdefRecord') -> bool: ...
    def clear(self) -> None: ...
...
class QNearFieldTarget(QtCore.QObject):
    ...
    class RequestId(PyQt6.sip.simplewrapper):
        ...
        def __ne__(self, other: 'QNearFieldTarget.RequestId') -> bool: ...
        def __eq__(self, other: 'QNearFieldTarget.RequestId') -> bool: ...
