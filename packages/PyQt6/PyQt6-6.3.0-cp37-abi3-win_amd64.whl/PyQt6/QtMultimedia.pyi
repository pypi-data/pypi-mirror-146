...
class QAudioDevice(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QAudioDevice') -> bool: ...
    def __eq__(self, other: 'QAudioDevice') -> bool: ...
...
class QAudioFormat(PyQt6.sip.simplewrapper):
    ...
    def __eq__(self, b: 'QAudioFormat') -> bool: ...
    def __ne__(self, b: 'QAudioFormat') -> bool: ...
...
class QCameraFormat(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QCameraFormat') -> bool: ...
    def __eq__(self, other: 'QCameraFormat') -> bool: ...
    def isNull(self) -> bool: ...
...
class QCameraDevice(PyQt6.sip.simplewrapper):
    ...
    def id(self) -> QtCore.QByteArray: ...
    def isNull(self) -> bool: ...
    def __ne__(self, other: 'QCameraDevice') -> bool: ...
    def __eq__(self, other: 'QCameraDevice') -> bool: ...
...
class QMediaFormat(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QMediaFormat') -> bool: ...
    def __eq__(self, other: 'QMediaFormat') -> bool: ...
...
class QMediaMetaData(PyQt6.sip.simplewrapper):
    ...
    def __eq__(self, b: 'QMediaMetaData') -> bool: ...
    def __ne__(self, b: 'QMediaMetaData') -> bool: ...
    @staticmethod
...
class QMediaTimeRange(PyQt6.sip.simplewrapper):
    ...
    class Interval(PyQt6.sip.simplewrapper):
        ...
        def __eq__(self, rhs: 'QMediaTimeRange.Interval') -> bool: ...
        def __ne__(self, rhs: 'QMediaTimeRange.Interval') -> bool: ...
    ...
    def __eq__(self, a0: 'QMediaTimeRange') -> bool: ...
    def __ne__(self, a0: 'QMediaTimeRange') -> bool: ...
...
class QVideoFrame(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, other: 'QVideoFrame') -> bool: ...
    def __eq__(self, other: 'QVideoFrame') -> bool: ...
...
class QVideoFrameFormat(PyQt6.sip.simplewrapper):
    ...
    def pixelFormat(self) -> 'QVideoFrameFormat.PixelFormat': ...
    def isValid(self) -> bool: ...
    def __ne__(self, format: 'QVideoFrameFormat') -> bool: ...
    def __eq__(self, format: 'QVideoFrameFormat') -> bool: ...
