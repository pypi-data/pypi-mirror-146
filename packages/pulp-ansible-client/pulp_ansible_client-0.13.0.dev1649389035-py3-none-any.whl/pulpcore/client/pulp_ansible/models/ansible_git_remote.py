...
class AnsibleGitRemote(object):
    ...
    def __init__(self, username=None, headers=None, proxy_url=None, proxy_password=None, ca_cert=None, total_timeout=None, connect_timeout=None, tls_validation=None, rate_limit=None, download_concurrency=None, sock_read_timeout=None, max_retries=None, url=None, sock_connect_timeout=None, pulp_labels=None, client_cert=None, name=None, password=None, client_key=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
