...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, pulp_created=None, proxy_url=None, ca_cert=None, total_timeout=None, connect_timeout=None, tls_validation=None, rate_limit=None, download_concurrency=None, pulp_last_updated=None, sock_read_timeout=None, max_retries=None, url=None, pulp_href=None, sock_connect_timeout=None, pulp_labels=None, client_cert=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
