...
class AnsibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, proxy_password=None, pulp_labels=None, max_retries=None, total_timeout=None, proxy_url=None, ca_cert=None, client_key=None, rate_limit=None, sock_connect_timeout=None, headers=None, username=None, download_concurrency=None, password=None, proxy_username=None, sock_read_timeout=None, client_cert=None, connect_timeout=None, url=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
