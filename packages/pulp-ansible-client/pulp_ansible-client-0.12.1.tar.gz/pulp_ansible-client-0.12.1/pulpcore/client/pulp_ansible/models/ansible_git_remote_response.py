...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, proxy_url=None, tls_validation=None, pulp_labels=None, url=None, rate_limit=None, sock_connect_timeout=None, sock_read_timeout=None, connect_timeout=None, ca_cert=None, headers=None, client_cert=None, max_retries=None, name=None, pulp_href=None, total_timeout=None, pulp_created=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
