...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, headers=None, proxy_url=None, username=None, max_retries=None, sock_read_timeout=None, client_key=None, download_concurrency=None, tls_validation=None, url=None, ca_cert=None, connect_timeout=None, rate_limit=None, name=None, proxy_password=None, pulp_labels=None, proxy_username=None, sock_connect_timeout=None, total_timeout=None, password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
