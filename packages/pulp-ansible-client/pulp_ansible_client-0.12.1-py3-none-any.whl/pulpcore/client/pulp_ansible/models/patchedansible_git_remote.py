...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, username=None, download_concurrency=None, proxy_url=None, tls_validation=None, pulp_labels=None, url=None, rate_limit=None, sock_connect_timeout=None, sock_read_timeout=None, proxy_password=None, password=None, connect_timeout=None, ca_cert=None, client_key=None, headers=None, client_cert=None, max_retries=None, name=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
