...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, headers=None, proxy_url=None, max_retries=None, sock_read_timeout=None, download_concurrency=None, pulp_created=None, tls_validation=None, url=None, ca_cert=None, pulp_href=None, pulp_last_updated=None, connect_timeout=None, rate_limit=None, name=None, pulp_labels=None, sock_connect_timeout=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
