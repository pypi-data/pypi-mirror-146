...
def process_content(content: str, parameters:Dict[str,object]=None):
...
class AlphaSsh:
    ...
    def write_to_file(self, content: str, path: str, ensure_path: bool = True, parameters:Dict[str, object]=None) -> bool:
        if ensure_path:
