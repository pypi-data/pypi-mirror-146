    ...
    def run(self):
        ...
        for chro in dic0:
            ...
            for i in lt:
                ...
                chro1,chro2 = gff[id1]['chr'],gff[id2]['chr']
                alp = 0.08
                self.plot_bez_inner((chro1, pos1, self.radius_a*0.8), (chro2, pos2, self.radius_a*0.8), '#d4dcda', total_size,alp,2)
        ltx = []
        for i in famlist:
            id1, id2 = i[0],i[1]
            pos1,pos2 = gff[id1]['end'],gff[id2]['end']
            chro1,chro2 = gff[id1]['chr'],gff[id2]['chr']
            alp = 1
            self.plot_bez_inner((chro1, pos1, self.radius_a*0.8), (chro2, pos2, self.radius_a*0.8), '#e2041b', total_size,alp,2.5)
            ...
            if id1 not in ltx:
                ltx.append(id1)
                # ex1y = ex1y + 0.004
                text(ex1x, ex1y, id1, horizontalalignment="center", verticalalignment="center", fontsize = 6, color = 'black',rotation=(rad1/(2*pi))*360)
            if id2 not in ltx:
                ltx.append(id2)
                text(ex2x, ex2y, id2, horizontalalignment="center", verticalalignment="center", fontsize = 6, color = 'black',rotation=(rad2/(2*pi))*360)
        plt.axis('off')
