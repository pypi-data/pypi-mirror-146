...
class tandem():
    ...
    def ksrun(self):
        ...
        return lens,chr_list,gff,ks,family
    ...
    def run(self):
        ...
        lens,chr_list,gff,ks,family = self.ksrun()
        ...
        for i in pair:
            ...
            if chro1 == chro2 and abs(int(gff[id1][self.position])-int(gff[id2][self.position])) == 1:
                ...
                self.plot_bez_inner((chro1, pos1, self.radius_a*0.90), (chro2, pos2, self.radius_a*0.90), "#e9dfe5", total_size,2)#绘制内部共线性
        outfile.close()
        put01 = []
        for i in pair:
            id1,id2 = i[0],i[1]
