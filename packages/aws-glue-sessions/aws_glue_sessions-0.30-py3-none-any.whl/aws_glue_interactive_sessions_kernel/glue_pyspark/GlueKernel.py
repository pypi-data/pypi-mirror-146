...
class GlueKernel(IPythonKernel):
    ...
    def configure(self, configs_json):
        ...
        try:
            ...
            sys.stderr.write(f'The following exception was encountered while parsing the configurations provided: {e} \n')
            self._print_traceback(e)
            return
        if not configs:
    ...
    def _cancel_statement(self, statement_id: str):
        ...
        try:
            ...
            sys.stderr.write(f'Exception encountered while canceling statement {statement_id}: {e} \n')
            self._print_traceback(e)
    ...
    async def _print_startup_text(self):
        ...
        self._send_output("Please view our Getting Started page to access the most up-to-date information on the Interactive Sessions kernel: https://docs.aws.amazon.com/glue/latest/dg/interactive-sessions.html")
