...
class KernelProfiler:
    ...
    Note:
        For details about using CUPTI in Taichi, please visit https://docs.taichi.graphics/lang/articles/profiler#advanced-mode.
    """
    def __init__(self):
...
def print_kernel_profiler_info(mode='count'):
    ...
    Note:
        ...
        For advanced mode of `KernelProfiler`, please visit https://docs.taichi.graphics/lang/articles/profiler#advanced-mode.
    """
