...
class RolesRepresentation(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'client': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'realm': ([RoleRepresentation],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            client ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
            realm ([RoleRepresentation]): [optional]  # noqa: E501
        """
