...
from keycloak_api import rest
from keycloak_api.configuration import Configuration
from keycloak_api.exceptions import ApiTypeError, ApiValueError, ApiException
from keycloak_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/17.0-2/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AttackDetectionApi()
        api_instance.realm_attack_detection_brute_force_users_delete  # this is an instance of the class Endpoint
        api_instance.realm_attack_detection_brute_force_users_delete()  # this invokes api_instance.realm_attack_detection_brute_force_users_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.realm_attack_detection_brute_force_users_delete.callable or self.callable in this class
