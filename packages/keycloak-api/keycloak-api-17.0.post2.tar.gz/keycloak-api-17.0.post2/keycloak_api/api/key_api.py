...
class KeyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.realm_keys_get_endpoint = _Endpoint(
            settings={
                'response_type': (KeysMetadataRepresentation,),
                'auth': [
                    'access_token'
                ],
                'endpoint_path': '/{realm}/keys',
                'operation_id': 'realm_keys_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def realm_keys_get(
        ...
        **kwargs
        ...
        """realm_keys_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.realm_keys_get(realm, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['realm'] = \
            realm
        return self.realm_keys_get_endpoint.call_with_http_info(**kwargs)
