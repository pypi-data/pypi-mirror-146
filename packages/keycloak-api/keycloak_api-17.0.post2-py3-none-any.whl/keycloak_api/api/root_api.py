...
class RootApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.admin_realms_get_endpoint = _Endpoint(
            settings={
                'response_type': (ServerInfoRepresentation,),
                'auth': [
                    'access_token'
                ],
    ...
    def admin_realms_get(
        ...
        **kwargs
        ...
        return self.admin_realms_get_endpoint.call_with_http_info(**kwargs)
