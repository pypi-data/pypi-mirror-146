...
class ObservedLibraryUsage(BaseTsAppMessage):
    ...
    @property
    def path(self):
        return f"applications/{self.server_name_b64}/{self.server_path_b64}/{self.server_type_b64}/{self.app_language_b64}/{self.app_name_b64}/library-usage"
    ...
    @fail_safely("Failed to process ObservedLibraryUsage response")
    def process_response(self, response, reporting_client):
        self.process_response_code(response)
...
class HeartBeat(BaseTsAppMessage):
    ...
    @property
    def path(self):
        return f"applications/{self.server_name_b64}/{self.server_path_b64}/{self.server_type_b64}/{self.app_language_b64}/{self.app_name_b64}/heartbeat"
    ...
    @fail_safely("Failed to process HeartBeat response")
    def process_response(self, response, reporting_client):
        self.process_response_code(response)
