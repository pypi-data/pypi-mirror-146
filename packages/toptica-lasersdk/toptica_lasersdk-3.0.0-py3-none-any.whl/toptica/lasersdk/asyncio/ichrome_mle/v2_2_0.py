# Generated from 'v2_2_0.xml' on 2022-04-11 08:03:16.409590
...
class Laser:
    ...
    async def check_level(self) -> float:
        return await self.__client.exec(self.__name + ':check-level', input_stream=None, output_type=None, return_type=float)
    ...
    async def wait(self) -> None:
        await self.__client.exec(self.__name + ':wait', input_stream=None, output_type=None, return_type=None)
...
class Beam:
    ...
    async def moveto(self, xposition: float, yposition: float) -> None:
        ...
        await self.__client.exec(self.__name + ':moveto', xposition, yposition, input_stream=None, output_type=None, return_type=None)

    async def gohome(self) -> None:
        await self.__client.exec(self.__name + ':gohome', input_stream=None, output_type=None, return_type=None)
    ...
    async def sethome(self, use_current_settings: bool) -> None:
        ...
        await self.__client.exec(self.__name + ':sethome', use_current_settings, input_stream=None, output_type=None, return_type=None)

    async def newhome(self) -> None:
        await self.__client.exec(self.__name + ':newhome', input_stream=None, output_type=None, return_type=None)

    async def getpos(self) -> None:
        return await self.__client.exec(self.__name + ':getpos', input_stream=None, output_type=None, return_type=None)

    async def newcenter(self) -> None:
        await self.__client.exec(self.__name + ':newcenter', input_stream=None, output_type=None, return_type=None)

    async def checkcenter(self) -> None:
        return await self.__client.exec(self.__name + ':checkcenter', input_stream=None, output_type=None, return_type=None)

    async def gocenter(self) -> None:
        await self.__client.exec(self.__name + ':gocenter', input_stream=None, output_type=None, return_type=None)

    async def optimize(self) -> None:
        await self.__client.exec(self.__name + ':optimize', input_stream=None, output_type=None, return_type=None)

    async def scan(self) -> None:
        await self.__client.exec(self.__name + ':scan', input_stream=None, output_type=None, return_type=None)

    async def history(self) -> Tuple[str, int]:
        return await self.__client.exec(self.__name + ':history', input_stream=None, output_type=str, return_type=int)

    async def goback(self) -> None:
        await self.__client.exec(self.__name + ':goback', input_stream=None, output_type=None, return_type=None)

    async def gofwd(self) -> None:
        await self.__client.exec(self.__name + ':gofwd', input_stream=None, output_type=None, return_type=None)
...
class Elliptec:
    ...
    async def refinefreqs(self) -> str:
        return await self.__client.exec(self.__name + ':refinefreqs', input_stream=None, output_type=str, return_type=None)
    ...
    async def find_center(self) -> None:
        return await self.__client.exec(self.__name + ':find-center', input_stream=None, output_type=None, return_type=None)
...
class Ibeam:
    ...
    async def cmd(self, cmd_string: str) -> None:
        ...
        await self.__client.exec(self.__name + ':cmd', cmd_string, input_stream=None, output_type=None, return_type=None)

    async def reset_system(self) -> None:
        await self.__client.exec(self.__name + ':reset-system', input_stream=None, output_type=None, return_type=None)
...
class Cam:
    ...
    async def grab(self) -> None:
        await self.__client.exec(self.__name + ':grab', input_stream=None, output_type=None, return_type=None)

    async def max_level(self) -> int:
        return await self.__client.exec(self.__name + ':max-level', input_stream=None, output_type=None, return_type=int)

    async def com(self) -> None:
        await self.__client.exec(self.__name + ':com', input_stream=None, output_type=None, return_type=None)
...
class CamSetting:
    ...
    async def auto_adjust(self) -> int:
        return await self.__client.exec(self.__name + ':auto-adjust', input_stream=None, output_type=None, return_type=int)
