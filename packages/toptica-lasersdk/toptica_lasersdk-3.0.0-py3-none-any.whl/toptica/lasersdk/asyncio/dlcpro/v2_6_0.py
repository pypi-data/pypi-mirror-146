# Generated from 'v2_6_0.xml' on 2022-04-11 08:03:15.225170
...
class DlMotorStepper:
    ...
    async def perform_referencing(self) -> None:
        await self.__client.exec(self.__name + ':perform-referencing', input_stream=None, output_type=None, return_type=None)

    async def reset_cycles(self) -> None:
        await self.__client.exec(self.__name + ':reset-cycles', input_stream=None, output_type=None, return_type=None)
...
class DlMotorCalibration:
    ...
    async def set(self, fit_a: float, fit_b: float, fit_c: float, wavelength_min: float, wavelength_max: float) -> None:
        ...
        await self.__client.exec(self.__name + ':set', fit_a, fit_b, fit_c, wavelength_min, wavelength_max, input_stream=None, output_type=None, return_type=None)
...
class LhFactory:
    ...
    async def update_service_date(self) -> None:
        await self.__client.exec(self.__name + ':update-service-date', input_stream=None, output_type=None, return_type=None)
...
class AutoNlo:
    ...
    async def reset_operation_time_cavity_fhg(self) -> None:
        await self.__client.exec(self.__name + ':reset-operation-time-cavity-fhg', input_stream=None, output_type=None, return_type=None)
...
class NloLaserHeadLocalOscillatorShg1:
    ...
    async def auto_pdh_abort(self) -> None:
        await self.__client.exec(self.__name + ':auto-pdh-abort', input_stream=None, output_type=None, return_type=None)
...
class DLCpro:
    ...
    async def change_password_service(self, password: str) -> None:
        assert isinstance(password, str), f"expected type 'str' for parameter 'password', got '{type(password)}'"
        await self.__client.exec('change-password-service', password, input_stream=None, output_type=None, return_type=None)
