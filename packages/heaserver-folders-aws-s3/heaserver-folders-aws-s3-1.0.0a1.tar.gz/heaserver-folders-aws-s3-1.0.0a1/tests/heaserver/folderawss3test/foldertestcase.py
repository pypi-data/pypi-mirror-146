...
ItemTestCase = \
    mockmongotestcase.get_test_case_cls_default(href='http://localhost:8080/folders/root/items/',
...
FolderTestCase = \
    mockmongotestcase.get_test_case_cls_default(href='http://localhost:8080/folders/',
                                                wstl_package=service.__package__,
