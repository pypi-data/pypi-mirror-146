...
@routes.get('/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{folder_id}/items/')
@action(name='heaserver-awss3folders-item-move', path='/awss3folders/{folder_id}/items/{id}/mover', rel='hea-mover')
@action(name='heaserver-awss3folders-item-duplicate', rel='hea-duplicator',
        path='/awss3folders/{folder_id}/items/{id}/duplicator')
...
@action(name='heaserver-awss3folders-item-duplicate-form', path='/awss3folders/{folder_id}/items/{id}')
...
@action(name='heaserver-awss3folders-folder-duplicate-form', path='/awss3folders/{folder_id}/items/{id}')
...
@action(name='heaserver-awss3folders-folder-duplicate', rel='hea-duplicator', path='/awss3folders/{id}/duplicator')
...
def main():
    ...
    start(wstl_builder_factory=builder_factory(__package__), config=config)
