...
async def present(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        resource_id(Text, Optional): The user name and policy name with a separator.
    ...
    if resource_id:
        policy_name = resource_id.split(user_name + "-")[1]
    ...
    if before:
        ...
        try:
            ...
            fret = await update_user_policy(hub, ctx, user_name, name, policy_document)
...
async def absent(
    hub, ctx, name: str, user_name: str, resource_id: str = None
) -> Dict[str, Any]:
    r"""
    **Autogenerated function**
    ...
    Args:
        name(Text): The name of the AWS IAM policy.
        user_name(Text): The UserPolicy's user_name identifier
        resource_id(Text): The name of the policy within the user policy.
    ...
    if not before:
        ...
        try:
            result[
                "old_state"
            ] = hub.tool.aws.iam.conversion_utils.convert_raw_user_policy_to_present(
                before
            )
