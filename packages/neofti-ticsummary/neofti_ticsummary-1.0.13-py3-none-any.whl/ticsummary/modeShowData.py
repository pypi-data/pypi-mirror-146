...
from ticsummary import backWorking, loaderData, inputDataHandler
...
def onlineInit(model):
    ...
    model.setRealTimeMode()
def onlineUninit(model):
    model.realTimeModeOn = False
    model.offRealTimeMode()
