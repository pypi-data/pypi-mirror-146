...
class RestClient:
    ...
    def __init__(
        ...
        :param credentials: An instance of Credentials. If None, login() must be called before using any REST API endpoints that require authentication.
        :param timeout: Connection timeout duration in seconds. See https://docs.python.org/3/library/socket.html#socket.socket.settimeout for more information about Python socket timeouts.
        """
