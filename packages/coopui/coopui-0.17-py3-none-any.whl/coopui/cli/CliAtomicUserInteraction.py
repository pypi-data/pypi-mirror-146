...
class CliAtomicUserInteraction(IAtomicUserInteraction):
    ...
    def request_index_from_df(cls,
        ...
        while True:
            ...
            cls.pretty_print_dataframe(print_out, prompt, **kwargs)
    ...
    def request_data_from_csv_with_specified_columns(cls,
        ...
        required_columns = required_columns if required_columns else [key for key, value in column_type_definition.items()]
