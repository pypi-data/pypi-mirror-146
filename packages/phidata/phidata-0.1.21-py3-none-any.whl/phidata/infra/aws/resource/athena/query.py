    ...
    def _create(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            if self.client_request_token:
                non_null_args["ClientRequestToken"] = self.client_request_token
            if self.query_execution_context:
                non_null_args["QueryExecutionContext"] = self.query_execution_context
            if self.result_configuration:
                non_null_args["ResultConfiguration"] = self.result_configuration
            if self.work_group:
                non_null_args["WorkGroup"] = self.work_group
            ...
            print_error("AthenaQueryExecution could not be started.")
            print_error(e)
        return False
