...
class AcmCertificate(AwsResource):
    ...
    def _create(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            try:
                ...
                print_error(
                    "AcmCertificate could not be created, this operation is known to be buggy."
                )
    ...
    def post_create(self, aws_client: AwsApiClient) -> bool:
        ...
        if self.wait_for_completion:
            try:
                print_info(
                    "Waiting for AcmCertificate to be validated, this can take upto 20 minutes"
                )
                ...
                print_error(
                    "Received errors while waiting for AcmCertificate validation, this operation is known to be buggy."
                )
                print_error("Please try again.")
                print_error(e)
