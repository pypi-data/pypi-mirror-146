        ...
        with multiprocessing.Pool(processes) as pool:
            ...
            while continue_processing:
                ...
                for model_name in model_info.keys():
                    self._logger.info(f"{model_name} - {model_info[model_name]['status']} - {model_info[model_name]['steps']}")
                ...
                for (filename_executed, execution_status, db_error) in results:
                    ...
                    self._logger.info(f"{model_info[executed_model_name]['current_step']} , {len(model_info[model_name]['steps'])}")
