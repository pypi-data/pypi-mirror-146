...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Parameters:
        imported (optional): List of :obj:`ImportedContact <pyrogram.raw.base.ImportedContact>`
        popular_invites (optional): List of :obj:`PopularContact <pyrogram.raw.base.PopularContact>`
        retry_contacts (optional): List of ``int`` ``64-bit``
