...
class Config(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        expires (optional): ``int`` ``32-bit``
        test_mode (optional): ``bool``
        this_dc (optional): ``int`` ``32-bit``
        dc_options (optional): List of :obj:`DcOption <pyrogram.raw.base.DcOption>`
        dc_txt_domain_name (optional): ``str``
        chat_size_max (optional): ``int`` ``32-bit``
        megagroup_size_max (optional): ``int`` ``32-bit``
        forwarded_count_max (optional): ``int`` ``32-bit``
        online_update_period_ms (optional): ``int`` ``32-bit``
        offline_blur_timeout_ms (optional): ``int`` ``32-bit``
        offline_idle_timeout_ms (optional): ``int`` ``32-bit``
        online_cloud_timeout_ms (optional): ``int`` ``32-bit``
        notify_cloud_delay_ms (optional): ``int`` ``32-bit``
        notify_default_delay_ms (optional): ``int`` ``32-bit``
        push_chat_period_ms (optional): ``int`` ``32-bit``
        push_chat_limit (optional): ``int`` ``32-bit``
        saved_gifs_limit (optional): ``int`` ``32-bit``
        edit_time_limit (optional): ``int`` ``32-bit``
        revoke_time_limit (optional): ``int`` ``32-bit``
        revoke_pm_time_limit (optional): ``int`` ``32-bit``
        rating_e_decay (optional): ``int`` ``32-bit``
        stickers_recent_limit (optional): ``int`` ``32-bit``
        stickers_faved_limit (optional): ``int`` ``32-bit``
        channels_read_media_period (optional): ``int`` ``32-bit``
        pinned_dialogs_count_max (optional): ``int`` ``32-bit``
        pinned_infolder_count_max (optional): ``int`` ``32-bit``
        call_receive_timeout_ms (optional): ``int`` ``32-bit``
        call_ring_timeout_ms (optional): ``int`` ``32-bit``
        call_connect_timeout_ms (optional): ``int`` ``32-bit``
        call_packet_timeout_ms (optional): ``int`` ``32-bit``
        me_url_prefix (optional): ``str``
        caption_length_max (optional): ``int`` ``32-bit``
        message_length_max (optional): ``int`` ``32-bit``
        webfile_dc_id (optional): ``int`` ``32-bit``
