...
class PageBlockEmbedPost(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        author_photo_id (optional): ``int`` ``64-bit``
        author (optional): ``str``
        date (optional): ``int`` ``32-bit``
        blocks (optional): List of :obj:`PageBlock <pyrogram.raw.base.PageBlock>`
        caption (optional): :obj:`PageCaption <pyrogram.raw.base.PageCaption>`
    """
