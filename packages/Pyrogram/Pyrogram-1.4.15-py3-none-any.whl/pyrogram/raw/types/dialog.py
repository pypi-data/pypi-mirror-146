...
class Dialog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        unread_count (optional): ``int`` ``32-bit``
        unread_mentions_count (optional): ``int`` ``32-bit``
        unread_reactions_count (optional): ``int`` ``32-bit``
        notify_settings (optional): :obj:`PeerNotifySettings <pyrogram.raw.base.PeerNotifySettings>`
