...
class ChannelAdminLogEventActionDefaultBannedRights(TLObject):  # type: ignore
    ...
    Parameters:
        prev_banned_rights (optional): :obj:`ChatBannedRights <pyrogram.raw.base.ChatBannedRights>`
        new_banned_rights (optional): :obj:`ChatBannedRights <pyrogram.raw.base.ChatBannedRights>`
    """
