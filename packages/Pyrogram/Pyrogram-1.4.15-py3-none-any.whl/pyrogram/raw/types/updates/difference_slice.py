...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Parameters:
        new_messages (optional): List of :obj:`Message <pyrogram.raw.base.Message>`
        new_encrypted_messages (optional): List of :obj:`EncryptedMessage <pyrogram.raw.base.EncryptedMessage>`
        other_updates (optional): List of :obj:`Update <pyrogram.raw.base.Update>`
        chats (optional): List of :obj:`Chat <pyrogram.raw.base.Chat>`
        users (optional): List of :obj:`User <pyrogram.raw.base.User>`
        intermediate_state (optional): :obj:`updates.State <pyrogram.raw.base.updates.State>`
