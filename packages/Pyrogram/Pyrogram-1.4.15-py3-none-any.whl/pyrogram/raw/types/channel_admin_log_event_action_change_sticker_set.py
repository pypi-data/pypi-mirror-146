...
class ChannelAdminLogEventActionChangeStickerSet(TLObject):  # type: ignore
    ...
    Parameters:
        prev_stickerset (optional): :obj:`InputStickerSet <pyrogram.raw.base.InputStickerSet>`
        new_stickerset (optional): :obj:`InputStickerSet <pyrogram.raw.base.InputStickerSet>`
    """
