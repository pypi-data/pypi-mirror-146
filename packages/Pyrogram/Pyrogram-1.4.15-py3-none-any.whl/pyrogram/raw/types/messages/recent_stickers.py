...
class RecentStickers(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        packs (optional): List of :obj:`StickerPack <pyrogram.raw.base.StickerPack>`
        stickers (optional): List of :obj:`Document <pyrogram.raw.base.Document>`
        dates (optional): List of ``int`` ``32-bit``
