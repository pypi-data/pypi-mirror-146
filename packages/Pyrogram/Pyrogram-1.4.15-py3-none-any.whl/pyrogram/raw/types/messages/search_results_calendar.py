...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Parameters:
        count (optional): ``int`` ``32-bit``
        min_date (optional): ``int`` ``32-bit``
        min_msg_id (optional): ``int`` ``32-bit``
        periods (optional): List of :obj:`SearchResultsCalendarPeriod <pyrogram.raw.base.SearchResultsCalendarPeriod>`
        messages (optional): List of :obj:`Message <pyrogram.raw.base.Message>`
