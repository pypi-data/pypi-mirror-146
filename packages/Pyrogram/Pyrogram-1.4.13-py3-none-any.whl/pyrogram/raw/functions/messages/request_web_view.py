...
class RequestWebView(TLObject):  # type: ignore
    ...
    def __init__(self, *, peer: "raw.base.InputPeer", bot: "raw.base.InputUser", from_bot_menu: Union[None, bool] = None, silent: Union[None, bool] = None, url: Union[None, str] = None, start_param: Union[None, str] = None, theme_params: "raw.base.DataJSON" = None, reply_to_msg_id: Union[None, int] = None) -> None:
