...
class InputPeerNotifySettings(TLObject):  # type: ignore
    ...
    def __init__(self, *, show_previews: Union[None, bool] = None, silent: Union[None, bool] = None, mute_until: Union[None, int] = None, sound: "raw.base.NotificationSound" = None) -> None:
