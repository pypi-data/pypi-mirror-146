...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer (optional): :obj:`InputEncryptedChat <pyrogram.raw.base.InputEncryptedChat>`
        random_id (optional): ``int`` ``64-bit``
        data (optional): ``bytes``
        file (optional): :obj:`InputEncryptedFile <pyrogram.raw.base.InputEncryptedFile>`
