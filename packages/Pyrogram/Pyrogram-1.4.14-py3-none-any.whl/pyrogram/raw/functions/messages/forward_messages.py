...
class ForwardMessages(TLObject):  # type: ignore
    ...
    Parameters:
        from_peer (optional): :obj:`InputPeer <pyrogram.raw.base.InputPeer>`
        id (optional): List of ``int`` ``32-bit``
        random_id (optional): List of ``int`` ``64-bit``
        to_peer (optional): :obj:`InputPeer <pyrogram.raw.base.InputPeer>`
