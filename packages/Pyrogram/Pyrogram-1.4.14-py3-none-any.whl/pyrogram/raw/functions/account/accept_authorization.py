...
class AcceptAuthorization(TLObject):  # type: ignore
    ...
    Parameters:
        bot_id (optional): ``int`` ``64-bit``
        scope (optional): ``str``
        public_key (optional): ``str``
        value_hashes (optional): List of :obj:`SecureValueHash <pyrogram.raw.base.SecureValueHash>`
        credentials (optional): :obj:`SecureCredentialsEncrypted <pyrogram.raw.base.SecureCredentialsEncrypted>`
