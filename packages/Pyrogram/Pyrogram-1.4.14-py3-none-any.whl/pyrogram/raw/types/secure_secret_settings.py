...
class SecureSecretSettings(TLObject):  # type: ignore
    ...
    Parameters:
        secure_algo (optional): :obj:`SecurePasswordKdfAlgo <pyrogram.raw.base.SecurePasswordKdfAlgo>`
        secure_secret (optional): ``bytes``
        secure_secret_id (optional): ``int`` ``64-bit``
    """
