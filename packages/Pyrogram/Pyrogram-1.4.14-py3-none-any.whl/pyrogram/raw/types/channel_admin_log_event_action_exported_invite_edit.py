...
class ChannelAdminLogEventActionExportedInviteEdit(TLObject):  # type: ignore
    ...
    Parameters:
        prev_invite (optional): :obj:`ExportedChatInvite <pyrogram.raw.base.ExportedChatInvite>`
        new_invite (optional): :obj:`ExportedChatInvite <pyrogram.raw.base.ExportedChatInvite>`
    """
