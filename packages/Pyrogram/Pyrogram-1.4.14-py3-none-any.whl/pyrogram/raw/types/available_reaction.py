...
class AvailableReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        title (optional): ``str``
        static_icon (optional): :obj:`Document <pyrogram.raw.base.Document>`
        appear_animation (optional): :obj:`Document <pyrogram.raw.base.Document>`
        select_animation (optional): :obj:`Document <pyrogram.raw.base.Document>`
        activate_animation (optional): :obj:`Document <pyrogram.raw.base.Document>`
        effect_animation (optional): :obj:`Document <pyrogram.raw.base.Document>`
