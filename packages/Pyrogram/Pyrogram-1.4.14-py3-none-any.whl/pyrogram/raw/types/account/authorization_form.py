...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Parameters:
        required_types (optional): List of :obj:`SecureRequiredType <pyrogram.raw.base.SecureRequiredType>`
        values (optional): List of :obj:`SecureValue <pyrogram.raw.base.SecureValue>`
        errors (optional): List of :obj:`SecureValueError <pyrogram.raw.base.SecureValueError>`
